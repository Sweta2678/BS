...
jQuery(function() {
	...
	jQuery("#brandStatusUpdate").click(function(){
		...
		var confirmMsg = "Selecting yes will continue attributing/un-attributing brands to the IDs you provided";
		var confirmAttributeMsg = "Selecting yes will continue attributing brands to the IDs you provided";
		var confirmUnAttributeMsg = "Selecting yes will continue un-attributing brands to the IDs you provided"
		...
		if(stdIds.length > 0 && selectedBrandArray.length > 0)
		{
			...
			if(sts == "UnAttribute" || sts == "Attribute" ){
				...
				if(sts == "UnAttribute"){
					...
					confirmMsg = confirmUnAttributeMsg;
				}else{
					failedErrMsg = failedAttributeErrMsg;
					confirmMsg = confirmAttributeMsg;
				}
