...
/*for the mousehover effect on article image on homapage*/
$(function() {
	$('.img-container').mouseover( function(){
		 $(this).children('.article-overlay').show();
	}).mouseout(function(){
...
/* the line below throws an error on console */
$(function () {
	$('select#sort-by-tabs').selectmenu({ style:'dropdown', width:128 });
	$('select#selectedRegion').selectmenu({ style:'dropdown', width:221 });
	$('select#selectedBrand').selectmenu({ style:'dropdown', width:215 });
	$('#people-finder-left select.brand-region-selectbox').selectmenu({ style:'dropdown', width:449 });
	$('#people-finder-right select.brand-region-selectbox').selectmenu({ style:'dropdown', width:200 });
	$('select.rightpanel-brand-region-selectbox').selectmenu({ style:'dropdown', width:189 });
...
$(function(){
		if($('nav ul li#mainnav-conf').hasClass('selected'))
		
		{
			$('ul.secnav-conf').show();
			$(function(){
				$('nav ul li#mainnav-conf a.secnav').click(function(e){
		...
		else if($('nav ul li#mainnav-news').hasClass('selected'))
		{
			$('ul.secnav-news').show();
			$(function(){
...
{
	for(var i=0; i<500000000000000; i++)
               {
       if($('select.goog-te-combo').length == 1){	
	$('a.goog-logo-link').attr('href','#');
         	break;}
            }
}*/

/*for placeholder to work in ie
...
var userType = "Ha";	
	...
	else{window.open('http://yahoo.com')}
}*/
