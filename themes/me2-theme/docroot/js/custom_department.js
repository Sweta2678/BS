...
$(function () {
	...
	$('select#sort-by-region').selectmenu({ style:'dropdown', width:195  });
	$('select#filter-select').selectmenu({ style:'dropdown', width:325 });
	$('select#sorted-by-applications').selectmenu({ style:'dropdown', width:170 });
...
/* Caraousel in Application Details Page*/
;(function ($) 
{
    $.tiny = $.tiny || { };
...
/* Caraousel in Application Details Page ends*/

/* tab content department index page*/
$(function(){
...
$(document).ready(function() {
	...
	$("#about div").show(); 
	$("#sub-dept div").show();
	$("#resourcelinks div").show(); 
	$("#hot-topic div").show();
	$("#Resources div").show(); 	
	$("#dept-tabs li:first").attr("id","current"); 
	$("#inside-tab div:first").fadeIn();
