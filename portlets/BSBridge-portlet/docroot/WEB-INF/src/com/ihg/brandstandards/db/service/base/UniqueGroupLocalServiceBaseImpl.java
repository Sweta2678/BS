...
import com.ihg.brandstandards.db.service.UniqueGroupLocalService;
...
/**
 * Provides the base implementation for the unique group local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.UniqueGroupLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class UniqueGroupLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements UniqueGroupLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.UniqueGroupLocalServiceUtil} to access the unique group local service.
	 */
	...
	@Override
	public UniqueGroup addUniqueGroup(UniqueGroup uniqueGroup)
		throws SystemException {
		uniqueGroup.setNew(true);

		return uniqueGroupPersistence.update(uniqueGroup);
	}
	 ...
	 */
	@Override
	public UniqueGroup createUniqueGroup(long uniqueGroupId) {
		return uniqueGroupPersistence.create(uniqueGroupId);
	}
	...
	@Override
	public UniqueGroup deleteUniqueGroup(long uniqueGroupId)
		throws PortalException, SystemException {
		return uniqueGroupPersistence.remove(uniqueGroupId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public UniqueGroup deleteUniqueGroup(UniqueGroup uniqueGroup)
		throws SystemException {
		return uniqueGroupPersistence.remove(uniqueGroup);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(UniqueGroup.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return uniqueGroupPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return uniqueGroupPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return uniqueGroupPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public UniqueGroup fetchUniqueGroup(long uniqueGroupId)
		throws SystemException {
		return uniqueGroupPersistence.fetchByPrimaryKey(uniqueGroupId);
	}
	 ...
	 */
	@Override
	public UniqueGroup getUniqueGroup(long uniqueGroupId)
		throws PortalException, SystemException {
		return uniqueGroupPersistence.findByPrimaryKey(uniqueGroupId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return uniqueGroupPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<UniqueGroup> getUniqueGroups(int start, int end)
		throws SystemException {
		return uniqueGroupPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getUniqueGroupsCount() throws SystemException {
		return uniqueGroupPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public UniqueGroup updateUniqueGroup(UniqueGroup uniqueGroup)
		throws SystemException {
		return uniqueGroupPersistence.update(uniqueGroup);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.UniqueGroup",
			uniqueGroupLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = uniqueGroupPersistence.getDataSource();
	...
	private UniqueGroupLocalServiceClpInvoker _clpInvoker = new UniqueGroupLocalServiceClpInvoker();
}