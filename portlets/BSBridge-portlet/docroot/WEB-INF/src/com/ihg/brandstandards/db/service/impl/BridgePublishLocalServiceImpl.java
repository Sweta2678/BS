...
public class BridgePublishLocalServiceImpl extends BridgePublishLocalServiceBaseImpl {
    ...
    public void createManuals (long publishQueueId, long publishId, String emailAddress, String userName,String manualRegions) {
    	bridgePublishFinder.createManuals(publishQueueId, publishId, emailAddress, userName,manualRegions);
    }
