...
import com.ihg.brandstandards.db.service.ChainStandardsLocalService;
...
/**
 * Provides the base implementation for the chain standards local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.ChainStandardsLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class ChainStandardsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ChainStandardsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.ChainStandardsLocalServiceUtil} to access the chain standards local service.
	 */
	...
	@Override
	public ChainStandards addChainStandards(ChainStandards chainStandards)
		throws SystemException {
		chainStandards.setNew(true);

		return chainStandardsPersistence.update(chainStandards);
	}
	 ...
	 */
	@Override
	public ChainStandards createChainStandards(
		ChainStandardsPK chainStandardsPK) {
		return chainStandardsPersistence.create(chainStandardsPK);
	}
	...
	@Override
	public ChainStandards deleteChainStandards(
		ChainStandardsPK chainStandardsPK)
		throws PortalException, SystemException {
		return chainStandardsPersistence.remove(chainStandardsPK);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ChainStandards deleteChainStandards(ChainStandards chainStandards)
		throws SystemException {
		return chainStandardsPersistence.remove(chainStandards);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ChainStandards.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return chainStandardsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return chainStandardsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ChainStandards fetchChainStandards(ChainStandardsPK chainStandardsPK)
		throws SystemException {
		return chainStandardsPersistence.fetchByPrimaryKey(chainStandardsPK);
	}
	 ...
	 */
	@Override
	public ChainStandards getChainStandards(ChainStandardsPK chainStandardsPK)
		throws PortalException, SystemException {
		return chainStandardsPersistence.findByPrimaryKey(chainStandardsPK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return chainStandardsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ChainStandards> getChainStandardses(int start, int end)
		throws SystemException {
		return chainStandardsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getChainStandardsesCount() throws SystemException {
		return chainStandardsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ChainStandards updateChainStandards(ChainStandards chainStandards)
		throws SystemException {
		return chainStandardsPersistence.update(chainStandards);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.ChainStandards",
			chainStandardsLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = chainStandardsPersistence.getDataSource();
	...
	private ChainStandardsLocalServiceClpInvoker _clpInvoker = new ChainStandardsLocalServiceClpInvoker();
}