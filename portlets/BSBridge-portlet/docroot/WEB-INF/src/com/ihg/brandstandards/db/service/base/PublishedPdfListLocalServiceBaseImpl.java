...
import com.ihg.brandstandards.db.service.PublishedPdfListLocalService;
...
/**
 * Provides the base implementation for the published pdf list local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.PublishedPdfListLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class PublishedPdfListLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PublishedPdfListLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.PublishedPdfListLocalServiceUtil} to access the published pdf list local service.
	 */
	...
	@Override
	public PublishedPdfList addPublishedPdfList(
		PublishedPdfList publishedPdfList) throws SystemException {
		publishedPdfList.setNew(true);

		return publishedPdfListPersistence.update(publishedPdfList);
	}
	 ...
	 */
	@Override
	public PublishedPdfList createPublishedPdfList(long pdfId) {
		return publishedPdfListPersistence.create(pdfId);
	}
	...
	@Override
	public PublishedPdfList deletePublishedPdfList(long pdfId)
		throws PortalException, SystemException {
		return publishedPdfListPersistence.remove(pdfId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PublishedPdfList deletePublishedPdfList(
		PublishedPdfList publishedPdfList) throws SystemException {
		return publishedPdfListPersistence.remove(publishedPdfList);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PublishedPdfList.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return publishedPdfListPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return publishedPdfListPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public PublishedPdfList fetchPublishedPdfList(long pdfId)
		throws SystemException {
		return publishedPdfListPersistence.fetchByPrimaryKey(pdfId);
	}
	 ...
	 */
	@Override
	public PublishedPdfList getPublishedPdfList(long pdfId)
		throws PortalException, SystemException {
		return publishedPdfListPersistence.findByPrimaryKey(pdfId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return publishedPdfListPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PublishedPdfList> getPublishedPdfLists(int start, int end)
		throws SystemException {
		return publishedPdfListPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getPublishedPdfListsCount() throws SystemException {
		return publishedPdfListPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PublishedPdfList updatePublishedPdfList(
		PublishedPdfList publishedPdfList) throws SystemException {
		return publishedPdfListPersistence.update(publishedPdfList);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.PublishedPdfList",
			publishedPdfListLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.PublishedPdfList");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = publishedPdfListPersistence.getDataSource();
	...
	private PublishedPdfListLocalServiceClpInvoker _clpInvoker = new PublishedPdfListLocalServiceClpInvoker();
}