...
import com.ihg.brandstandards.db.service.GlossaryTranslateLocalService;
...
/**
 * Provides the base implementation for the glossary translate local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.GlossaryTranslateLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class GlossaryTranslateLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements GlossaryTranslateLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.GlossaryTranslateLocalServiceUtil} to access the glossary translate local service.
	 */
	...
	@Override
	public GlossaryTranslate addGlossaryTranslate(
		GlossaryTranslate glossaryTranslate) throws SystemException {
		glossaryTranslate.setNew(true);

		return glossaryTranslatePersistence.update(glossaryTranslate);
	}
	 ...
	 */
	@Override
	public GlossaryTranslate createGlossaryTranslate(long glossaryXlatId) {
		return glossaryTranslatePersistence.create(glossaryXlatId);
	}
	...
	@Override
	public GlossaryTranslate deleteGlossaryTranslate(long glossaryXlatId)
		throws PortalException, SystemException {
		return glossaryTranslatePersistence.remove(glossaryXlatId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public GlossaryTranslate deleteGlossaryTranslate(
		GlossaryTranslate glossaryTranslate) throws SystemException {
		return glossaryTranslatePersistence.remove(glossaryTranslate);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(GlossaryTranslate.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return glossaryTranslatePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return glossaryTranslatePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public GlossaryTranslate fetchGlossaryTranslate(long glossaryXlatId)
		throws SystemException {
		return glossaryTranslatePersistence.fetchByPrimaryKey(glossaryXlatId);
	}
	 ...
	 */
	@Override
	public GlossaryTranslate getGlossaryTranslate(long glossaryXlatId)
		throws PortalException, SystemException {
		return glossaryTranslatePersistence.findByPrimaryKey(glossaryXlatId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return glossaryTranslatePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<GlossaryTranslate> getGlossaryTranslates(int start, int end)
		throws SystemException {
		return glossaryTranslatePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getGlossaryTranslatesCount() throws SystemException {
		return glossaryTranslatePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public GlossaryTranslate updateGlossaryTranslate(
		GlossaryTranslate glossaryTranslate) throws SystemException {
		return glossaryTranslatePersistence.update(glossaryTranslate);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.GlossaryTranslate",
			glossaryTranslateLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = glossaryTranslatePersistence.getDataSource();
	...
	private GlossaryTranslateLocalServiceClpInvoker _clpInvoker = new GlossaryTranslateLocalServiceClpInvoker();
}