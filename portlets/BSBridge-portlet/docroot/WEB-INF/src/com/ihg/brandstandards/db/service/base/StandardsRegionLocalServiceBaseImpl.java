...
import com.ihg.brandstandards.db.service.StandardsRegionLocalService;
...
/**
 * Provides the base implementation for the standards region local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.StandardsRegionLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class StandardsRegionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements StandardsRegionLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.StandardsRegionLocalServiceUtil} to access the standards region local service.
	 */
	...
	@Override
	public StandardsRegion addStandardsRegion(StandardsRegion standardsRegion)
		throws SystemException {
		standardsRegion.setNew(true);

		return standardsRegionPersistence.update(standardsRegion);
	}
	 ...
	 */
	@Override
	public StandardsRegion createStandardsRegion(long regionId) {
		return standardsRegionPersistence.create(regionId);
	}
	...
	@Override
	public StandardsRegion deleteStandardsRegion(long regionId)
		throws PortalException, SystemException {
		return standardsRegionPersistence.remove(regionId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public StandardsRegion deleteStandardsRegion(
		StandardsRegion standardsRegion) throws SystemException {
		return standardsRegionPersistence.remove(standardsRegion);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(StandardsRegion.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return standardsRegionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return standardsRegionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public StandardsRegion fetchStandardsRegion(long regionId)
		throws SystemException {
		return standardsRegionPersistence.fetchByPrimaryKey(regionId);
	}
	 ...
	 */
	@Override
	public StandardsRegion getStandardsRegion(long regionId)
		throws PortalException, SystemException {
		return standardsRegionPersistence.findByPrimaryKey(regionId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return standardsRegionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<StandardsRegion> getStandardsRegions(int start, int end)
		throws SystemException {
		return standardsRegionPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getStandardsRegionsCount() throws SystemException {
		return standardsRegionPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public StandardsRegion updateStandardsRegion(
		StandardsRegion standardsRegion) throws SystemException {
		return standardsRegionPersistence.update(standardsRegion);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.StandardsRegion",
			standardsRegionLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.StandardsRegion");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = standardsRegionPersistence.getDataSource();
	...
	private StandardsRegionLocalServiceClpInvoker _clpInvoker = new StandardsRegionLocalServiceClpInvoker();
}