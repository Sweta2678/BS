...
import com.ihg.brandstandards.db.service.GlossaryExtLocalService;
...
/**
 * Provides the base implementation for the glossary ext local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.GlossaryExtLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class GlossaryExtLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements GlossaryExtLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.GlossaryExtLocalServiceUtil} to access the glossary ext local service.
	 */
	...
	@Override
	public GlossaryExt addGlossaryExt(GlossaryExt glossaryExt)
		throws SystemException {
		glossaryExt.setNew(true);

		return glossaryExtPersistence.update(glossaryExt);
	}
	 ...
	 */
	@Override
	public GlossaryExt createGlossaryExt(long glossaryId) {
		return glossaryExtPersistence.create(glossaryId);
	}
	...
	@Override
	public GlossaryExt deleteGlossaryExt(long glossaryId)
		throws PortalException, SystemException {
		return glossaryExtPersistence.remove(glossaryId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public GlossaryExt deleteGlossaryExt(GlossaryExt glossaryExt)
		throws SystemException {
		return glossaryExtPersistence.remove(glossaryExt);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(GlossaryExt.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return glossaryExtPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return glossaryExtPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return glossaryExtPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public GlossaryExt fetchGlossaryExt(long glossaryId)
		throws SystemException {
		return glossaryExtPersistence.fetchByPrimaryKey(glossaryId);
	}
	 ...
	 */
	@Override
	public GlossaryExt getGlossaryExt(long glossaryId)
		throws PortalException, SystemException {
		return glossaryExtPersistence.findByPrimaryKey(glossaryId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return glossaryExtPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<GlossaryExt> getGlossaryExts(int start, int end)
		throws SystemException {
		return glossaryExtPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getGlossaryExtsCount() throws SystemException {
		return glossaryExtPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public GlossaryExt updateGlossaryExt(GlossaryExt glossaryExt)
		throws SystemException {
		return glossaryExtPersistence.update(glossaryExt);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.GlossaryExt",
			glossaryExtLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = glossaryExtPersistence.getDataSource();
	...
	private GlossaryExtLocalServiceClpInvoker _clpInvoker = new GlossaryExtLocalServiceClpInvoker();
}