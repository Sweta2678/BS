...
import com.ihg.brandstandards.db.service.AttachmentsStandardsLocalService;
...
/**
 * Provides the base implementation for the attachments standards local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.AttachmentsStandardsLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class AttachmentsStandardsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AttachmentsStandardsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.AttachmentsStandardsLocalServiceUtil} to access the attachments standards local service.
	 */
	...
	@Override
	public AttachmentsStandards addAttachmentsStandards(
		AttachmentsStandards attachmentsStandards) throws SystemException {
		attachmentsStandards.setNew(true);

		return attachmentsStandardsPersistence.update(attachmentsStandards);
	}
	 ...
	 */
	@Override
	public AttachmentsStandards createAttachmentsStandards(
		AttachmentsStandardsPK attachmentsStandardsPK) {
		return attachmentsStandardsPersistence.create(attachmentsStandardsPK);
	}
	...
	@Override
	public AttachmentsStandards deleteAttachmentsStandards(
		AttachmentsStandardsPK attachmentsStandardsPK)
		throws PortalException, SystemException {
		return attachmentsStandardsPersistence.remove(attachmentsStandardsPK);
	}
	...
	public AttachmentsStandards deleteAttachmentsStandards(
		AttachmentsStandards attachmentsStandards) throws SystemException {
		return attachmentsStandardsPersistence.remove(attachmentsStandards);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AttachmentsStandards.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return attachmentsStandardsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return attachmentsStandardsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public AttachmentsStandards fetchAttachmentsStandards(
		AttachmentsStandardsPK attachmentsStandardsPK)
		throws SystemException {
		return attachmentsStandardsPersistence.fetchByPrimaryKey(attachmentsStandardsPK);
	}
	 ...
	 */
	@Override
	public AttachmentsStandards getAttachmentsStandards(
		AttachmentsStandardsPK attachmentsStandardsPK)
		throws PortalException, SystemException {
		return attachmentsStandardsPersistence.findByPrimaryKey(attachmentsStandardsPK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return attachmentsStandardsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AttachmentsStandards> getAttachmentsStandardses(int start,
		int end) throws SystemException {
		return attachmentsStandardsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getAttachmentsStandardsesCount() throws SystemException {
		return attachmentsStandardsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AttachmentsStandards updateAttachmentsStandards(
		AttachmentsStandards attachmentsStandards) throws SystemException {
		return attachmentsStandardsPersistence.update(attachmentsStandards);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.AttachmentsStandards",
			attachmentsStandardsLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = attachmentsStandardsPersistence.getDataSource();
	...
	private AttachmentsStandardsLocalServiceClpInvoker _clpInvoker = new AttachmentsStandardsLocalServiceClpInvoker();
}