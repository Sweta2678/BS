...
import com.ihg.brandstandards.db.service.HistManualAttachmentLocalService;
...
/**
 * Provides the base implementation for the hist manual attachment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.HistManualAttachmentLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 * @see com.ihg.brandstandards.db.service.impl.HistManualAttachmentLocalServiceImpl
 * @see com.ihg.brandstandards.db.service.HistManualAttachmentLocalServiceUtil
 * @generated
 */
public abstract class HistManualAttachmentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements HistManualAttachmentLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.HistManualAttachmentLocalServiceUtil} to access the hist manual attachment local service.
	 */

	/**
	 * Adds the hist manual attachment to the database. Also notifies the appropriate model listeners.
	 *
	 * @param histManualAttachment the hist manual attachment
	 * @return the hist manual attachment that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public HistManualAttachment addHistManualAttachment(
		HistManualAttachment histManualAttachment) throws SystemException {
		histManualAttachment.setNew(true);

		return histManualAttachmentPersistence.update(histManualAttachment);
	}
	 ...
	 */
	@Override
	public HistManualAttachment createHistManualAttachment(long histManualId) {
		return histManualAttachmentPersistence.create(histManualId);
	}

	/**
	 * Deletes the hist manual attachment with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param histManualId the primary key of the hist manual attachment
	 * @return the hist manual attachment that was removed
	 * @throws PortalException if a hist manual attachment with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public HistManualAttachment deleteHistManualAttachment(long histManualId)
		throws PortalException, SystemException {
		return histManualAttachmentPersistence.remove(histManualId);
	}

	/**
	 * Deletes the hist manual attachment from the database. Also notifies the appropriate model listeners.
	 *
	 * @param histManualAttachment the hist manual attachment
	 * @return the hist manual attachment that was removed
	 * @throws SystemException if a system exception occurred
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public HistManualAttachment deleteHistManualAttachment(
		HistManualAttachment histManualAttachment) throws SystemException {
		return histManualAttachmentPersistence.remove(histManualAttachment);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(HistManualAttachment.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return histManualAttachmentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return histManualAttachmentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public HistManualAttachment fetchHistManualAttachment(long histManualId)
		throws SystemException {
		return histManualAttachmentPersistence.fetchByPrimaryKey(histManualId);
	}

	/**
	 * Returns the hist manual attachment with the primary key.
	 *
	 * @param histManualId the primary key of the hist manual attachment
	 ...
	 */
	@Override
	public HistManualAttachment getHistManualAttachment(long histManualId)
		throws PortalException, SystemException {
		return histManualAttachmentPersistence.findByPrimaryKey(histManualId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return histManualAttachmentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<HistManualAttachment> getHistManualAttachments(int start,
		int end) throws SystemException {
		return histManualAttachmentPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getHistManualAttachmentsCount() throws SystemException {
		return histManualAttachmentPersistence.countAll();
	}

	/**
	 * Updates the hist manual attachment in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param histManualAttachment the hist manual attachment
	 * @return the hist manual attachment that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public HistManualAttachment updateHistManualAttachment(
		HistManualAttachment histManualAttachment) throws SystemException {
		return histManualAttachmentPersistence.update(histManualAttachment);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.HistManualAttachment",
			histManualAttachmentLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.HistManualAttachment");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = histManualAttachmentPersistence.getDataSource();
	...
	private HistManualAttachmentLocalServiceClpInvoker _clpInvoker = new HistManualAttachmentLocalServiceClpInvoker();
}