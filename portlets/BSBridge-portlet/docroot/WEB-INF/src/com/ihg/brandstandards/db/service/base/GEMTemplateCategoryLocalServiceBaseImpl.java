...
import com.ihg.brandstandards.db.service.GEMTemplateCategoryLocalService;
...
/**
 * Provides the base implementation for the g e m template category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.GEMTemplateCategoryLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 * @see com.ihg.brandstandards.db.service.impl.GEMTemplateCategoryLocalServiceImpl
 * @see com.ihg.brandstandards.db.service.GEMTemplateCategoryLocalServiceUtil
 * @generated
 */
public abstract class GEMTemplateCategoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements GEMTemplateCategoryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.GEMTemplateCategoryLocalServiceUtil} to access the g e m template category local service.
	 */
	...
	@Override
	public GEMTemplateCategory addGEMTemplateCategory(
		GEMTemplateCategory gemTemplateCategory) throws SystemException {
		gemTemplateCategory.setNew(true);

		return gemTemplateCategoryPersistence.update(gemTemplateCategory);
	}
	 ...
	 */
	@Override
	public GEMTemplateCategory createGEMTemplateCategory(long templateCatgyId) {
		return gemTemplateCategoryPersistence.create(templateCatgyId);
	}
	...
	@Override
	public GEMTemplateCategory deleteGEMTemplateCategory(long templateCatgyId)
		throws PortalException, SystemException {
		return gemTemplateCategoryPersistence.remove(templateCatgyId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public GEMTemplateCategory deleteGEMTemplateCategory(
		GEMTemplateCategory gemTemplateCategory) throws SystemException {
		return gemTemplateCategoryPersistence.remove(gemTemplateCategory);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(GEMTemplateCategory.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return gemTemplateCategoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return gemTemplateCategoryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public GEMTemplateCategory fetchGEMTemplateCategory(long templateCatgyId)
		throws SystemException {
		return gemTemplateCategoryPersistence.fetchByPrimaryKey(templateCatgyId);
	}
	 ...
	 */
	@Override
	public GEMTemplateCategory getGEMTemplateCategory(long templateCatgyId)
		throws PortalException, SystemException {
		return gemTemplateCategoryPersistence.findByPrimaryKey(templateCatgyId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return gemTemplateCategoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<GEMTemplateCategory> getGEMTemplateCategories(int start, int end)
		throws SystemException {
		return gemTemplateCategoryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getGEMTemplateCategoriesCount() throws SystemException {
		return gemTemplateCategoryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public GEMTemplateCategory updateGEMTemplateCategory(
		GEMTemplateCategory gemTemplateCategory) throws SystemException {
		return gemTemplateCategoryPersistence.update(gemTemplateCategory);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.GEMTemplateCategory",
			gemTemplateCategoryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.GEMTemplateCategory");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = gemTemplateCategoryPersistence.getDataSource();
	...
	private GEMTemplateCategoryLocalServiceClpInvoker _clpInvoker = new GEMTemplateCategoryLocalServiceClpInvoker();
}