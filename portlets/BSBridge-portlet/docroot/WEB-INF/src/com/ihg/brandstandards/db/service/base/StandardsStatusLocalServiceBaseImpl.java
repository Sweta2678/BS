...
import com.ihg.brandstandards.db.service.StandardsStatusLocalService;
...
/**
 * Provides the base implementation for the standards status local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.StandardsStatusLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class StandardsStatusLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements StandardsStatusLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.StandardsStatusLocalServiceUtil} to access the standards status local service.
	 */
	...
	@Override
	public StandardsStatus addStandardsStatus(StandardsStatus standardsStatus)
		throws SystemException {
		standardsStatus.setNew(true);

		return standardsStatusPersistence.update(standardsStatus);
	}
	 ...
	 */
	@Override
	public StandardsStatus createStandardsStatus(long statusId) {
		return standardsStatusPersistence.create(statusId);
	}
	...
	@Override
	public StandardsStatus deleteStandardsStatus(long statusId)
		throws PortalException, SystemException {
		return standardsStatusPersistence.remove(statusId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public StandardsStatus deleteStandardsStatus(
		StandardsStatus standardsStatus) throws SystemException {
		return standardsStatusPersistence.remove(standardsStatus);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(StandardsStatus.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return standardsStatusPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return standardsStatusPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public StandardsStatus fetchStandardsStatus(long statusId)
		throws SystemException {
		return standardsStatusPersistence.fetchByPrimaryKey(statusId);
	}
	 ...
	 */
	@Override
	public StandardsStatus getStandardsStatus(long statusId)
		throws PortalException, SystemException {
		return standardsStatusPersistence.findByPrimaryKey(statusId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return standardsStatusPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<StandardsStatus> getStandardsStatuses(int start, int end)
		throws SystemException {
		return standardsStatusPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getStandardsStatusesCount() throws SystemException {
		return standardsStatusPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public StandardsStatus updateStandardsStatus(
		StandardsStatus standardsStatus) throws SystemException {
		return standardsStatusPersistence.update(standardsStatus);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.StandardsStatus",
			standardsStatusLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.StandardsStatus");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = standardsStatusPersistence.getDataSource();
	...
	private StandardsStatusLocalServiceClpInvoker _clpInvoker = new StandardsStatusLocalServiceClpInvoker();
}