...
import com.ihg.brandstandards.db.service.GEMRoleLocalService;
...
/**
 * Provides the base implementation for the g e m role local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.GEMRoleLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 * @see com.ihg.brandstandards.db.service.impl.GEMRoleLocalServiceImpl
 * @see com.ihg.brandstandards.db.service.GEMRoleLocalServiceUtil
 * @generated
 */
public abstract class GEMRoleLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements GEMRoleLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.GEMRoleLocalServiceUtil} to access the g e m role local service.
	 */

	/**
	 * Adds the g e m role to the database. Also notifies the appropriate model listeners.
	 *
	 * @param gemRole the g e m role
	 * @return the g e m role that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public GEMRole addGEMRole(GEMRole gemRole) throws SystemException {
		gemRole.setNew(true);

		return gemRolePersistence.update(gemRole);
	}
	 ...
	 */
	@Override
	public GEMRole createGEMRole(long gemGrpId) {
		return gemRolePersistence.create(gemGrpId);
	}

	/**
	 * Deletes the g e m role with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param gemGrpId the primary key of the g e m role
	 * @return the g e m role that was removed
	 * @throws PortalException if a g e m role with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public GEMRole deleteGEMRole(long gemGrpId)
		throws PortalException, SystemException {
		return gemRolePersistence.remove(gemGrpId);
	}

	/**
	 * Deletes the g e m role from the database. Also notifies the appropriate model listeners.
	 *
	 * @param gemRole the g e m role
	 * @return the g e m role that was removed
	 * @throws SystemException if a system exception occurred
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public GEMRole deleteGEMRole(GEMRole gemRole) throws SystemException {
		return gemRolePersistence.remove(gemRole);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(GEMRole.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return gemRolePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return gemRolePersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return gemRolePersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return gemRolePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return gemRolePersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public GEMRole fetchGEMRole(long gemGrpId) throws SystemException {
		return gemRolePersistence.fetchByPrimaryKey(gemGrpId);
	}

	/**
	 * Returns the g e m role with the primary key.
	 *
	 * @param gemGrpId the primary key of the g e m role
	 ...
	 */
	@Override
	public GEMRole getGEMRole(long gemGrpId)
		throws PortalException, SystemException {
		return gemRolePersistence.findByPrimaryKey(gemGrpId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return gemRolePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<GEMRole> getGEMRoles(int start, int end)
		throws SystemException {
		return gemRolePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getGEMRolesCount() throws SystemException {
		return gemRolePersistence.countAll();
	}

	/**
	 * Updates the g e m role in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param gemRole the g e m role
	 * @return the g e m role that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public GEMRole updateGEMRole(GEMRole gemRole) throws SystemException {
		return gemRolePersistence.update(gemRole);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.GEMRole",
			gemRoleLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = gemRolePersistence.getDataSource();
	...
	private GEMRoleLocalServiceClpInvoker _clpInvoker = new GEMRoleLocalServiceClpInvoker();
}