...
public class SpreadSheetAttributeUpdateLocalServiceClpInvoker {
	public SpreadSheetAttributeUpdateLocalServiceClpInvoker() {
		...
		_methodName614 = "addSpreadSheetAttributeUpdate";

		_methodParameterTypes614 = new String[] {
				"com.ihg.brandstandards.db.model.SpreadSheetAttributeUpdate"
			};

		_methodName615 = "createSpreadSheetAttributeUpdate";

		_methodParameterTypes615 = new String[] { "long" };

		_methodName616 = "deleteSpreadSheetAttributeUpdate";

		_methodParameterTypes616 = new String[] { "long" };

		_methodName617 = "deleteSpreadSheetAttributeUpdate";

		_methodParameterTypes617 = new String[] {
				"com.ihg.brandstandards.db.model.SpreadSheetAttributeUpdate"
			};

		_methodName618 = "updateSpreadSheetAttributeUpdate";

		_methodParameterTypes618 = new String[] {
				"com.ihg.brandstandards.db.model.SpreadSheetAttributeUpdate"
			};

		_methodName619 = "recordsNotAvailable";
		...
		_methodName620 = "getStandardDetails";

		_methodParameterTypes620 = new String[] { "java.util.List" };

		_methodName621 = "getAttributeRequestList";

		_methodParameterTypes621 = new String[] { "java.lang.String" };

		_methodName622 = "getFlagCategoryIdForStandard";

		_methodParameterTypes622 = new String[] { "long" };

		_methodName623 = "getFlagCategories";

		_methodParameterTypes623 = new String[] {  };

		_methodName624 = "sendEmailNotification";
		...
		_methodName625 = "getStandardFlagCaterogies";

		_methodParameterTypes625 = new String[] { "java.util.List" };

		_methodName626 = "clearCache";

		_methodParameterTypes626 = new String[] {  };

		_methodName627 = "addToJobQueue";
