...
import com.ihg.brandstandards.db.service.PublishParmLocalService;
...
/**
 * Provides the base implementation for the publish parm local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.PublishParmLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class PublishParmLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PublishParmLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.PublishParmLocalServiceUtil} to access the publish parm local service.
	 */
	...
	@Override
	public PublishParm addPublishParm(PublishParm publishParm)
		throws SystemException {
		publishParm.setNew(true);

		return publishParmPersistence.update(publishParm);
	}
	 ...
	 */
	@Override
	public PublishParm createPublishParm(long publishParmId) {
		return publishParmPersistence.create(publishParmId);
	}
	...
	@Override
	public PublishParm deletePublishParm(long publishParmId)
		throws PortalException, SystemException {
		return publishParmPersistence.remove(publishParmId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PublishParm deletePublishParm(PublishParm publishParm)
		throws SystemException {
		return publishParmPersistence.remove(publishParm);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PublishParm.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return publishParmPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return publishParmPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return publishParmPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public PublishParm fetchPublishParm(long publishParmId)
		throws SystemException {
		return publishParmPersistence.fetchByPrimaryKey(publishParmId);
	}
	 ...
	 */
	@Override
	public PublishParm getPublishParm(long publishParmId)
		throws PortalException, SystemException {
		return publishParmPersistence.findByPrimaryKey(publishParmId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return publishParmPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PublishParm> getPublishParms(int start, int end)
		throws SystemException {
		return publishParmPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getPublishParmsCount() throws SystemException {
		return publishParmPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PublishParm updatePublishParm(PublishParm publishParm)
		throws SystemException {
		return publishParmPersistence.update(publishParm);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.PublishParm",
			publishParmLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = publishParmPersistence.getDataSource();
	...
	private PublishParmLocalServiceClpInvoker _clpInvoker = new PublishParmLocalServiceClpInvoker();
}