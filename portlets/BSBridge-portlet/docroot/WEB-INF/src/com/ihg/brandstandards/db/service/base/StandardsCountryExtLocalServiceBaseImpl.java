...
import com.ihg.brandstandards.db.service.StandardsCountryExtLocalService;
...
/**
 * Provides the base implementation for the standards country ext local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.StandardsCountryExtLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class StandardsCountryExtLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements StandardsCountryExtLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.StandardsCountryExtLocalServiceUtil} to access the standards country ext local service.
	 */
	...
	@Override
	public StandardsCountryExt addStandardsCountryExt(
		StandardsCountryExt standardsCountryExt) throws SystemException {
		standardsCountryExt.setNew(true);

		return standardsCountryExtPersistence.update(standardsCountryExt);
	}
	 ...
	 */
	@Override
	public StandardsCountryExt createStandardsCountryExt(long rowNum) {
		return standardsCountryExtPersistence.create(rowNum);
	}
	...
	@Override
	public StandardsCountryExt deleteStandardsCountryExt(long rowNum)
		throws PortalException, SystemException {
		return standardsCountryExtPersistence.remove(rowNum);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public StandardsCountryExt deleteStandardsCountryExt(
		StandardsCountryExt standardsCountryExt) throws SystemException {
		return standardsCountryExtPersistence.remove(standardsCountryExt);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(StandardsCountryExt.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return standardsCountryExtPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return standardsCountryExtPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public StandardsCountryExt fetchStandardsCountryExt(long rowNum)
		throws SystemException {
		return standardsCountryExtPersistence.fetchByPrimaryKey(rowNum);
	}
	 ...
	 */
	@Override
	public StandardsCountryExt getStandardsCountryExt(long rowNum)
		throws PortalException, SystemException {
		return standardsCountryExtPersistence.findByPrimaryKey(rowNum);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return standardsCountryExtPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<StandardsCountryExt> getStandardsCountryExts(int start, int end)
		throws SystemException {
		return standardsCountryExtPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getStandardsCountryExtsCount() throws SystemException {
		return standardsCountryExtPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public StandardsCountryExt updateStandardsCountryExt(
		StandardsCountryExt standardsCountryExt) throws SystemException {
		return standardsCountryExtPersistence.update(standardsCountryExt);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.StandardsCountryExt",
			standardsCountryExtLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = standardsCountryExtPersistence.getDataSource();
	...
	private StandardsCountryExtLocalServiceClpInvoker _clpInvoker = new StandardsCountryExtLocalServiceClpInvoker();
}