...
import com.ihg.brandstandards.db.service.FlagCategoryLocalService;
...
/**
 * Provides the base implementation for the flag category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.FlagCategoryLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class FlagCategoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FlagCategoryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.FlagCategoryLocalServiceUtil} to access the flag category local service.
	 */
	...
	@Override
	public FlagCategory addFlagCategory(FlagCategory flagCategory)
		throws SystemException {
		flagCategory.setNew(true);

		return flagCategoryPersistence.update(flagCategory);
	}
	 ...
	 */
	@Override
	public FlagCategory createFlagCategory(FlagCategoryPK flagCategoryPK) {
		return flagCategoryPersistence.create(flagCategoryPK);
	}
	...
	@Override
	public FlagCategory deleteFlagCategory(FlagCategoryPK flagCategoryPK)
		throws PortalException, SystemException {
		return flagCategoryPersistence.remove(flagCategoryPK);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FlagCategory deleteFlagCategory(FlagCategory flagCategory)
		throws SystemException {
		return flagCategoryPersistence.remove(flagCategory);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FlagCategory.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return flagCategoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return flagCategoryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public FlagCategory fetchFlagCategory(FlagCategoryPK flagCategoryPK)
		throws SystemException {
		return flagCategoryPersistence.fetchByPrimaryKey(flagCategoryPK);
	}
	 ...
	 */
	@Override
	public FlagCategory getFlagCategory(FlagCategoryPK flagCategoryPK)
		throws PortalException, SystemException {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return flagCategoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FlagCategory> getFlagCategories(int start, int end)
		throws SystemException {
		return flagCategoryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getFlagCategoriesCount() throws SystemException {
		return flagCategoryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FlagCategory updateFlagCategory(FlagCategory flagCategory)
		throws SystemException {
		return flagCategoryPersistence.update(flagCategory);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.FlagCategory",
			flagCategoryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.FlagCategory");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = flagCategoryPersistence.getDataSource();
	...
	private FlagCategoryLocalServiceClpInvoker _clpInvoker = new FlagCategoryLocalServiceClpInvoker();
}