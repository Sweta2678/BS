...
import com.ihg.brandstandards.db.service.BridgeProgressCategoryLocalService;
...
/**
 * Provides the base implementation for the bridge progress category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.BridgeProgressCategoryLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 * @see com.ihg.brandstandards.db.service.impl.BridgeProgressCategoryLocalServiceImpl
 * @see com.ihg.brandstandards.db.service.BridgeProgressCategoryLocalServiceUtil
 * @generated
 */
public abstract class BridgeProgressCategoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements BridgeProgressCategoryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.BridgeProgressCategoryLocalServiceUtil} to access the bridge progress category local service.
	 */

	/**
	 * Adds the bridge progress category to the database. Also notifies the appropriate model listeners.
	 *
	 * @param bridgeProgressCategory the bridge progress category
	 * @return the bridge progress category that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public BridgeProgressCategory addBridgeProgressCategory(
		BridgeProgressCategory bridgeProgressCategory)
		throws SystemException {
		bridgeProgressCategory.setNew(true);

		return bridgeProgressCategoryPersistence.update(bridgeProgressCategory);
	}
	 ...
	 */
	@Override
	public BridgeProgressCategory createBridgeProgressCategory(
		long progressCategoryId) {
		return bridgeProgressCategoryPersistence.create(progressCategoryId);
	}

	/**
	 * Deletes the bridge progress category with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 ...
	 * @throws PortalException if a bridge progress category with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public BridgeProgressCategory deleteBridgeProgressCategory(
		long progressCategoryId) throws PortalException, SystemException {
		return bridgeProgressCategoryPersistence.remove(progressCategoryId);
	}

	/**
	 * Deletes the bridge progress category from the database. Also notifies the appropriate model listeners.
	 *
	 * @param bridgeProgressCategory the bridge progress category
	 * @return the bridge progress category that was removed
	 * @throws SystemException if a system exception occurred
	...
	public BridgeProgressCategory deleteBridgeProgressCategory(
		BridgeProgressCategory bridgeProgressCategory)
		throws SystemException {
		return bridgeProgressCategoryPersistence.remove(bridgeProgressCategory);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(BridgeProgressCategory.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return bridgeProgressCategoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return bridgeProgressCategoryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public BridgeProgressCategory fetchBridgeProgressCategory(
		long progressCategoryId) throws SystemException {
		return bridgeProgressCategoryPersistence.fetchByPrimaryKey(progressCategoryId);
	}

	/**
	 * Returns the bridge progress category with the primary key.
	 *
	 * @param progressCategoryId the primary key of the bridge progress category
	 ...
	 */
	@Override
	public BridgeProgressCategory getBridgeProgressCategory(
		long progressCategoryId) throws PortalException, SystemException {
		return bridgeProgressCategoryPersistence.findByPrimaryKey(progressCategoryId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return bridgeProgressCategoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<BridgeProgressCategory> getBridgeProgressCategories(int start,
		int end) throws SystemException {
		return bridgeProgressCategoryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getBridgeProgressCategoriesCount() throws SystemException {
		return bridgeProgressCategoryPersistence.countAll();
	}

	/**
	 * Updates the bridge progress category in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param bridgeProgressCategory the bridge progress category
	 * @return the bridge progress category that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public BridgeProgressCategory updateBridgeProgressCategory(
		BridgeProgressCategory bridgeProgressCategory)
		throws SystemException {
		return bridgeProgressCategoryPersistence.update(bridgeProgressCategory);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.BridgeProgressCategory",
			bridgeProgressCategoryLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = bridgeProgressCategoryPersistence.getDataSource();
	...
	private BridgeProgressCategoryLocalServiceClpInvoker _clpInvoker = new BridgeProgressCategoryLocalServiceClpInvoker();
}