...
import com.ihg.brandstandards.db.service.StandardsHistoricalManualLocalService;
...
/**
 * Provides the base implementation for the standards historical manual local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.StandardsHistoricalManualLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 * @see com.ihg.brandstandards.db.service.impl.StandardsHistoricalManualLocalServiceImpl
 * @see com.ihg.brandstandards.db.service.StandardsHistoricalManualLocalServiceUtil
 * @generated
 */
public abstract class StandardsHistoricalManualLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements StandardsHistoricalManualLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.StandardsHistoricalManualLocalServiceUtil} to access the standards historical manual local service.
	 */

	/**
	 * Adds the standards historical manual to the database. Also notifies the appropriate model listeners.
	 *
	 * @param standardsHistoricalManual the standards historical manual
	 * @return the standards historical manual that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public StandardsHistoricalManual addStandardsHistoricalManual(
		StandardsHistoricalManual standardsHistoricalManual)
		throws SystemException {
		standardsHistoricalManual.setNew(true);

		return standardsHistoricalManualPersistence.update(standardsHistoricalManual);
	}
	 ...
	 */
	@Override
	public StandardsHistoricalManual createStandardsHistoricalManual(
		long stdMnlId) {
		return standardsHistoricalManualPersistence.create(stdMnlId);
	}

	/**
	 * Deletes the standards historical manual with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param stdMnlId the primary key of the standards historical manual
	 * @return the standards historical manual that was removed
	 * @throws PortalException if a standards historical manual with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public StandardsHistoricalManual deleteStandardsHistoricalManual(
		long stdMnlId) throws PortalException, SystemException {
		return standardsHistoricalManualPersistence.remove(stdMnlId);
	}

	/**
	 * Deletes the standards historical manual from the database. Also notifies the appropriate model listeners.
	 *
	 * @param standardsHistoricalManual the standards historical manual
	 * @return the standards historical manual that was removed
	 * @throws SystemException if a system exception occurred
	...
	public StandardsHistoricalManual deleteStandardsHistoricalManual(
		StandardsHistoricalManual standardsHistoricalManual)
		throws SystemException {
		return standardsHistoricalManualPersistence.remove(standardsHistoricalManual);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(StandardsHistoricalManual.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return standardsHistoricalManualPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return standardsHistoricalManualPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public StandardsHistoricalManual fetchStandardsHistoricalManual(
		long stdMnlId) throws SystemException {
		return standardsHistoricalManualPersistence.fetchByPrimaryKey(stdMnlId);
	}

	/**
	 * Returns the standards historical manual with the primary key.
	 *
	 * @param stdMnlId the primary key of the standards historical manual
	 ...
	 */
	@Override
	public StandardsHistoricalManual getStandardsHistoricalManual(long stdMnlId)
		throws PortalException, SystemException {
		return standardsHistoricalManualPersistence.findByPrimaryKey(stdMnlId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return standardsHistoricalManualPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<StandardsHistoricalManual> getStandardsHistoricalManuals(
		...
		return standardsHistoricalManualPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getStandardsHistoricalManualsCount() throws SystemException {
		return standardsHistoricalManualPersistence.countAll();
	}

	/**
	 * Updates the standards historical manual in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param standardsHistoricalManual the standards historical manual
	 * @return the standards historical manual that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public StandardsHistoricalManual updateStandardsHistoricalManual(
		StandardsHistoricalManual standardsHistoricalManual)
		throws SystemException {
		return standardsHistoricalManualPersistence.update(standardsHistoricalManual);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.StandardsHistoricalManual",
			standardsHistoricalManualLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = standardsHistoricalManualPersistence.getDataSource();
	...
	private StandardsHistoricalManualLocalServiceClpInvoker _clpInvoker = new StandardsHistoricalManualLocalServiceClpInvoker();
}