...
import com.ihg.brandstandards.db.service.StandardsExtLocalService;
...
/**
 * Provides the base implementation for the Custom Query mapping between STD and Taxonomy tables. local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.StandardsExtLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 * @see com.ihg.brandstandards.db.service.impl.StandardsExtLocalServiceImpl
 * @see com.ihg.brandstandards.db.service.StandardsExtLocalServiceUtil
 * @generated
 */
public abstract class StandardsExtLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements StandardsExtLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.StandardsExtLocalServiceUtil} to access the Custom Query mapping between STD and Taxonomy tables. local service.
	 */
	...
	@Override
	public StandardsExt addStandardsExt(StandardsExt standardsExt)
		throws SystemException {
		standardsExt.setNew(true);

		return standardsExtPersistence.update(standardsExt);
	}
	 ...
	 */
	@Override
	public StandardsExt createStandardsExt(StandardsExtPK standardsExtPK) {
		return standardsExtPersistence.create(standardsExtPK);
	}
	...
	@Override
	public StandardsExt deleteStandardsExt(StandardsExtPK standardsExtPK)
		throws PortalException, SystemException {
		return standardsExtPersistence.remove(standardsExtPK);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public StandardsExt deleteStandardsExt(StandardsExt standardsExt)
		throws SystemException {
		return standardsExtPersistence.remove(standardsExt);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(StandardsExt.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return standardsExtPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return standardsExtPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public StandardsExt fetchStandardsExt(StandardsExtPK standardsExtPK)
		throws SystemException {
		return standardsExtPersistence.fetchByPrimaryKey(standardsExtPK);
	}
	 ...
	 */
	@Override
	public StandardsExt getStandardsExt(StandardsExtPK standardsExtPK)
		throws PortalException, SystemException {
		return standardsExtPersistence.findByPrimaryKey(standardsExtPK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return standardsExtPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<StandardsExt> getStandardsExts(int start, int end)
		throws SystemException {
		return standardsExtPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getStandardsExtsCount() throws SystemException {
		return standardsExtPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public StandardsExt updateStandardsExt(StandardsExt standardsExt)
		throws SystemException {
		return standardsExtPersistence.update(standardsExt);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.StandardsExt",
			standardsExtLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = standardsExtPersistence.getDataSource();
	...
	private StandardsExtLocalServiceClpInvoker _clpInvoker = new StandardsExtLocalServiceClpInvoker();
}