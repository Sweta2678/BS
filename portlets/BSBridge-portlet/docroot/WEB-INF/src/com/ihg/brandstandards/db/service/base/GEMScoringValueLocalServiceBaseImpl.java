...
import com.ihg.brandstandards.db.service.GEMScoringValueLocalService;
...
/**
 * Provides the base implementation for the g e m scoring value local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.GEMScoringValueLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 * @see com.ihg.brandstandards.db.service.impl.GEMScoringValueLocalServiceImpl
 * @see com.ihg.brandstandards.db.service.GEMScoringValueLocalServiceUtil
 * @generated
 */
public abstract class GEMScoringValueLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements GEMScoringValueLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.GEMScoringValueLocalServiceUtil} to access the g e m scoring value local service.
	 */
	...
	@Override
	public GEMScoringValue addGEMScoringValue(GEMScoringValue gemScoringValue)
		throws SystemException {
		gemScoringValue.setNew(true);

		return gemScoringValuePersistence.update(gemScoringValue);
	}
	 ...
	 */
	@Override
	public GEMScoringValue createGEMScoringValue(long scoringId) {
		return gemScoringValuePersistence.create(scoringId);
	}
	...
	@Override
	public GEMScoringValue deleteGEMScoringValue(long scoringId)
		throws PortalException, SystemException {
		return gemScoringValuePersistence.remove(scoringId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public GEMScoringValue deleteGEMScoringValue(
		GEMScoringValue gemScoringValue) throws SystemException {
		return gemScoringValuePersistence.remove(gemScoringValue);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(GEMScoringValue.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return gemScoringValuePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return gemScoringValuePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public GEMScoringValue fetchGEMScoringValue(long scoringId)
		throws SystemException {
		return gemScoringValuePersistence.fetchByPrimaryKey(scoringId);
	}
	 ...
	 */
	@Override
	public GEMScoringValue getGEMScoringValue(long scoringId)
		throws PortalException, SystemException {
		return gemScoringValuePersistence.findByPrimaryKey(scoringId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return gemScoringValuePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<GEMScoringValue> getGEMScoringValues(int start, int end)
		throws SystemException {
		return gemScoringValuePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getGEMScoringValuesCount() throws SystemException {
		return gemScoringValuePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public GEMScoringValue updateGEMScoringValue(
		GEMScoringValue gemScoringValue) throws SystemException {
		return gemScoringValuePersistence.update(gemScoringValue);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.GEMScoringValue",
			gemScoringValueLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = gemScoringValuePersistence.getDataSource();
	...
	private GEMScoringValueLocalServiceClpInvoker _clpInvoker = new GEMScoringValueLocalServiceClpInvoker();
}