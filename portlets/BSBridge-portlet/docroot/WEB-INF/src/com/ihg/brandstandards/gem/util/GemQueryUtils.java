...
public class GemQueryUtils {
	...
	public static String getGemScoringQuery(long publishDeptId, long parentPublishId, long publishId, long seTemplateId, long regionId, String userName)
	{
        ...
        query.append("CURSOR l_bkt_cur IS SELECT gem_mgt_bucket_id, gem_bucket_nm FROM gem_mgt_bucket WHERE gem_mgt_bucket_id > 0 AND GEM_DEPT_ID=(SELECT GEM_DEPT_ID FROM GEM_PUBLISH_DEPT WHERE GEM_PUBLISH_DEPT_ID=l_publish_dept_id); ");
...
//    -- Trigger Q's
	...
	public static String getGemQLFormRecordsQuery(long bridgePublishId, long gemPublishId, long regionId, String regionCd, String brandCd, String seMnlTypeConfig, String filterRules)
	{
        ...
        query.append(" ,(SELECT listagg(CS.ctry_nm_cd,',') within group (order by CS.std_id)FROM CTRY_STD CS WHERE s.STD_ID = CS.STD_ID GROUP BY CS.STD_ID) AS COUNTRY_CODE");
