...
import com.ihg.brandstandards.db.service.GEMCategoryLocalService;
...
/**
 * Provides the base implementation for the g e m category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.GEMCategoryLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class GEMCategoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements GEMCategoryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.GEMCategoryLocalServiceUtil} to access the g e m category local service.
	 */
	...
	@Override
	public GEMCategory addGEMCategory(GEMCategory gemCategory)
		throws SystemException {
		gemCategory.setNew(true);

		return gemCategoryPersistence.update(gemCategory);
	}
	 ...
	 */
	@Override
	public GEMCategory createGEMCategory(long categoryId) {
		return gemCategoryPersistence.create(categoryId);
	}
	...
	@Override
	public GEMCategory deleteGEMCategory(long categoryId)
		throws PortalException, SystemException {
		return gemCategoryPersistence.remove(categoryId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public GEMCategory deleteGEMCategory(GEMCategory gemCategory)
		throws SystemException {
		return gemCategoryPersistence.remove(gemCategory);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(GEMCategory.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return gemCategoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return gemCategoryPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return gemCategoryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public GEMCategory fetchGEMCategory(long categoryId)
		throws SystemException {
		return gemCategoryPersistence.fetchByPrimaryKey(categoryId);
	}
	 ...
	 */
	@Override
	public GEMCategory getGEMCategory(long categoryId)
		throws PortalException, SystemException {
		return gemCategoryPersistence.findByPrimaryKey(categoryId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return gemCategoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<GEMCategory> getGEMCategories(int start, int end)
		throws SystemException {
		return gemCategoryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getGEMCategoriesCount() throws SystemException {
		return gemCategoryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public GEMCategory updateGEMCategory(GEMCategory gemCategory)
		throws SystemException {
		return gemCategoryPersistence.update(gemCategory);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.GEMCategory",
			gemCategoryLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = gemCategoryPersistence.getDataSource();
	...
	private GEMCategoryLocalServiceClpInvoker _clpInvoker = new GEMCategoryLocalServiceClpInvoker();
}