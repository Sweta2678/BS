...
import com.ihg.brandstandards.db.service.ErrNotificationLocalService;
...
/**
 * Provides the base implementation for the err notification local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.ErrNotificationLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class ErrNotificationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ErrNotificationLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.ErrNotificationLocalServiceUtil} to access the err notification local service.
	 */
	...
	@Override
	public ErrNotification addErrNotification(ErrNotification errNotification)
		throws SystemException {
		errNotification.setNew(true);

		return errNotificationPersistence.update(errNotification);
	}
	 ...
	 */
	@Override
	public ErrNotification createErrNotification(long notificationId) {
		return errNotificationPersistence.create(notificationId);
	}
	...
	@Override
	public ErrNotification deleteErrNotification(long notificationId)
		throws PortalException, SystemException {
		return errNotificationPersistence.remove(notificationId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ErrNotification deleteErrNotification(
		ErrNotification errNotification) throws SystemException {
		return errNotificationPersistence.remove(errNotification);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ErrNotification.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return errNotificationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return errNotificationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ErrNotification fetchErrNotification(long notificationId)
		throws SystemException {
		return errNotificationPersistence.fetchByPrimaryKey(notificationId);
	}
	 ...
	 */
	@Override
	public ErrNotification getErrNotification(long notificationId)
		throws PortalException, SystemException {
		return errNotificationPersistence.findByPrimaryKey(notificationId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return errNotificationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ErrNotification> getErrNotifications(int start, int end)
		throws SystemException {
		return errNotificationPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getErrNotificationsCount() throws SystemException {
		return errNotificationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ErrNotification updateErrNotification(
		ErrNotification errNotification) throws SystemException {
		return errNotificationPersistence.update(errNotification);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.ErrNotification",
			errNotificationLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = errNotificationPersistence.getDataSource();
	...
	private ErrNotificationLocalServiceClpInvoker _clpInvoker = new ErrNotificationLocalServiceClpInvoker();
}