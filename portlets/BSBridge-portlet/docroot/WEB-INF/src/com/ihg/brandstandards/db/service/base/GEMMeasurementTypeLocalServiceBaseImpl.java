...
import com.ihg.brandstandards.db.service.GEMMeasurementTypeLocalService;
...
/**
 * Provides the base implementation for the g e m measurement type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.GEMMeasurementTypeLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 * @see com.ihg.brandstandards.db.service.impl.GEMMeasurementTypeLocalServiceImpl
 * @see com.ihg.brandstandards.db.service.GEMMeasurementTypeLocalServiceUtil
 * @generated
 */
public abstract class GEMMeasurementTypeLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements GEMMeasurementTypeLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.GEMMeasurementTypeLocalServiceUtil} to access the g e m measurement type local service.
	 */
	...
	@Override
	public GEMMeasurementType addGEMMeasurementType(
		GEMMeasurementType gemMeasurementType) throws SystemException {
		gemMeasurementType.setNew(true);

		return gemMeasurementTypePersistence.update(gemMeasurementType);
	}
	 ...
	 */
	@Override
	public GEMMeasurementType createGEMMeasurementType(String measurementType) {
		return gemMeasurementTypePersistence.create(measurementType);
	}
	...
	@Override
	public GEMMeasurementType deleteGEMMeasurementType(String measurementType)
		throws PortalException, SystemException {
		return gemMeasurementTypePersistence.remove(measurementType);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public GEMMeasurementType deleteGEMMeasurementType(
		GEMMeasurementType gemMeasurementType) throws SystemException {
		return gemMeasurementTypePersistence.remove(gemMeasurementType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(GEMMeasurementType.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return gemMeasurementTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return gemMeasurementTypePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public GEMMeasurementType fetchGEMMeasurementType(String measurementType)
		throws SystemException {
		return gemMeasurementTypePersistence.fetchByPrimaryKey(measurementType);
	}
	 ...
	 */
	@Override
	public GEMMeasurementType getGEMMeasurementType(String measurementType)
		throws PortalException, SystemException {
		return gemMeasurementTypePersistence.findByPrimaryKey(measurementType);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return gemMeasurementTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<GEMMeasurementType> getGEMMeasurementTypes(int start, int end)
		throws SystemException {
		return gemMeasurementTypePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getGEMMeasurementTypesCount() throws SystemException {
		return gemMeasurementTypePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public GEMMeasurementType updateGEMMeasurementType(
		GEMMeasurementType gemMeasurementType) throws SystemException {
		return gemMeasurementTypePersistence.update(gemMeasurementType);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.GEMMeasurementType",
			gemMeasurementTypeLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = gemMeasurementTypePersistence.getDataSource();
	...
	private GEMMeasurementTypeLocalServiceClpInvoker _clpInvoker = new GEMMeasurementTypeLocalServiceClpInvoker();
}