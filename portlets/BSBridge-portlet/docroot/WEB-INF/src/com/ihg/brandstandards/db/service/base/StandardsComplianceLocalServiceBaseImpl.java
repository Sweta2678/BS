...
import com.ihg.brandstandards.db.service.StandardsComplianceLocalService;
...
/**
 * Provides the base implementation for the standards compliance local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.StandardsComplianceLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class StandardsComplianceLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements StandardsComplianceLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.StandardsComplianceLocalServiceUtil} to access the standards compliance local service.
	 */
	...
	@Override
	public StandardsCompliance addStandardsCompliance(
		StandardsCompliance standardsCompliance) throws SystemException {
		standardsCompliance.setNew(true);

		return standardsCompliancePersistence.update(standardsCompliance);
	}
	 ...
	 */
	@Override
	public StandardsCompliance createStandardsCompliance(long stdComplianceId) {
		return standardsCompliancePersistence.create(stdComplianceId);
	}
	...
	@Override
	public StandardsCompliance deleteStandardsCompliance(long stdComplianceId)
		throws PortalException, SystemException {
		return standardsCompliancePersistence.remove(stdComplianceId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public StandardsCompliance deleteStandardsCompliance(
		StandardsCompliance standardsCompliance) throws SystemException {
		return standardsCompliancePersistence.remove(standardsCompliance);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(StandardsCompliance.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return standardsCompliancePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return standardsCompliancePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public StandardsCompliance fetchStandardsCompliance(long stdComplianceId)
		throws SystemException {
		return standardsCompliancePersistence.fetchByPrimaryKey(stdComplianceId);
	}
	 ...
	 */
	@Override
	public StandardsCompliance getStandardsCompliance(long stdComplianceId)
		throws PortalException, SystemException {
		return standardsCompliancePersistence.findByPrimaryKey(stdComplianceId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return standardsCompliancePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<StandardsCompliance> getStandardsCompliances(int start, int end)
		throws SystemException {
		return standardsCompliancePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getStandardsCompliancesCount() throws SystemException {
		return standardsCompliancePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public StandardsCompliance updateStandardsCompliance(
		StandardsCompliance standardsCompliance) throws SystemException {
		return standardsCompliancePersistence.update(standardsCompliance);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.StandardsCompliance",
			standardsComplianceLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.StandardsCompliance");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = standardsCompliancePersistence.getDataSource();
	...
	private StandardsComplianceLocalServiceClpInvoker _clpInvoker = new StandardsComplianceLocalServiceClpInvoker();
}