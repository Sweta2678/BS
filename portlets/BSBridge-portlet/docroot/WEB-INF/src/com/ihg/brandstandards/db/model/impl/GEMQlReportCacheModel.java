...
public class GEMQlReportCacheModel implements CacheModel<GEMQlReport>,
	...
	public GEMQlReport toEntityModel() {
		...
		gemQlReportImpl.setParentQlReportId(parentQlReportId);

		if (duplicate == null) {
			gemQlReportImpl.setDuplicate(StringPool.BLANK);
		}
		else {
			gemQlReportImpl.setDuplicate(duplicate);
		}
	...
	public void readExternal(ObjectInput objectInput) throws IOException {
		...
		parentQlReportId = objectInput.readLong();
		duplicate = objectInput.readUTF();
	...
	public void writeExternal(ObjectOutput objectOutput)
		...
		objectOutput.writeLong(parentQlReportId);

		if (duplicate == null) {
			objectOutput.writeUTF(StringPool.BLANK);
		}
		else {
			objectOutput.writeUTF(duplicate);
		}
