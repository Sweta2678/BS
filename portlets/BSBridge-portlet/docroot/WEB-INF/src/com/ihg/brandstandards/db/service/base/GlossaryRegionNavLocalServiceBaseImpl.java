...
import com.ihg.brandstandards.db.service.GlossaryRegionNavLocalService;
...
/**
 * Provides the base implementation for the glossary region nav local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.GlossaryRegionNavLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class GlossaryRegionNavLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements GlossaryRegionNavLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.GlossaryRegionNavLocalServiceUtil} to access the glossary region nav local service.
	 */
	...
	@Override
	public GlossaryRegionNav addGlossaryRegionNav(
		GlossaryRegionNav glossaryRegionNav) throws SystemException {
		glossaryRegionNav.setNew(true);

		return glossaryRegionNavPersistence.update(glossaryRegionNav);
	}
	 ...
	 */
	@Override
	public GlossaryRegionNav createGlossaryRegionNav(long glossaryRgnNavId) {
		return glossaryRegionNavPersistence.create(glossaryRgnNavId);
	}
	...
	@Override
	public GlossaryRegionNav deleteGlossaryRegionNav(long glossaryRgnNavId)
		throws PortalException, SystemException {
		return glossaryRegionNavPersistence.remove(glossaryRgnNavId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public GlossaryRegionNav deleteGlossaryRegionNav(
		GlossaryRegionNav glossaryRegionNav) throws SystemException {
		return glossaryRegionNavPersistence.remove(glossaryRegionNav);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(GlossaryRegionNav.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return glossaryRegionNavPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return glossaryRegionNavPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public GlossaryRegionNav fetchGlossaryRegionNav(long glossaryRgnNavId)
		throws SystemException {
		return glossaryRegionNavPersistence.fetchByPrimaryKey(glossaryRgnNavId);
	}
	 ...
	 */
	@Override
	public GlossaryRegionNav getGlossaryRegionNav(long glossaryRgnNavId)
		throws PortalException, SystemException {
		return glossaryRegionNavPersistence.findByPrimaryKey(glossaryRgnNavId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return glossaryRegionNavPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<GlossaryRegionNav> getGlossaryRegionNavs(int start, int end)
		throws SystemException {
		return glossaryRegionNavPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getGlossaryRegionNavsCount() throws SystemException {
		return glossaryRegionNavPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public GlossaryRegionNav updateGlossaryRegionNav(
		GlossaryRegionNav glossaryRegionNav) throws SystemException {
		return glossaryRegionNavPersistence.update(glossaryRegionNav);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.GlossaryRegionNav",
			glossaryRegionNavLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = glossaryRegionNavPersistence.getDataSource();
	...
	private GlossaryRegionNavLocalServiceClpInvoker _clpInvoker = new GlossaryRegionNavLocalServiceClpInvoker();
}