...
import com.ihg.brandstandards.db.service.BridgePublishStatusLocalService;
...
/**
 * Provides the base implementation for the bridge publish status local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.BridgePublishStatusLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class BridgePublishStatusLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements BridgePublishStatusLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.BridgePublishStatusLocalServiceUtil} to access the bridge publish status local service.
	 */
	...
	@Override
	public BridgePublishStatus addBridgePublishStatus(
		BridgePublishStatus bridgePublishStatus) throws SystemException {
		bridgePublishStatus.setNew(true);

		return bridgePublishStatusPersistence.update(bridgePublishStatus);
	}
	 ...
	 */
	@Override
	public BridgePublishStatus createBridgePublishStatus(
		String publishStatusCode) {
		return bridgePublishStatusPersistence.create(publishStatusCode);
	}
	...
	@Override
	public BridgePublishStatus deleteBridgePublishStatus(
		String publishStatusCode) throws PortalException, SystemException {
		return bridgePublishStatusPersistence.remove(publishStatusCode);
	}
	...
	public BridgePublishStatus deleteBridgePublishStatus(
		BridgePublishStatus bridgePublishStatus) throws SystemException {
		return bridgePublishStatusPersistence.remove(bridgePublishStatus);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(BridgePublishStatus.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return bridgePublishStatusPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return bridgePublishStatusPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public BridgePublishStatus fetchBridgePublishStatus(
		String publishStatusCode) throws SystemException {
		return bridgePublishStatusPersistence.fetchByPrimaryKey(publishStatusCode);
	}
	 ...
	 */
	@Override
	public BridgePublishStatus getBridgePublishStatus(String publishStatusCode)
		throws PortalException, SystemException {
		return bridgePublishStatusPersistence.findByPrimaryKey(publishStatusCode);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return bridgePublishStatusPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<BridgePublishStatus> getBridgePublishStatuses(int start, int end)
		throws SystemException {
		return bridgePublishStatusPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getBridgePublishStatusesCount() throws SystemException {
		return bridgePublishStatusPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public BridgePublishStatus updateBridgePublishStatus(
		BridgePublishStatus bridgePublishStatus) throws SystemException {
		return bridgePublishStatusPersistence.update(bridgePublishStatus);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.BridgePublishStatus",
			bridgePublishStatusLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.BridgePublishStatus");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = bridgePublishStatusPersistence.getDataSource();
	...
	private BridgePublishStatusLocalServiceClpInvoker _clpInvoker = new BridgePublishStatusLocalServiceClpInvoker();
}