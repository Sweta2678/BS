...
import com.ihg.brandstandards.db.service.StandardsImagesLocalService;
...
/**
 * Provides the base implementation for the standards images local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.StandardsImagesLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class StandardsImagesLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements StandardsImagesLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.StandardsImagesLocalServiceUtil} to access the standards images local service.
	 */
	...
	@Override
	public StandardsImages addStandardsImages(StandardsImages standardsImages)
		throws SystemException {
		standardsImages.setNew(true);

		return standardsImagesPersistence.update(standardsImages);
	}
	 ...
	 */
	@Override
	public StandardsImages createStandardsImages(long stdImageId) {
		return standardsImagesPersistence.create(stdImageId);
	}
	...
	@Override
	public StandardsImages deleteStandardsImages(long stdImageId)
		throws PortalException, SystemException {
		return standardsImagesPersistence.remove(stdImageId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public StandardsImages deleteStandardsImages(
		StandardsImages standardsImages) throws SystemException {
		return standardsImagesPersistence.remove(standardsImages);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(StandardsImages.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return standardsImagesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return standardsImagesPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public StandardsImages fetchStandardsImages(long stdImageId)
		throws SystemException {
		return standardsImagesPersistence.fetchByPrimaryKey(stdImageId);
	}
	 ...
	 */
	@Override
	public StandardsImages getStandardsImages(long stdImageId)
		throws PortalException, SystemException {
		return standardsImagesPersistence.findByPrimaryKey(stdImageId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return standardsImagesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<StandardsImages> getStandardsImageses(int start, int end)
		throws SystemException {
		return standardsImagesPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getStandardsImagesesCount() throws SystemException {
		return standardsImagesPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public StandardsImages updateStandardsImages(
		StandardsImages standardsImages) throws SystemException {
		return standardsImagesPersistence.update(standardsImages);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.StandardsImages",
			standardsImagesLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = standardsImagesPersistence.getDataSource();
	...
	private StandardsImagesLocalServiceClpInvoker _clpInvoker = new StandardsImagesLocalServiceClpInvoker();
}