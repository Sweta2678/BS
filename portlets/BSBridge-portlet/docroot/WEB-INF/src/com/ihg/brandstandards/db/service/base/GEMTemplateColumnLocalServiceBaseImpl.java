...
import com.ihg.brandstandards.db.service.GEMTemplateColumnLocalService;
...
/**
 * Provides the base implementation for the g e m template column local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.GEMTemplateColumnLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 * @see com.ihg.brandstandards.db.service.impl.GEMTemplateColumnLocalServiceImpl
 * @see com.ihg.brandstandards.db.service.GEMTemplateColumnLocalServiceUtil
 * @generated
 */
public abstract class GEMTemplateColumnLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements GEMTemplateColumnLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.GEMTemplateColumnLocalServiceUtil} to access the g e m template column local service.
	 */
	...
	@Override
	public GEMTemplateColumn addGEMTemplateColumn(
		GEMTemplateColumn gemTemplateColumn) throws SystemException {
		gemTemplateColumn.setNew(true);

		return gemTemplateColumnPersistence.update(gemTemplateColumn);
	}
	 ...
	 */
	@Override
	public GEMTemplateColumn createGEMTemplateColumn(long columnId) {
		return gemTemplateColumnPersistence.create(columnId);
	}
	...
	@Override
	public GEMTemplateColumn deleteGEMTemplateColumn(long columnId)
		throws PortalException, SystemException {
		return gemTemplateColumnPersistence.remove(columnId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public GEMTemplateColumn deleteGEMTemplateColumn(
		GEMTemplateColumn gemTemplateColumn) throws SystemException {
		return gemTemplateColumnPersistence.remove(gemTemplateColumn);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(GEMTemplateColumn.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return gemTemplateColumnPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return gemTemplateColumnPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public GEMTemplateColumn fetchGEMTemplateColumn(long columnId)
		throws SystemException {
		return gemTemplateColumnPersistence.fetchByPrimaryKey(columnId);
	}
	 ...
	 */
	@Override
	public GEMTemplateColumn getGEMTemplateColumn(long columnId)
		throws PortalException, SystemException {
		return gemTemplateColumnPersistence.findByPrimaryKey(columnId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return gemTemplateColumnPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<GEMTemplateColumn> getGEMTemplateColumns(int start, int end)
		throws SystemException {
		return gemTemplateColumnPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getGEMTemplateColumnsCount() throws SystemException {
		return gemTemplateColumnPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public GEMTemplateColumn updateGEMTemplateColumn(
		GEMTemplateColumn gemTemplateColumn) throws SystemException {
		return gemTemplateColumnPersistence.update(gemTemplateColumn);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.GEMTemplateColumn",
			gemTemplateColumnLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = gemTemplateColumnPersistence.getDataSource();
	...
	private GEMTemplateColumnLocalServiceClpInvoker _clpInvoker = new GEMTemplateColumnLocalServiceClpInvoker();
}