...
import com.ihg.brandstandards.db.service.GEMGeneratedReportLocalService;
...
/**
 * Provides the base implementation for the g e m generated report local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.GEMGeneratedReportLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 * @see com.ihg.brandstandards.db.service.impl.GEMGeneratedReportLocalServiceImpl
 * @see com.ihg.brandstandards.db.service.GEMGeneratedReportLocalServiceUtil
 * @generated
 */
public abstract class GEMGeneratedReportLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements GEMGeneratedReportLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.GEMGeneratedReportLocalServiceUtil} to access the g e m generated report local service.
	 */
	...
	@Override
	public GEMGeneratedReport addGEMGeneratedReport(
		GEMGeneratedReport gemGeneratedReport) throws SystemException {
		gemGeneratedReport.setNew(true);

		return gemGeneratedReportPersistence.update(gemGeneratedReport);
	}
	 ...
	 */
	@Override
	public GEMGeneratedReport createGEMGeneratedReport(long reportId) {
		return gemGeneratedReportPersistence.create(reportId);
	}
	...
	@Override
	public GEMGeneratedReport deleteGEMGeneratedReport(long reportId)
		throws PortalException, SystemException {
		return gemGeneratedReportPersistence.remove(reportId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public GEMGeneratedReport deleteGEMGeneratedReport(
		GEMGeneratedReport gemGeneratedReport) throws SystemException {
		return gemGeneratedReportPersistence.remove(gemGeneratedReport);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(GEMGeneratedReport.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return gemGeneratedReportPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return gemGeneratedReportPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public GEMGeneratedReport fetchGEMGeneratedReport(long reportId)
		throws SystemException {
		return gemGeneratedReportPersistence.fetchByPrimaryKey(reportId);
	}
	 ...
	 */
	@Override
	public GEMGeneratedReport getGEMGeneratedReport(long reportId)
		throws PortalException, SystemException {
		return gemGeneratedReportPersistence.findByPrimaryKey(reportId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return gemGeneratedReportPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<GEMGeneratedReport> getGEMGeneratedReports(int start, int end)
		throws SystemException {
		return gemGeneratedReportPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getGEMGeneratedReportsCount() throws SystemException {
		return gemGeneratedReportPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public GEMGeneratedReport updateGEMGeneratedReport(
		GEMGeneratedReport gemGeneratedReport) throws SystemException {
		return gemGeneratedReportPersistence.update(gemGeneratedReport);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.GEMGeneratedReport",
			gemGeneratedReportLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.GEMGeneratedReport");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = gemGeneratedReportPersistence.getDataSource();
	...
	private GEMGeneratedReportLocalServiceClpInvoker _clpInvoker = new GEMGeneratedReportLocalServiceClpInvoker();
}