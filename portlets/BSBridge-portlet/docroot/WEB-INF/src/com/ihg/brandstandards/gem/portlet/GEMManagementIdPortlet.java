	...
	public void doView(RenderRequest renderRequest,
		...
		try 
		{
			...
			if(chnCdMap != null && chnCdMap.size() > 0 && brandCode != null && subBrandCacheMap!=null && subBrandCacheMap.size() > 0) 
			{
				...
				else if(brandCode.equals("CV") || brandCode.equals("RS"))
				{
					subBrands = (String) subBrandCacheMap.get("HI");
				}
				else if(brandCode.equals("IR"))
				{
					subBrands = (String) subBrandCacheMap.get("IC");
				}
				else 
				{
