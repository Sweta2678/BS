...
import com.ihg.brandstandards.db.service.BrandTaxonomyLocalService;
...
/**
 * Provides the base implementation for the brand taxonomy local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.BrandTaxonomyLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 * @see com.ihg.brandstandards.db.service.impl.BrandTaxonomyLocalServiceImpl
 * @see com.ihg.brandstandards.db.service.BrandTaxonomyLocalServiceUtil
 * @generated
 */
public abstract class BrandTaxonomyLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements BrandTaxonomyLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.BrandTaxonomyLocalServiceUtil} to access the brand taxonomy local service.
	 */

	/**
	 * Adds the brand taxonomy to the database. Also notifies the appropriate model listeners.
	 *
	 * @param brandTaxonomy the brand taxonomy
	 * @return the brand taxonomy that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public BrandTaxonomy addBrandTaxonomy(BrandTaxonomy brandTaxonomy)
		throws SystemException {
		brandTaxonomy.setNew(true);

		return brandTaxonomyPersistence.update(brandTaxonomy);
	}
	 ...
	 */
	@Override
	public BrandTaxonomy createBrandTaxonomy(long id) {
		return brandTaxonomyPersistence.create(id);
	}

	/**
	 * Deletes the brand taxonomy with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param id the primary key of the brand taxonomy
	 * @return the brand taxonomy that was removed
	 * @throws PortalException if a brand taxonomy with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public BrandTaxonomy deleteBrandTaxonomy(long id)
		throws PortalException, SystemException {
		return brandTaxonomyPersistence.remove(id);
	}

	/**
	 * Deletes the brand taxonomy from the database. Also notifies the appropriate model listeners.
	 *
	 * @param brandTaxonomy the brand taxonomy
	 * @return the brand taxonomy that was removed
	 * @throws SystemException if a system exception occurred
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public BrandTaxonomy deleteBrandTaxonomy(BrandTaxonomy brandTaxonomy)
		throws SystemException {
		return brandTaxonomyPersistence.remove(brandTaxonomy);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(BrandTaxonomy.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return brandTaxonomyPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return brandTaxonomyPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public BrandTaxonomy fetchBrandTaxonomy(long id) throws SystemException {
		return brandTaxonomyPersistence.fetchByPrimaryKey(id);
	}

	/**
	 * Returns the brand taxonomy with the primary key.
	 *
	 * @param id the primary key of the brand taxonomy
	 ...
	 */
	@Override
	public BrandTaxonomy getBrandTaxonomy(long id)
		throws PortalException, SystemException {
		return brandTaxonomyPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return brandTaxonomyPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<BrandTaxonomy> getBrandTaxonomies(int start, int end)
		throws SystemException {
		return brandTaxonomyPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getBrandTaxonomiesCount() throws SystemException {
		return brandTaxonomyPersistence.countAll();
	}

	/**
	 * Updates the brand taxonomy in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param brandTaxonomy the brand taxonomy
	 * @return the brand taxonomy that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public BrandTaxonomy updateBrandTaxonomy(BrandTaxonomy brandTaxonomy)
		throws SystemException {
		return brandTaxonomyPersistence.update(brandTaxonomy);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.BrandTaxonomy",
			brandTaxonomyLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.BrandTaxonomy");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = brandTaxonomyPersistence.getDataSource();
	...
	private BrandTaxonomyLocalServiceClpInvoker _clpInvoker = new BrandTaxonomyLocalServiceClpInvoker();
}