...
import com.ihg.brandstandards.db.service.UserSearchCriteriaLocalService;
...
/**
 * Provides the base implementation for the user search criteria local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.UserSearchCriteriaLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class UserSearchCriteriaLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements UserSearchCriteriaLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.UserSearchCriteriaLocalServiceUtil} to access the user search criteria local service.
	 */
	...
	@Override
	public UserSearchCriteria addUserSearchCriteria(
		UserSearchCriteria userSearchCriteria) throws SystemException {
		userSearchCriteria.setNew(true);

		return userSearchCriteriaPersistence.update(userSearchCriteria);
	}
	 ...
	 */
	@Override
	public UserSearchCriteria createUserSearchCriteria(long userSearchId) {
		return userSearchCriteriaPersistence.create(userSearchId);
	}
	...
	@Override
	public UserSearchCriteria deleteUserSearchCriteria(long userSearchId)
		throws PortalException, SystemException {
		return userSearchCriteriaPersistence.remove(userSearchId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public UserSearchCriteria deleteUserSearchCriteria(
		UserSearchCriteria userSearchCriteria) throws SystemException {
		return userSearchCriteriaPersistence.remove(userSearchCriteria);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(UserSearchCriteria.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return userSearchCriteriaPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return userSearchCriteriaPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public UserSearchCriteria fetchUserSearchCriteria(long userSearchId)
		throws SystemException {
		return userSearchCriteriaPersistence.fetchByPrimaryKey(userSearchId);
	}
	 ...
	 */
	@Override
	public UserSearchCriteria getUserSearchCriteria(long userSearchId)
		throws PortalException, SystemException {
		return userSearchCriteriaPersistence.findByPrimaryKey(userSearchId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return userSearchCriteriaPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<UserSearchCriteria> getUserSearchCriterias(int start, int end)
		throws SystemException {
		return userSearchCriteriaPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getUserSearchCriteriasCount() throws SystemException {
		return userSearchCriteriaPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public UserSearchCriteria updateUserSearchCriteria(
		UserSearchCriteria userSearchCriteria) throws SystemException {
		return userSearchCriteriaPersistence.update(userSearchCriteria);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.UserSearchCriteria",
			userSearchCriteriaLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.UserSearchCriteria");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = userSearchCriteriaPersistence.getDataSource();
	...
	private UserSearchCriteriaLocalServiceClpInvoker _clpInvoker = new UserSearchCriteriaLocalServiceClpInvoker();
}