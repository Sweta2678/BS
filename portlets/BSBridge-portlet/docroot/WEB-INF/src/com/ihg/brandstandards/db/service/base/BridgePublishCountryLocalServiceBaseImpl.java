...
import com.ihg.brandstandards.db.service.BridgePublishCountryLocalService;
...
/**
 * Provides the base implementation for the bridge publish country local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.BridgePublishCountryLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 * @see com.ihg.brandstandards.db.service.impl.BridgePublishCountryLocalServiceImpl
 * @see com.ihg.brandstandards.db.service.BridgePublishCountryLocalServiceUtil
 * @generated
 */
public abstract class BridgePublishCountryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements BridgePublishCountryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.BridgePublishCountryLocalServiceUtil} to access the bridge publish country local service.
	 */

	/**
	 * Adds the bridge publish country to the database. Also notifies the appropriate model listeners.
	 *
	 * @param bridgePublishCountry the bridge publish country
	 * @return the bridge publish country that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public BridgePublishCountry addBridgePublishCountry(
		BridgePublishCountry bridgePublishCountry) throws SystemException {
		bridgePublishCountry.setNew(true);

		return bridgePublishCountryPersistence.update(bridgePublishCountry);
	}
	 ...
	 */
	@Override
	public BridgePublishCountry createBridgePublishCountry(long publishCtryId) {
		return bridgePublishCountryPersistence.create(publishCtryId);
	}

	/**
	 * Deletes the bridge publish country with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param publishCtryId the primary key of the bridge publish country
	 * @return the bridge publish country that was removed
	 * @throws PortalException if a bridge publish country with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public BridgePublishCountry deleteBridgePublishCountry(long publishCtryId)
		throws PortalException, SystemException {
		return bridgePublishCountryPersistence.remove(publishCtryId);
	}

	/**
	 * Deletes the bridge publish country from the database. Also notifies the appropriate model listeners.
	 *
	 * @param bridgePublishCountry the bridge publish country
	 * @return the bridge publish country that was removed
	 * @throws SystemException if a system exception occurred
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public BridgePublishCountry deleteBridgePublishCountry(
		BridgePublishCountry bridgePublishCountry) throws SystemException {
		return bridgePublishCountryPersistence.remove(bridgePublishCountry);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(BridgePublishCountry.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return bridgePublishCountryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return bridgePublishCountryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public BridgePublishCountry fetchBridgePublishCountry(long publishCtryId)
		throws SystemException {
		return bridgePublishCountryPersistence.fetchByPrimaryKey(publishCtryId);
	}

	/**
	 * Returns the bridge publish country with the primary key.
	 *
	 * @param publishCtryId the primary key of the bridge publish country
	 ...
	 */
	@Override
	public BridgePublishCountry getBridgePublishCountry(long publishCtryId)
		throws PortalException, SystemException {
		return bridgePublishCountryPersistence.findByPrimaryKey(publishCtryId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return bridgePublishCountryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<BridgePublishCountry> getBridgePublishCountries(int start,
		int end) throws SystemException {
		return bridgePublishCountryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getBridgePublishCountriesCount() throws SystemException {
		return bridgePublishCountryPersistence.countAll();
	}

	/**
	 * Updates the bridge publish country in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param bridgePublishCountry the bridge publish country
	 * @return the bridge publish country that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public BridgePublishCountry updateBridgePublishCountry(
		BridgePublishCountry bridgePublishCountry) throws SystemException {
		return bridgePublishCountryPersistence.update(bridgePublishCountry);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.BridgePublishCountry",
			bridgePublishCountryLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = bridgePublishCountryPersistence.getDataSource();
	...
	private BridgePublishCountryLocalServiceClpInvoker _clpInvoker = new BridgePublishCountryLocalServiceClpInvoker();
}