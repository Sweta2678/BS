...
import com.ihg.brandstandards.db.service.GEMTriggerLocalService;
...
/**
 * Provides the base implementation for the g e m trigger local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.GEMTriggerLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class GEMTriggerLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements GEMTriggerLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.GEMTriggerLocalServiceUtil} to access the g e m trigger local service.
	 */
	...
	@Override
	public GEMTrigger addGEMTrigger(GEMTrigger gemTrigger)
		throws SystemException {
		gemTrigger.setNew(true);

		return gemTriggerPersistence.update(gemTrigger);
	}
	 ...
	 */
	@Override
	public GEMTrigger createGEMTrigger(long triggerId) {
		return gemTriggerPersistence.create(triggerId);
	}
	...
	@Override
	public GEMTrigger deleteGEMTrigger(long triggerId)
		throws PortalException, SystemException {
		return gemTriggerPersistence.remove(triggerId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public GEMTrigger deleteGEMTrigger(GEMTrigger gemTrigger)
		throws SystemException {
		return gemTriggerPersistence.remove(gemTrigger);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(GEMTrigger.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return gemTriggerPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return gemTriggerPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return gemTriggerPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public GEMTrigger fetchGEMTrigger(long triggerId) throws SystemException {
		return gemTriggerPersistence.fetchByPrimaryKey(triggerId);
	}
	 ...
	 */
	@Override
	public GEMTrigger getGEMTrigger(long triggerId)
		throws PortalException, SystemException {
		return gemTriggerPersistence.findByPrimaryKey(triggerId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return gemTriggerPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<GEMTrigger> getGEMTriggers(int start, int end)
		throws SystemException {
		return gemTriggerPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getGEMTriggersCount() throws SystemException {
		return gemTriggerPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public GEMTrigger updateGEMTrigger(GEMTrigger gemTrigger)
		throws SystemException {
		return gemTriggerPersistence.update(gemTrigger);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.GEMTrigger",
			gemTriggerLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = gemTriggerPersistence.getDataSource();
	...
	private GEMTriggerLocalServiceClpInvoker _clpInvoker = new GEMTriggerLocalServiceClpInvoker();
}