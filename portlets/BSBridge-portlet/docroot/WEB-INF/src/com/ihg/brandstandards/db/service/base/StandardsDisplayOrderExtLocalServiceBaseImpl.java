...
import com.ihg.brandstandards.db.service.StandardsDisplayOrderExtLocalService;
...
/**
 * Provides the base implementation for the standards display order ext local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.StandardsDisplayOrderExtLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 * @see com.ihg.brandstandards.db.service.impl.StandardsDisplayOrderExtLocalServiceImpl
 * @see com.ihg.brandstandards.db.service.StandardsDisplayOrderExtLocalServiceUtil
 * @generated
 */
public abstract class StandardsDisplayOrderExtLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements StandardsDisplayOrderExtLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.StandardsDisplayOrderExtLocalServiceUtil} to access the standards display order ext local service.
	 */

	/**
	 * Adds the standards display order ext to the database. Also notifies the appropriate model listeners.
	 *
	 * @param standardsDisplayOrderExt the standards display order ext
	 * @return the standards display order ext that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public StandardsDisplayOrderExt addStandardsDisplayOrderExt(
		StandardsDisplayOrderExt standardsDisplayOrderExt)
		throws SystemException {
		standardsDisplayOrderExt.setNew(true);

		return standardsDisplayOrderExtPersistence.update(standardsDisplayOrderExt);
	}
	 ...
	 */
	@Override
	public StandardsDisplayOrderExt createStandardsDisplayOrderExt(long stdId) {
		return standardsDisplayOrderExtPersistence.create(stdId);
	}

	/**
	 * Deletes the standards display order ext with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param stdId the primary key of the standards display order ext
	 * @return the standards display order ext that was removed
	 * @throws PortalException if a standards display order ext with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public StandardsDisplayOrderExt deleteStandardsDisplayOrderExt(long stdId)
		throws PortalException, SystemException {
		return standardsDisplayOrderExtPersistence.remove(stdId);
	}

	/**
	 * Deletes the standards display order ext from the database. Also notifies the appropriate model listeners.
	 *
	 * @param standardsDisplayOrderExt the standards display order ext
	 * @return the standards display order ext that was removed
	 * @throws SystemException if a system exception occurred
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public StandardsDisplayOrderExt deleteStandardsDisplayOrderExt(
		StandardsDisplayOrderExt standardsDisplayOrderExt)
		throws SystemException {
		return standardsDisplayOrderExtPersistence.remove(standardsDisplayOrderExt);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(StandardsDisplayOrderExt.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return standardsDisplayOrderExtPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return standardsDisplayOrderExtPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public StandardsDisplayOrderExt fetchStandardsDisplayOrderExt(long stdId)
		throws SystemException {
		return standardsDisplayOrderExtPersistence.fetchByPrimaryKey(stdId);
	}

	/**
	 * Returns the standards display order ext with the primary key.
	 *
	 * @param stdId the primary key of the standards display order ext
	 ...
	 */
	@Override
	public StandardsDisplayOrderExt getStandardsDisplayOrderExt(long stdId)
		throws PortalException, SystemException {
		return standardsDisplayOrderExtPersistence.findByPrimaryKey(stdId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return standardsDisplayOrderExtPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<StandardsDisplayOrderExt> getStandardsDisplayOrderExts(
		int start, int end) throws SystemException {
		return standardsDisplayOrderExtPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getStandardsDisplayOrderExtsCount() throws SystemException {
		return standardsDisplayOrderExtPersistence.countAll();
	}

	/**
	 * Updates the standards display order ext in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param standardsDisplayOrderExt the standards display order ext
	 * @return the standards display order ext that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public StandardsDisplayOrderExt updateStandardsDisplayOrderExt(
		StandardsDisplayOrderExt standardsDisplayOrderExt)
		throws SystemException {
		return standardsDisplayOrderExtPersistence.update(standardsDisplayOrderExt);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.StandardsDisplayOrderExt",
			standardsDisplayOrderExtLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.StandardsDisplayOrderExt");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = standardsDisplayOrderExtPersistence.getDataSource();
	...
	private StandardsDisplayOrderExtLocalServiceClpInvoker _clpInvoker = new StandardsDisplayOrderExtLocalServiceClpInvoker();
}