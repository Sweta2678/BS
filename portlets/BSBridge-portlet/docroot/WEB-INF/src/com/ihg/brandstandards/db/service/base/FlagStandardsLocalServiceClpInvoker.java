...
public class FlagStandardsLocalServiceClpInvoker {
	public FlagStandardsLocalServiceClpInvoker() {
		...
		_methodName614 = "getFlagStandardsObject";

		_methodParameterTypes614 = new String[] {  };

		_methodName615 = "getFlagStandardsByStdId";

		_methodParameterTypes615 = new String[] { "long" };

		_methodName616 = "getFlagStandardByFlagId";

		_methodParameterTypes616 = new String[] { "long" };

		_methodName617 = "getFlagStandardByStandardAndCategoryId";

		_methodParameterTypes617 = new String[] { "long", "long" };

		_methodName618 = "getFlagIdsByStandardAndCategoryId";

		_methodParameterTypes618 = new String[] { "long", "java.util.List" };

		_methodName619 = "getFlagIdsByStdId";

		_methodParameterTypes619 = new String[] { "long" };

		_methodName620 = "clearCache";
