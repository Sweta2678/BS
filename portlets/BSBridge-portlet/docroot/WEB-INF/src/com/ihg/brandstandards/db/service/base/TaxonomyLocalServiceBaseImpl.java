...
import com.ihg.brandstandards.db.service.TaxonomyLocalService;
...
/**
 * Provides the base implementation for the taxonomy local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.TaxonomyLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class TaxonomyLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements TaxonomyLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.TaxonomyLocalServiceUtil} to access the taxonomy local service.
	 */
	...
	@Override
	public Taxonomy addTaxonomy(Taxonomy taxonomy) throws SystemException {
	 ...
	 */
	@Override
	public Taxonomy createTaxonomy(long taxId) {
		return taxonomyPersistence.create(taxId);
	}
	...
	@Override
	public Taxonomy deleteTaxonomy(long taxId)
		throws PortalException, SystemException {
		return taxonomyPersistence.remove(taxId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Taxonomy deleteTaxonomy(Taxonomy taxonomy) throws SystemException {
		return taxonomyPersistence.remove(taxonomy);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Taxonomy.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return taxonomyPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return taxonomyPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return taxonomyPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return taxonomyPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public Taxonomy fetchTaxonomy(long taxId) throws SystemException {
		return taxonomyPersistence.fetchByPrimaryKey(taxId);
	}
	 ...
	 */
	@Override
	public Taxonomy getTaxonomy(long taxId)
		throws PortalException, SystemException {
		return taxonomyPersistence.findByPrimaryKey(taxId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return taxonomyPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Taxonomy> getTaxonomies(int start, int end)
		throws SystemException {
		return taxonomyPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTaxonomiesCount() throws SystemException {
		return taxonomyPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Taxonomy updateTaxonomy(Taxonomy taxonomy) throws SystemException {
		return taxonomyPersistence.update(taxonomy);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.Taxonomy",
			taxonomyLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = taxonomyPersistence.getDataSource();
	...
	private TaxonomyLocalServiceClpInvoker _clpInvoker = new TaxonomyLocalServiceClpInvoker();
}