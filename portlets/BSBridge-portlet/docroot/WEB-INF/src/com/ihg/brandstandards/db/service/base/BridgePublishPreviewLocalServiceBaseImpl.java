...
import com.ihg.brandstandards.db.service.BridgePublishPreviewLocalService;
...
/**
 * Provides the base implementation for the bridge publish preview local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.BridgePublishPreviewLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class BridgePublishPreviewLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements BridgePublishPreviewLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.BridgePublishPreviewLocalServiceUtil} to access the bridge publish preview local service.
	 */
	...
	@Override
	public BridgePublishPreview addBridgePublishPreview(
		BridgePublishPreview bridgePublishPreview) throws SystemException {
		bridgePublishPreview.setNew(true);

		return bridgePublishPreviewPersistence.update(bridgePublishPreview);
	}
	 ...
	 */
	@Override
	public BridgePublishPreview createBridgePublishPreview(long stdId) {
		return bridgePublishPreviewPersistence.create(stdId);
	}
	...
	@Override
	public BridgePublishPreview deleteBridgePublishPreview(long stdId)
		throws PortalException, SystemException {
		return bridgePublishPreviewPersistence.remove(stdId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public BridgePublishPreview deleteBridgePublishPreview(
		BridgePublishPreview bridgePublishPreview) throws SystemException {
		return bridgePublishPreviewPersistence.remove(bridgePublishPreview);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(BridgePublishPreview.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return bridgePublishPreviewPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return bridgePublishPreviewPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public BridgePublishPreview fetchBridgePublishPreview(long stdId)
		throws SystemException {
		return bridgePublishPreviewPersistence.fetchByPrimaryKey(stdId);
	}
	 ...
	 */
	@Override
	public BridgePublishPreview getBridgePublishPreview(long stdId)
		throws PortalException, SystemException {
		return bridgePublishPreviewPersistence.findByPrimaryKey(stdId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return bridgePublishPreviewPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<BridgePublishPreview> getBridgePublishPreviews(int start,
		int end) throws SystemException {
		return bridgePublishPreviewPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getBridgePublishPreviewsCount() throws SystemException {
		return bridgePublishPreviewPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public BridgePublishPreview updateBridgePublishPreview(
		BridgePublishPreview bridgePublishPreview) throws SystemException {
		return bridgePublishPreviewPersistence.update(bridgePublishPreview);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.BridgePublishPreview",
			bridgePublishPreviewLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.BridgePublishPreview");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = bridgePublishPreviewPersistence.getDataSource();
	...
	private BridgePublishPreviewLocalServiceClpInvoker _clpInvoker = new BridgePublishPreviewLocalServiceClpInvoker();
}