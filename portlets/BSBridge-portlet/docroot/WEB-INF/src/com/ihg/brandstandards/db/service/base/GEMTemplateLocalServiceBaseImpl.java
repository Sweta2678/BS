...
import com.ihg.brandstandards.db.service.GEMTemplateLocalService;
...
/**
 * Provides the base implementation for the g e m template local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.GEMTemplateLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class GEMTemplateLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements GEMTemplateLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.GEMTemplateLocalServiceUtil} to access the g e m template local service.
	 */
	...
	@Override
	public GEMTemplate addGEMTemplate(GEMTemplate gemTemplate)
		throws SystemException {
		gemTemplate.setNew(true);

		return gemTemplatePersistence.update(gemTemplate);
	}
	 ...
	 */
	@Override
	public GEMTemplate createGEMTemplate(long templateId) {
		return gemTemplatePersistence.create(templateId);
	}
	...
	@Override
	public GEMTemplate deleteGEMTemplate(long templateId)
		throws PortalException, SystemException {
		return gemTemplatePersistence.remove(templateId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public GEMTemplate deleteGEMTemplate(GEMTemplate gemTemplate)
		throws SystemException {
		return gemTemplatePersistence.remove(gemTemplate);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(GEMTemplate.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return gemTemplatePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return gemTemplatePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return gemTemplatePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public GEMTemplate fetchGEMTemplate(long templateId)
		throws SystemException {
		return gemTemplatePersistence.fetchByPrimaryKey(templateId);
	}
	 ...
	 */
	@Override
	public GEMTemplate getGEMTemplate(long templateId)
		throws PortalException, SystemException {
		return gemTemplatePersistence.findByPrimaryKey(templateId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return gemTemplatePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<GEMTemplate> getGEMTemplates(int start, int end)
		throws SystemException {
		return gemTemplatePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getGEMTemplatesCount() throws SystemException {
		return gemTemplatePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public GEMTemplate updateGEMTemplate(GEMTemplate gemTemplate)
		throws SystemException {
		return gemTemplatePersistence.update(gemTemplate);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.GEMTemplate",
			gemTemplateLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = gemTemplatePersistence.getDataSource();
	...
	private GEMTemplateLocalServiceClpInvoker _clpInvoker = new GEMTemplateLocalServiceClpInvoker();
}