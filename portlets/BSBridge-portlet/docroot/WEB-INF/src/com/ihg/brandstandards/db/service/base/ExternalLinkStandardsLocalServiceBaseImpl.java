...
/**
 * Provides the base implementation for the external link standards local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.ExternalLinkStandardsLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class ExternalLinkStandardsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ExternalLinkStandardsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.ExternalLinkStandardsLocalServiceUtil} to access the external link standards local service.
	 */
	...
	@Override
	public ExternalLinkStandards addExternalLinkStandards(
		ExternalLinkStandards externalLinkStandards) throws SystemException {
		externalLinkStandards.setNew(true);

		return externalLinkStandardsPersistence.update(externalLinkStandards);
	}
	 ...
	 */
	@Override
	public ExternalLinkStandards createExternalLinkStandards(long extLinkId) {
		return externalLinkStandardsPersistence.create(extLinkId);
	}
	...
	@Override
	public ExternalLinkStandards deleteExternalLinkStandards(long extLinkId)
		throws PortalException, SystemException {
		return externalLinkStandardsPersistence.remove(extLinkId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ExternalLinkStandards deleteExternalLinkStandards(
		ExternalLinkStandards externalLinkStandards) throws SystemException {
		return externalLinkStandardsPersistence.remove(externalLinkStandards);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ExternalLinkStandards.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return externalLinkStandardsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return externalLinkStandardsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ExternalLinkStandards fetchExternalLinkStandards(long extLinkId)
		throws SystemException {
		return externalLinkStandardsPersistence.fetchByPrimaryKey(extLinkId);
	}
	 ...
	 */
	@Override
	public ExternalLinkStandards getExternalLinkStandards(long extLinkId)
		throws PortalException, SystemException {
		return externalLinkStandardsPersistence.findByPrimaryKey(extLinkId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return externalLinkStandardsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ExternalLinkStandards> getExternalLinkStandardses(int start,
		int end) throws SystemException {
		return externalLinkStandardsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getExternalLinkStandardsesCount() throws SystemException {
		return externalLinkStandardsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ExternalLinkStandards updateExternalLinkStandards(
		ExternalLinkStandards externalLinkStandards) throws SystemException {
		return externalLinkStandardsPersistence.update(externalLinkStandards);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.ExternalLinkStandards",
			externalLinkStandardsLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = externalLinkStandardsPersistence.getDataSource();
	...
	private ExternalLinkStandardsLocalServiceClpInvoker _clpInvoker = new ExternalLinkStandardsLocalServiceClpInvoker();
}