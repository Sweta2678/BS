...
/**
 * The persistence utility for the g e m template column service. This utility wraps {@link GEMTemplateColumnPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class GEMTemplateColumnUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(GEMTemplateColumn gemTemplateColumn) {
		getPersistence().clearCache(gemTemplateColumn);
	}
	 ...
	 */
	public static List<GEMTemplateColumn> findWithDynamicQuery(
	 ...
	 */
	public static GEMTemplateColumn update(GEMTemplateColumn gemTemplateColumn)
		throws SystemException {
		return getPersistence().update(gemTemplateColumn);
	}

	/**
	 * @see com.liferay.portal.service.persistence.BasePersistence#update(com.liferay.portal.model.BaseModel, ServiceContext)
	 */
	public static GEMTemplateColumn update(
		GEMTemplateColumn gemTemplateColumn, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(gemTemplateColumn, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(gemTemplateColumn);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(gemTemplateColumns);
	}
	...
	*/
	public static com.ihg.brandstandards.db.model.GEMTemplateColumn create(
		long columnId) {
	...
	*/
	public static com.ihg.brandstandards.db.model.GEMTemplateColumn remove(
		long columnId)
	...
	public static com.ihg.brandstandards.db.model.GEMTemplateColumn updateImpl(
		com.ihg.brandstandards.db.model.GEMTemplateColumn gemTemplateColumn)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(gemTemplateColumn);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.GEMTemplateColumn findByPrimaryKey(
		long columnId)
		throws com.ihg.brandstandards.db.NoSuchGEMTemplateColumnException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.GEMTemplateColumn fetchByPrimaryKey(
		long columnId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.ihg.brandstandards.db.model.GEMTemplateColumn> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static GEMTemplateColumnPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (GEMTemplateColumnPersistence)PortletBeanLocatorUtil.locate(com.ihg.brandstandards.db.service.ClpSerializer.getServletContextName(),
					GEMTemplateColumnPersistence.class.getName());

			ReferenceRegistry.registerReference(GEMTemplateColumnUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(GEMTemplateColumnPersistence persistence) {
	}

	private static GEMTemplateColumnPersistence _persistence;
}