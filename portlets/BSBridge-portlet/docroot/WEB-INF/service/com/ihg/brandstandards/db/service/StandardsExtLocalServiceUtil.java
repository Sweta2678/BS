...
/**
 * Provides the local service utility for StandardsExt. This utility wraps
 * {@link com.ihg.brandstandards.db.service.impl.StandardsExtLocalServiceImpl} and is the
 ...
 * @generated
 */
public class StandardsExtLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.ihg.brandstandards.db.service.impl.StandardsExtLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.ihg.brandstandards.db.model.StandardsExt addStandardsExt(
		com.ihg.brandstandards.db.model.StandardsExt standardsExt)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addStandardsExt(standardsExt);
	}
	...
	*/
	public static com.ihg.brandstandards.db.model.StandardsExt createStandardsExt(
		com.ihg.brandstandards.db.service.persistence.StandardsExtPK standardsExtPK) {
		return getService().createStandardsExt(standardsExtPK);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.StandardsExt deleteStandardsExt(
		com.ihg.brandstandards.db.service.persistence.StandardsExtPK standardsExtPK)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteStandardsExt(standardsExtPK);
	}
	...
	*/
	public static com.ihg.brandstandards.db.model.StandardsExt deleteStandardsExt(
		com.ihg.brandstandards.db.model.StandardsExt standardsExt)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteStandardsExt(standardsExt);
	}
	...
	*/
	...
	public static com.ihg.brandstandards.db.model.StandardsExt fetchStandardsExt(
		com.ihg.brandstandards.db.service.persistence.StandardsExtPK standardsExtPK)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchStandardsExt(standardsExtPK);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.StandardsExt getStandardsExt(
		com.ihg.brandstandards.db.service.persistence.StandardsExtPK standardsExtPK)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getStandardsExt(standardsExtPK);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.ihg.brandstandards.db.model.StandardsExt> getStandardsExts(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getStandardsExts(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getStandardsExtsCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getStandardsExtsCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.StandardsExt updateStandardsExt(
		com.ihg.brandstandards.db.model.StandardsExt standardsExt)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateStandardsExt(standardsExt);
	}
	...
	*/
	...
	public static com.ihg.brandstandards.db.model.StandardsExt getStandardsExtObject() {
		return getService().getStandardsExtObject();
	}
	...
	public static StandardsExtLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					StandardsExtLocalService.class.getName());

			if (invokableLocalService instanceof StandardsExtLocalService) {
				_service = (StandardsExtLocalService)invokableLocalService;
			}
			else {
				_service = new StandardsExtLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(StandardsExtLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(StandardsExtLocalService service) {
	}

	private static StandardsExtLocalService _service;
}