...
/**
 * The persistence utility for the g e m measurement formula service. This utility wraps {@link GEMMeasurementFormulaPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class GEMMeasurementFormulaUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(GEMMeasurementFormula gemMeasurementFormula) {
		getPersistence().clearCache(gemMeasurementFormula);
	}
	 ...
	 */
	public static List<GEMMeasurementFormula> findWithDynamicQuery(
	 ...
	 */
	public static GEMMeasurementFormula update(
		GEMMeasurementFormula gemMeasurementFormula) throws SystemException {
		return getPersistence().update(gemMeasurementFormula);
	}
	...
	public static GEMMeasurementFormula update(
		...
		return getPersistence().update(gemMeasurementFormula, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(gemMeasurementFormula);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(gemMeasurementFormulas);
	}
	...
	*/
	public static com.ihg.brandstandards.db.model.GEMMeasurementFormula create(
		long formulaId) {
		return getPersistence().create(formulaId);
	}
	...
	*/
	public static com.ihg.brandstandards.db.model.GEMMeasurementFormula remove(
		long formulaId)
		throws com.ihg.brandstandards.db.NoSuchGEMMeasurementFormulaException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(formulaId);
	}

	public static com.ihg.brandstandards.db.model.GEMMeasurementFormula updateImpl(
		com.ihg.brandstandards.db.model.GEMMeasurementFormula gemMeasurementFormula)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(gemMeasurementFormula);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.GEMMeasurementFormula findByPrimaryKey(
		long formulaId)
		throws com.ihg.brandstandards.db.NoSuchGEMMeasurementFormulaException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().findByPrimaryKey(formulaId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.GEMMeasurementFormula fetchByPrimaryKey(
		long formulaId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(formulaId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.ihg.brandstandards.db.model.GEMMeasurementFormula> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static GEMMeasurementFormulaPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (GEMMeasurementFormulaPersistence)PortletBeanLocatorUtil.locate(com.ihg.brandstandards.db.service.ClpSerializer.getServletContextName(),
					GEMMeasurementFormulaPersistence.class.getName());

			ReferenceRegistry.registerReference(GEMMeasurementFormulaUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(GEMMeasurementFormulaPersistence persistence) {
	}

	private static GEMMeasurementFormulaPersistence _persistence;
}