...
public class StandardsListUtil extends BrandStandardsUtil
{
    ...
    */
     ...
     * @return 
     * /
    public static StringBuilder getWhereClauseForTagAnyWords(final List<String> values, String stdIdColumnName, 
            final String expressionStart, final String expressionEnd, final boolean upperCase)
    {
        final StringBuilder clause = new StringBuilder(" ").append(stdIdColumnName).append(" IN ( ");
        clause.append("SELECT DISTINCT std_id FROM std_tag st where ");
        for (int i = 0; i < values.size(); i++)
        {
            if (i != 0)
            {
            ...
            clause.append(getWhereExactClause(values.get(i), "upper(st.tag_txt)", expressionStart, expressionEnd, upperCase));
        }
        clause.append(") ");
        return clause;
    }*/
     ...
     * @return 
     */
    public static StringBuilder getWhereClauseForTagExactWords(final List<String> values, String stdIdColumnName, 
            final String expressionStart, final String expressionEnd, final boolean upperCase)
    {
        final StringBuilder clause = new StringBuilder(" ").append(stdIdColumnName).append(" IN ( ");
        clause.append("SELECT DISTINCT std_id FROM std_tag st where ");
     ...
     * @return 
     */
    public static StringBuilder getWhereClauseForTagAllWords(final List<String> values, String stdIdColumnName, 
            final String expressionStart, final String expressionEnd, final boolean upperCase)
    {
        final StringBuilder clause = new StringBuilder(" ").append(stdIdColumnName).append(" IN ( ");
        clause.append("SELECT DISTINCT std_id FROM std_tag st where (( ");
        for (int i = 0; i < values.size(); i++)
        {
            ...
            clause.append(getWhereClause(values.get(i), "upper(st.tag_txt)", expressionStart, expressionEnd, upperCase));
