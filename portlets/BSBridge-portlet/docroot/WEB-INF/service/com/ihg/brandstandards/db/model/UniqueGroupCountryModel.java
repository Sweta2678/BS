...
/**
 * The base model interface for the UniqueGroupCountry service. Represents a row in the &quot;UNIQUE_GRP_CTRY&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link com.ihg.brandstandards.db.model.impl.UniqueGroupCountryModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link com.ihg.brandstandards.db.model.impl.UniqueGroupCountryImpl}.
 * </p>
 *
 * @author Mummanedi
 * @see UniqueGroupCountry
 * @see com.ihg.brandstandards.db.model.impl.UniqueGroupCountryImpl
 * @see com.ihg.brandstandards.db.model.impl.UniqueGroupCountryModelImpl
 * @generated
 */
public interface UniqueGroupCountryModel extends BaseModel<UniqueGroupCountry> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a unique group country model instance should use the {@link UniqueGroupCountry} interface instead.
	 */
	...
	@Override
	public UniqueGroupCountry toUnescapedModel();
