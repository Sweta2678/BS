...
/**
 * Provides the local service interface for GEMMeasurementFormula. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mummanedi
 * @see GEMMeasurementFormulaLocalServiceUtil
...
public interface GEMMeasurementFormulaLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link GEMMeasurementFormulaLocalServiceUtil} to access the g e m measurement formula local service. Add custom service methods to {@link com.ihg.brandstandards.db.service.impl.GEMMeasurementFormulaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
