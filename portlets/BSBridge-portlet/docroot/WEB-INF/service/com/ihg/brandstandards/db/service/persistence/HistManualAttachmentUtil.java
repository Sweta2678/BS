...
/**
 * The persistence utility for the hist manual attachment service. This utility wraps {@link HistManualAttachmentPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see HistManualAttachmentPersistenceImpl
 * @generated
 */
public class HistManualAttachmentUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(HistManualAttachment histManualAttachment) {
		getPersistence().clearCache(histManualAttachment);
	}
	 ...
	 */
	public static List<HistManualAttachment> findWithDynamicQuery(
	 ...
	 */
	public static HistManualAttachment update(
		HistManualAttachment histManualAttachment) throws SystemException {
		return getPersistence().update(histManualAttachment);
	}
	 ...
	 */
	public static HistManualAttachment update(
		HistManualAttachment histManualAttachment, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(histManualAttachment, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(histManualAttachment);
	}
	...
	*/
	public static void cacheResult(
		java.util.List<com.ihg.brandstandards.db.model.HistManualAttachment> histManualAttachments) {
		getPersistence().cacheResult(histManualAttachments);
	}
	...
	*/
	public static com.ihg.brandstandards.db.model.HistManualAttachment create(
		long histManualId) {
		return getPersistence().create(histManualId);
	}
	...
	*/
	public static com.ihg.brandstandards.db.model.HistManualAttachment remove(
		long histManualId)
		throws com.ihg.brandstandards.db.NoSuchHistManualAttachmentException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(histManualId);
	}

	public static com.ihg.brandstandards.db.model.HistManualAttachment updateImpl(
		com.ihg.brandstandards.db.model.HistManualAttachment histManualAttachment)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(histManualAttachment);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.HistManualAttachment findByPrimaryKey(
		long histManualId)
		throws com.ihg.brandstandards.db.NoSuchHistManualAttachmentException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().findByPrimaryKey(histManualId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.HistManualAttachment fetchByPrimaryKey(
		long histManualId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(histManualId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.ihg.brandstandards.db.model.HistManualAttachment> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static HistManualAttachmentPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (HistManualAttachmentPersistence)PortletBeanLocatorUtil.locate(com.ihg.brandstandards.db.service.ClpSerializer.getServletContextName(),
					HistManualAttachmentPersistence.class.getName());

			ReferenceRegistry.registerReference(HistManualAttachmentUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(HistManualAttachmentPersistence persistence) {
	}

	private static HistManualAttachmentPersistence _persistence;
}