...
/**
 * The persistence utility for the bridge publish preview service. This utility wraps {@link BridgePublishPreviewPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class BridgePublishPreviewUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(BridgePublishPreview bridgePublishPreview) {
		getPersistence().clearCache(bridgePublishPreview);
	}
	 ...
	 */
	public static List<BridgePublishPreview> findWithDynamicQuery(
	 ...
	 */
	public static BridgePublishPreview update(
		BridgePublishPreview bridgePublishPreview) throws SystemException {
		return getPersistence().update(bridgePublishPreview);
	}
	 ...
	 */
	public static BridgePublishPreview update(
		BridgePublishPreview bridgePublishPreview, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(bridgePublishPreview, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(bridgePublishPreview);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(bridgePublishPreviews);
	}
	...
	*/
	public static com.ihg.brandstandards.db.model.BridgePublishPreview create(
		long stdId) {
	...
	*/
	public static com.ihg.brandstandards.db.model.BridgePublishPreview remove(
		long stdId)
	...
	public static com.ihg.brandstandards.db.model.BridgePublishPreview updateImpl(
		com.ihg.brandstandards.db.model.BridgePublishPreview bridgePublishPreview)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(bridgePublishPreview);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.BridgePublishPreview findByPrimaryKey(
		long stdId)
		throws com.ihg.brandstandards.db.NoSuchBridgePublishPreviewException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.BridgePublishPreview fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.ihg.brandstandards.db.model.BridgePublishPreview> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static BridgePublishPreviewPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (BridgePublishPreviewPersistence)PortletBeanLocatorUtil.locate(com.ihg.brandstandards.db.service.ClpSerializer.getServletContextName(),
					BridgePublishPreviewPersistence.class.getName());

			ReferenceRegistry.registerReference(BridgePublishPreviewUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(BridgePublishPreviewPersistence persistence) {
	}

	private static BridgePublishPreviewPersistence _persistence;
}