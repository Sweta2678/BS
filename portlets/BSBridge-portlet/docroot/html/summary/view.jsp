...
<script type="text/javascript">
	...
	function loadProgressBar () {
		...
		$('#summary').block({ message: '<h3><img src="/BSBridge-theme/images/busy.gif" /> Please wait...</h3>' });
	}
	...
	function loadTabData(tabIndex,isHardRefreh){
		loadProgressBar();		
		var regionRefreshURL = '${regionRefreshURL}';		
		if(isHardRefreh == true){
			regionRefreshURL = regionRefreshURL+"&isHardRefresh="+true;
		}
