...
<c:forEach items="${subRegionCountryMap}" var="subRegion" varStatus="rgnIndex">
	<c:if test="${subRegion.key ne 'GC' }">
		<tr>
			<td  colspan="2" style="padding-left:80px; text-align:left;" class="ri sub-rgn-title"><h4>Sub Region: <c:out value="${subRegion.key}"/></h4></td>
...
var publishId = '${bridgePubId}';
var regionCode = '${regionCode}';
$('#bridgePublishId').val(publishId); //will put value in popup hidden field
