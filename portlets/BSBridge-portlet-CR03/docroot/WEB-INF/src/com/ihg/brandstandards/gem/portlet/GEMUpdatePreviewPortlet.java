...
public class GEMUpdatePreviewPortlet extends AbstractPreviewPortlet {
	...
	public void doView(RenderRequest renderRequest,
		...
		Publication publication = getActiveGEMPublication(preferences.getDepartmentId(), preferences.getBrand());//getActiveBridgePublication(preferences.getBrand(), httpServletRequest);
		//Get List of groups
