...
/**
 * Provides the local service interface for StandardsRegionLocale. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mummanedi
 * @see StandardsRegionLocaleLocalServiceUtil
...
public interface StandardsRegionLocaleLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link StandardsRegionLocaleLocalServiceUtil} to access the standards region locale local service. Add custom service methods to {@link com.ihg.brandstandards.db.service.impl.StandardsRegionLocaleLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public com.ihg.brandstandards.db.model.StandardsRegionLocale addStandardsRegionLocale(
	...
	*/
	public com.ihg.brandstandards.db.model.StandardsRegionLocale createStandardsRegionLocale(
	...
	* @throws SystemException if a system exception occurred
	*/
	public com.ihg.brandstandards.db.model.StandardsRegionLocale deleteStandardsRegionLocale(
		com.ihg.brandstandards.db.service.persistence.StandardsRegionLocalePK standardsRegionLocalePK)
	...
	*/
	...
	public com.ihg.brandstandards.db.model.StandardsRegionLocale fetchStandardsRegionLocale(
		com.ihg.brandstandards.db.service.persistence.StandardsRegionLocalePK standardsRegionLocalePK)
		throws com.liferay.portal.kernel.exception.SystemException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public com.ihg.brandstandards.db.model.StandardsRegionLocale getStandardsRegionLocale(
		com.ihg.brandstandards.db.service.persistence.StandardsRegionLocalePK standardsRegionLocalePK)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public java.util.List<com.ihg.brandstandards.db.model.StandardsRegionLocale> getStandardsRegionLocales(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public int getStandardsRegionLocalesCount()
		throws com.liferay.portal.kernel.exception.SystemException;
	...
	* @throws SystemException if a system exception occurred
	*/
	public com.ihg.brandstandards.db.model.StandardsRegionLocale updateStandardsRegionLocale(
		com.ihg.brandstandards.db.model.StandardsRegionLocale standardsRegionLocale)
		throws com.liferay.portal.kernel.exception.SystemException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public com.ihg.brandstandards.db.model.StandardsRegionLocale getStandardsRegionLocaleObject();

	public void clearCache();

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public java.util.List<com.ihg.brandstandards.db.model.StandardsRegionLocale> getStandardsRegionLocaleByRegionId(
		long regionId)
		throws com.liferay.portal.kernel.exception.SystemException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public com.ihg.brandstandards.db.model.StandardsRegionLocale getDefaultRegionLocale(
		long regionId, java.lang.String isDefault)
		throws com.ihg.brandstandards.db.NoSuchStandardsRegionLocaleException,
			com.liferay.portal.kernel.exception.SystemException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public com.ihg.brandstandards.db.model.StandardsRegionLocale getLocaleByRegId(
		java.lang.String localeId, long rgnId)
		throws com.ihg.brandstandards.db.NoSuchStandardsRegionLocaleException,
			com.liferay.portal.kernel.exception.SystemException;

	public void delAllRegionLocale()
		throws com.liferay.portal.kernel.exception.SystemException;
}