...
/**
 * Provides the local service interface for TreeXML. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mummanedi
 * @see TreeXMLLocalServiceUtil
...
public interface TreeXMLLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TreeXMLLocalServiceUtil} to access the tree x m l local service. Add custom service methods to {@link com.ihg.brandstandards.db.service.impl.TreeXMLLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
