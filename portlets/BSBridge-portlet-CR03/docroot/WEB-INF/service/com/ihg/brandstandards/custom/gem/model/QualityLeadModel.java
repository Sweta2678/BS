...
public class QualityLeadModel extends BaseGemModel
{
    ...
    private String copyToBrand;
    
    private long prntQltyLeadRrptId;
    private String duplicateInd = "N";
    ...
    public JSONObject toJSON()
    {
    	...
    	jsonObject.put("prntQltyLeadRrptId", prntQltyLeadRrptId);
	    jsonObject.put("duplicateInd", duplicateInd);
	    jsonObject.put("copyToBrand", copyToBrand);
    ...
    public JSONObject copyToBrandJSON(){
    	...
    	jsonObject.put("id", id+"-"+chainCode);
    ...
    public void fromJSON(JSONObject jsonObject)
    {
        ...
        prntQltyLeadRrptId = jsonObject.getLong("prntQltyLeadRrptId",0L);
        duplicateInd = jsonObject.getString("duplicateInd");
    }
	...
	public long getPrntQltyLeadRrptId() {
		return prntQltyLeadRrptId;
	}

	public void setPrntQltyLeadRrptId(long prntQltyLeadRrptId) {
		this.prntQltyLeadRrptId = prntQltyLeadRrptId;
	}
	...
	public String getCopyToBrand() {
		return copyToBrand;
	}

	public void setCopyToBrand(String copyToBrand) {
		this.copyToBrand = copyToBrand;
	}
}
