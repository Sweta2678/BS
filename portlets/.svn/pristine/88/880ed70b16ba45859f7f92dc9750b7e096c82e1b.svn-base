...
$(document).ready(function(){
	...
	/*function updateDeclaimer(element){
		$('#diclarenote').html("");
		if(element.val()=='exact'){
			$('#diclarenote').html("<p class='pull-left'><em style='font-size:13px;'>The search default option, Match Exact Phrase, only returns content with the key words searched. If you would like to search for ID numbers, please switch search option to <strong>Search All Words</strong>.</em></p>");
		}
	}
	updateDeclaimer($("input:radio[name='searchOptions']:checked"));
	
	 $("input:radio[name='searchOptions']").change(function(){
		 updateDeclaimer($(this));
	 });*/
...
<div class="modal-body ">
	<div id="diclarenote"><p class="pull-left"><em style="font-size:13px;">The search default option, <strong>Match Exact Phrase</strong>, only returns content with the key words searched and does not recognize ID numbers. To search for ID numbers, please switch search option to <strong>Search All Words</strong>.</em></p></div>
	...
	<div class="form-inline" style="font-size: 0.8em; margin: 5px 0 10px 50px;clear:both;">
		<label class="radio">
		<input type="radio" name="searchOptions" id="searchOptions" value="exact" class="standard_radio" <%=strSearchOptions.equals("exact")? "checked='checked'":"" %> > ${matchExactPhrase} 
		<span><a class="help_icon tooltip" href="javascript:return false;"><img src="/BSTheme-theme/images/help.png" alt="Match Exact Phrase help icon"/>
		<span class="classic">${matchExactPhraseHelp}</span></a></span>
		</label>
		<label class="radio">
		<input type="radio" name="searchOptions" id="searchOptions" value="all" class="standard_radio" <%=strSearchOptions.equals("all")? "checked='checked'":"" %> > ${searchAllWords} 
		<span><a class="help_icon tooltip" href="javascript:return false;"><img src="/BSTheme-theme/images/help.png" alt="Search All Words help icon"/>
		<span class="classic">${searchAllWordsHelp}</span></a></span>
		</label>
		<label class="radio">
		<input type="radio" name="searchOptions" id="searchOptions" value="any" class="standard_radio" <%=strSearchOptions.equals("any")? "checked='checked'":"" %>> ${matchAnyWords}
		<span><a class="help_icon tooltip" href="javascript:return false;"><img src="/BSTheme-theme/images/help.png" alt="Match Any of the Words help icon"/>
		<span class="classic">${matchAnyWordsHelp}</span></a></span>
		</label>
