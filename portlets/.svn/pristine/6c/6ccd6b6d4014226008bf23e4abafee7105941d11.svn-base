...
public class StandardsCountryExtLocalServiceClpInvoker {
	public StandardsCountryExtLocalServiceClpInvoker() {
		...
		_methodName587 = "getCountryListByStdIdAndRegionId";

		_methodParameterTypes587 = new String[] { "long", "long", "long" };

		_methodName588 = "getCountryListByStdIdAndRegionIdForMyPublication";

		_methodParameterTypes588 = new String[] { "long", "long", "long" };

		_methodName589 = "getRegionBasedCountryStatus";
