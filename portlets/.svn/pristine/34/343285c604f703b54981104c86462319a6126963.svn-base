...
import com.ihg.brandstandards.db.service.GEMManagementIdLocalService;
...
/**
 * Provides the base implementation for the g e m management ID local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.GEMManagementIdLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class GEMManagementIdLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements GEMManagementIdLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.GEMManagementIdLocalServiceUtil} to access the g e m management ID local service.
	 */
	...
	@Override
	public GEMManagementId addGEMManagementId(GEMManagementId gemManagementId)
		throws SystemException {
		gemManagementId.setNew(true);

		return gemManagementIdPersistence.update(gemManagementId);
	}
	 ...
	 */
	@Override
	public GEMManagementId createGEMManagementId(long managementId) {
		return gemManagementIdPersistence.create(managementId);
	}
	...
	@Override
	public GEMManagementId deleteGEMManagementId(long managementId)
		throws PortalException, SystemException {
		return gemManagementIdPersistence.remove(managementId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public GEMManagementId deleteGEMManagementId(
		GEMManagementId gemManagementId) throws SystemException {
		return gemManagementIdPersistence.remove(gemManagementId);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(GEMManagementId.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return gemManagementIdPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return gemManagementIdPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public GEMManagementId fetchGEMManagementId(long managementId)
		throws SystemException {
		return gemManagementIdPersistence.fetchByPrimaryKey(managementId);
	}
	 ...
	 */
	@Override
	public GEMManagementId getGEMManagementId(long managementId)
		throws PortalException, SystemException {
		return gemManagementIdPersistence.findByPrimaryKey(managementId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return gemManagementIdPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<GEMManagementId> getGEMManagementIds(int start, int end)
		throws SystemException {
		return gemManagementIdPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getGEMManagementIdsCount() throws SystemException {
		return gemManagementIdPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public GEMManagementId updateGEMManagementId(
		GEMManagementId gemManagementId) throws SystemException {
		return gemManagementIdPersistence.update(gemManagementId);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.GEMManagementId",
			gemManagementIdLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.GEMManagementId");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = gemManagementIdPersistence.getDataSource();
	...
	private GEMManagementIdLocalServiceClpInvoker _clpInvoker = new GEMManagementIdLocalServiceClpInvoker();
}