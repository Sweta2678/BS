...
/**
 * Provides the local service utility for GEMManagementId. This utility wraps
 * {@link com.ihg.brandstandards.db.service.impl.GEMManagementIdLocalServiceImpl} and is the
 ...
 * @generated
 */
public class GEMManagementIdLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.ihg.brandstandards.db.service.impl.GEMManagementIdLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.ihg.brandstandards.db.model.GEMManagementId addGEMManagementId(
		com.ihg.brandstandards.db.model.GEMManagementId gemManagementId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addGEMManagementId(gemManagementId);
	}
	...
	*/
	public static com.ihg.brandstandards.db.model.GEMManagementId createGEMManagementId(
		long managementId) {
		return getService().createGEMManagementId(managementId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.GEMManagementId deleteGEMManagementId(
		long managementId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteGEMManagementId(managementId);
	}
	...
	*/
	public static com.ihg.brandstandards.db.model.GEMManagementId deleteGEMManagementId(
		com.ihg.brandstandards.db.model.GEMManagementId gemManagementId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteGEMManagementId(gemManagementId);
	}
	...
	*/
	...
	public static com.ihg.brandstandards.db.model.GEMManagementId fetchGEMManagementId(
		long managementId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchGEMManagementId(managementId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.GEMManagementId getGEMManagementId(
		long managementId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getGEMManagementId(managementId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.ihg.brandstandards.db.model.GEMManagementId> getGEMManagementIds(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getGEMManagementIds(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getGEMManagementIdsCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getGEMManagementIdsCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.GEMManagementId updateGEMManagementId(
		com.ihg.brandstandards.db.model.GEMManagementId gemManagementId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateGEMManagementId(gemManagementId);
	}
	...
	*/
	public static com.ihg.brandstandards.db.model.GEMManagementId getManagementIdsByCountryAndBrand(
		java.lang.String countryCode, java.lang.String chainCode)
		throws com.ihg.brandstandards.db.NoSuchGEMManagementIdException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .getManagementIdsByCountryAndBrand(countryCode, chainCode);
	}
	...
	public static GEMManagementIdLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					GEMManagementIdLocalService.class.getName());

			if (invokableLocalService instanceof GEMManagementIdLocalService) {
				_service = (GEMManagementIdLocalService)invokableLocalService;
			}
			else {
				_service = new GEMManagementIdLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(GEMManagementIdLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(GEMManagementIdLocalService service) {
	}

	private static GEMManagementIdLocalService _service;
}