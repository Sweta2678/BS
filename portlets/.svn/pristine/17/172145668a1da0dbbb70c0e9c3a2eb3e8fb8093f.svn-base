...
import com.ihg.brandstandards.db.service.GEMQlReportLocalService;
...
/**
 * Provides the base implementation for the g e m ql report local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.GEMQlReportLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class GEMQlReportLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements GEMQlReportLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.GEMQlReportLocalServiceUtil} to access the g e m ql report local service.
	 */
	...
	@Override
	public GEMQlReport addGEMQlReport(GEMQlReport gemQlReport)
		throws SystemException {
		gemQlReport.setNew(true);

		return gemQlReportPersistence.update(gemQlReport);
	}
	 ...
	 */
	@Override
	public GEMQlReport createGEMQlReport(long qlReportId) {
		return gemQlReportPersistence.create(qlReportId);
	}
	...
	@Override
	public GEMQlReport deleteGEMQlReport(long qlReportId)
		throws PortalException, SystemException {
		return gemQlReportPersistence.remove(qlReportId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public GEMQlReport deleteGEMQlReport(GEMQlReport gemQlReport)
		throws SystemException {
		return gemQlReportPersistence.remove(gemQlReport);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(GEMQlReport.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return gemQlReportPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return gemQlReportPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return gemQlReportPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public GEMQlReport fetchGEMQlReport(long qlReportId)
		throws SystemException {
		return gemQlReportPersistence.fetchByPrimaryKey(qlReportId);
	}
	 ...
	 */
	@Override
	public GEMQlReport getGEMQlReport(long qlReportId)
		throws PortalException, SystemException {
		return gemQlReportPersistence.findByPrimaryKey(qlReportId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return gemQlReportPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<GEMQlReport> getGEMQlReports(int start, int end)
		throws SystemException {
		return gemQlReportPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getGEMQlReportsCount() throws SystemException {
		return gemQlReportPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public GEMQlReport updateGEMQlReport(GEMQlReport gemQlReport)
		throws SystemException {
		return gemQlReportPersistence.update(gemQlReport);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.GEMQlReport",
			gemQlReportLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = gemQlReportPersistence.getDataSource();
	...
	private GEMQlReportLocalServiceClpInvoker _clpInvoker = new GEMQlReportLocalServiceClpInvoker();
}