...
import com.ihg.brandstandards.db.service.GEMChainMeasurementLocalService;
...
/**
 * Provides the base implementation for the g e m chain measurement local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.GEMChainMeasurementLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 * @see com.ihg.brandstandards.db.service.impl.GEMChainMeasurementLocalServiceImpl
 * @see com.ihg.brandstandards.db.service.GEMChainMeasurementLocalServiceUtil
 * @generated
 */
public abstract class GEMChainMeasurementLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements GEMChainMeasurementLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.GEMChainMeasurementLocalServiceUtil} to access the g e m chain measurement local service.
	 */
	...
	@Override
	public GEMChainMeasurement addGEMChainMeasurement(
		GEMChainMeasurement gemChainMeasurement) throws SystemException {
		gemChainMeasurement.setNew(true);

		return gemChainMeasurementPersistence.update(gemChainMeasurement);
	}
	 ...
	 */
	@Override
	public GEMChainMeasurement createGEMChainMeasurement(
		long chainMeasurementId) {
		return gemChainMeasurementPersistence.create(chainMeasurementId);
	}
	...
	@Override
	public GEMChainMeasurement deleteGEMChainMeasurement(
		long chainMeasurementId) throws PortalException, SystemException {
		return gemChainMeasurementPersistence.remove(chainMeasurementId);
	}
	...
	public GEMChainMeasurement deleteGEMChainMeasurement(
		GEMChainMeasurement gemChainMeasurement) throws SystemException {
		return gemChainMeasurementPersistence.remove(gemChainMeasurement);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(GEMChainMeasurement.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return gemChainMeasurementPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return gemChainMeasurementPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public GEMChainMeasurement fetchGEMChainMeasurement(long chainMeasurementId)
		throws SystemException {
		return gemChainMeasurementPersistence.fetchByPrimaryKey(chainMeasurementId);
	}
	 ...
	 */
	@Override
	public GEMChainMeasurement getGEMChainMeasurement(long chainMeasurementId)
		throws PortalException, SystemException {
		return gemChainMeasurementPersistence.findByPrimaryKey(chainMeasurementId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return gemChainMeasurementPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<GEMChainMeasurement> getGEMChainMeasurements(int start, int end)
		throws SystemException {
		return gemChainMeasurementPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getGEMChainMeasurementsCount() throws SystemException {
		return gemChainMeasurementPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public GEMChainMeasurement updateGEMChainMeasurement(
		GEMChainMeasurement gemChainMeasurement) throws SystemException {
		return gemChainMeasurementPersistence.update(gemChainMeasurement);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.GEMChainMeasurement",
			gemChainMeasurementLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.GEMChainMeasurement");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = gemChainMeasurementPersistence.getDataSource();
	...
	private GEMChainMeasurementLocalServiceClpInvoker _clpInvoker = new GEMChainMeasurementLocalServiceClpInvoker();
}