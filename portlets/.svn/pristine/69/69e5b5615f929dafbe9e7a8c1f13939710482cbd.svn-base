...
import com.ihg.brandstandards.db.service.StandardsCrossReferenceLocalService;
...
/**
 * Provides the base implementation for the standards cross reference local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.StandardsCrossReferenceLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 * @see com.ihg.brandstandards.db.service.impl.StandardsCrossReferenceLocalServiceImpl
 * @see com.ihg.brandstandards.db.service.StandardsCrossReferenceLocalServiceUtil
 * @generated
 */
public abstract class StandardsCrossReferenceLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements StandardsCrossReferenceLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.StandardsCrossReferenceLocalServiceUtil} to access the standards cross reference local service.
	 */
	...
	@Override
	public StandardsCrossReference addStandardsCrossReference(
		StandardsCrossReference standardsCrossReference)
		throws SystemException {
		standardsCrossReference.setNew(true);

		return standardsCrossReferencePersistence.update(standardsCrossReference);
	}
	 ...
	 */
	@Override
	public StandardsCrossReference createStandardsCrossReference(
		StandardsCrossReferencePK standardsCrossReferencePK) {
		return standardsCrossReferencePersistence.create(standardsCrossReferencePK);
	}
	...
	@Override
	public StandardsCrossReference deleteStandardsCrossReference(
		StandardsCrossReferencePK standardsCrossReferencePK)
		throws PortalException, SystemException {
		return standardsCrossReferencePersistence.remove(standardsCrossReferencePK);
	}
	...
	public StandardsCrossReference deleteStandardsCrossReference(
		StandardsCrossReference standardsCrossReference)
		throws SystemException {
		return standardsCrossReferencePersistence.remove(standardsCrossReference);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(StandardsCrossReference.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return standardsCrossReferencePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return standardsCrossReferencePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public StandardsCrossReference fetchStandardsCrossReference(
		StandardsCrossReferencePK standardsCrossReferencePK)
		throws SystemException {
		return standardsCrossReferencePersistence.fetchByPrimaryKey(standardsCrossReferencePK);
	}
	 ...
	 */
	@Override
	public StandardsCrossReference getStandardsCrossReference(
		StandardsCrossReferencePK standardsCrossReferencePK)
		throws PortalException, SystemException {
		return standardsCrossReferencePersistence.findByPrimaryKey(standardsCrossReferencePK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return standardsCrossReferencePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<StandardsCrossReference> getStandardsCrossReferences(
		int start, int end) throws SystemException {
		return standardsCrossReferencePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getStandardsCrossReferencesCount() throws SystemException {
		return standardsCrossReferencePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public StandardsCrossReference updateStandardsCrossReference(
		StandardsCrossReference standardsCrossReference)
		throws SystemException {
		return standardsCrossReferencePersistence.update(standardsCrossReference);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.StandardsCrossReference",
			standardsCrossReferenceLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = standardsCrossReferencePersistence.getDataSource();
	...
	private StandardsCrossReferenceLocalServiceClpInvoker _clpInvoker = new StandardsCrossReferenceLocalServiceClpInvoker();
}