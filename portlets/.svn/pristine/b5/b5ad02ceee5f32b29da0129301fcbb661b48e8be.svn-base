...
public class PublicationLocalServiceImpl extends PublicationLocalServiceBaseImpl {
        ...
        try
        {
            ...
            whatChangedOnNav = ListUtil.sort(whatChangedOnNav, new Comparator<Publication>()
            {
                public int compare(Publication u1, Publication u2)
                {
                    ...
                    return -((u1.getPublishDate()).compareTo(u2.getPublishDate()));
                }
            });
        }
        catch (SystemException e)
    ...
    public List<Publication> getWhatChangedOnCustom(String chainCode, String publishEnv){
    	return publicationFinder.getWhatChangedOnCustom(chainCode, publishEnv);
    }
    /*
    public void clearStagingData(String chainCode)
    {
    	publicationFinder.clearStagingData(chainCode);
