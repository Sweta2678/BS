...
public class BridgePublishImportLocalServiceClpInvoker {
	public BridgePublishImportLocalServiceClpInvoker() {
		...
		_methodName586 = "createOraSequence";

		_methodParameterTypes586 = new String[] {  };

		_methodName587 = "addBridgePublishImport";
		...
		_methodName588 = "findByPublishIdAndStdId";

		_methodParameterTypes588 = new String[] { "long", "long" };

		_methodName589 = "getBridgeImportedRecordsCount";

		_methodParameterTypes589 = new String[] { "long", "long" };

		_methodName590 = "findByPublishIdAndRegionId";

		_methodParameterTypes590 = new String[] { "long", "long" };

		_methodName591 = "findByPublishIdRegionIdandSelectionInd";

		_methodParameterTypes591 = new String[] { "long", "long" };

		_methodName592 = "deleteBridgeImportByPublishIdAndRegionId";

		_methodParameterTypes592 = new String[] { "long", "long" };

		_methodName593 = "updateBridgePublishImport";
		...
		_methodName594 = "getStandardsByRegion";

		_methodParameterTypes594 = new String[] { "long", "long" };

		_methodName595 = "getDiscountinuedStandards";

		_methodParameterTypes595 = new String[] {
				"java.util.List", "java.lang.String"
			};

		_methodName596 = "getMyPublicationIssuesCount";
		...
		_methodName598 = "updateGlobalRegionalStdCountries";

		_methodParameterTypes598 = new String[] {
				"long", "long", "long", "java.lang.String"
			};

		_methodName599 = "updateStdCountriesState";

		_methodParameterTypes599 = new String[] {
				"long", "long", "long", "java.lang.String"
			};

		_methodName600 = "setBridgePublishForImport";

		_methodParameterTypes600 = new String[] { "long", "long", "java.util.Map" };

		_methodName601 = "getSTDToBeAddedCount";
