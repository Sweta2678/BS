...
/**
 * Provides the local service interface for GEMStdCategory. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mummanedi
 * @see GEMStdCategoryLocalServiceUtil
...
public interface GEMStdCategoryLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link GEMStdCategoryLocalServiceUtil} to access the g e m std category local service. Add custom service methods to {@link com.ihg.brandstandards.db.service.impl.GEMStdCategoryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
