...
public class BrandStandardsUtil
{
    ...
    private static final Map<String, String> amerOptions = new LinkedHashMap<String, String>();
    private static final Map<String, String> euOptions = new LinkedHashMap<String, String>();
    private static final Map<String, String> ameaOptions = new LinkedHashMap<String, String>();
    private static final Map<String, String> gcOptions = new LinkedHashMap<String, String>();
