...
public class ChainStandardsLocalServiceClpInvoker {
	public ChainStandardsLocalServiceClpInvoker() {
		...
		_methodName586 = "getChainStandardsObject";
		...
		_methodName588 = "getChainStandardsByStdId";

		_methodParameterTypes588 = new String[] { "long" };

		_methodName589 = "getChainStandardsByChainCode";

		_methodParameterTypes589 = new String[] { "long", "java.lang.String" };

		_methodName590 = "getChainStandardsByChainCodeAll";

		_methodParameterTypes590 = new String[] { "long", "java.lang.String" };

		_methodName591 = "getChainStandardsByStdIdAll";

		_methodParameterTypes591 = new String[] { "long" };

		_methodName592 = "deleteChainStandards";

		_methodParameterTypes592 = new String[] {
				"com.ihg.brandstandards.db.model.ChainStandards"
			};

		_methodName593 = "getStandardsByChain";
