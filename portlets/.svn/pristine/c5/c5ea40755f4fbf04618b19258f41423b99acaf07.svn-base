 ...
 * @generated
 */
public class StandardsCrossReferenceLocalServiceClp
	implements StandardsCrossReferenceLocalService {
	public StandardsCrossReferenceLocalServiceClp(
		...
		_methodName20 = "getXStandardsOthers";

		_methodParameterTypes20 = new String[] { "long" };

		_methodName21 = "addCrossReferences";

		_methodParameterTypes21 = new String[] {
				"long", "java.util.Date", "long", "java.lang.String"
			};

		_methodName22 = "deleteCrossReferences";

		_methodParameterTypes22 = new String[] { "long", "java.lang.String" };

		_methodName23 = "updateStdOrder";
	...
	public com.ihg.brandstandards.db.model.StandardsCrossReference addStandardsCrossReference(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(standardsCrossReference)
					});
		}
		catch (Throwable t) {
		...
		return (com.ihg.brandstandards.db.model.StandardsCrossReference)ClpSerializer.translateOutput(returnObj);
	}
	...
	public com.ihg.brandstandards.db.model.StandardsCrossReference createStandardsCrossReference(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					...
					new Object[] {
						ClpSerializer.translateInput(standardsCrossReferencePK)
					});
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<com.ihg.brandstandards.db.model.StandardsCrossReference> getStandardsCrossReferences(
		...
		return (java.util.List<com.ihg.brandstandards.db.model.StandardsCrossReference>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public void addCrossReferences(long userId, java.util.Date currDate,
		...
		try {
			_invokableLocalService.invokeMethod(_methodName21,
				...
				ClpSerializer.translateInput(currDate),
					
				stdId,
					
				ClpSerializer.translateInput(crossRefIds)
				});
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public void deleteCrossReferences(long stdId, java.lang.String crossRefIds) {
		try {
			_invokableLocalService.invokeMethod(_methodName22,
				...
				new Object[] { stdId, ClpSerializer.translateInput(crossRefIds) });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public void updateStdOrder(long stdId, java.lang.String stdIds) {
		try {
			_invokableLocalService.invokeMethod(_methodName23,
				...
				new Object[] { stdId, ClpSerializer.translateInput(stdIds) });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
