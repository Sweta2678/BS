...
public class BridgeGlobalPublishLocalServiceImpl extends BridgeGlobalPublishLocalServiceBaseImpl 
{
    ...
    public Map<String,String> importGlobalMustPublishStandards(long publishId, String chainCode, String screenName, String stdIds) throws SystemException {
    	return bridgeGlobalPublishFinder.importGlobalMustPublishStandards(publishId, chainCode, screenName, stdIds);
    }
}