...
import com.ihg.brandstandards.db.service.TaxonomyExtLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.TaxonomyExtLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 * @see com.ihg.brandstandards.db.service.impl.TaxonomyExtLocalServiceImpl
 * @see com.ihg.brandstandards.db.service.TaxonomyExtLocalServiceUtil
 * @generated
 */
public abstract class TaxonomyExtLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TaxonomyExtLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.TaxonomyExtLocalServiceUtil} to access the Custom Query mapping to create index path. local service.
	 */
	...
	@Override
	public TaxonomyExt addTaxonomyExt(TaxonomyExt taxonomyExt)
		throws SystemException {
		taxonomyExt.setNew(true);

		return taxonomyExtPersistence.update(taxonomyExt);
	}
	 ...
	 */
	@Override
	public TaxonomyExt createTaxonomyExt(long taxId) {
		return taxonomyExtPersistence.create(taxId);
	}
	...
	@Override
	public TaxonomyExt deleteTaxonomyExt(long taxId)
		throws PortalException, SystemException {
		return taxonomyExtPersistence.remove(taxId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TaxonomyExt deleteTaxonomyExt(TaxonomyExt taxonomyExt)
		throws SystemException {
		return taxonomyExtPersistence.remove(taxonomyExt);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TaxonomyExt.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return taxonomyExtPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return taxonomyExtPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return taxonomyExtPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TaxonomyExt fetchTaxonomyExt(long taxId) throws SystemException {
		return taxonomyExtPersistence.fetchByPrimaryKey(taxId);
	}
	 ...
	 */
	@Override
	public TaxonomyExt getTaxonomyExt(long taxId)
		throws PortalException, SystemException {
		return taxonomyExtPersistence.findByPrimaryKey(taxId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return taxonomyExtPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TaxonomyExt> getTaxonomyExts(int start, int end)
		throws SystemException {
		return taxonomyExtPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTaxonomyExtsCount() throws SystemException {
		return taxonomyExtPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TaxonomyExt updateTaxonomyExt(TaxonomyExt taxonomyExt)
		throws SystemException {
		return taxonomyExtPersistence.update(taxonomyExt);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.TaxonomyExt",
			taxonomyExtLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.TaxonomyExt");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = taxonomyExtPersistence.getDataSource();
	...
	private TaxonomyExtLocalServiceClpInvoker _clpInvoker = new TaxonomyExtLocalServiceClpInvoker();
}