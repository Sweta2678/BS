...
/**
 * Provides a wrapper for {@link JobQueueLocalService}.
 *
 * @author Mummanedi
...
public class JobQueueLocalServiceWrapper implements JobQueueLocalService,
	...
	*/
	...
	public com.ihg.brandstandards.db.model.JobQueue createJobQueue(long jobId) {
		return _jobQueueLocalService.createJobQueue(jobId);
	}
	...
	*/
	...
	public com.ihg.brandstandards.db.model.JobQueue deleteJobQueue(long jobId)
		...
		return _jobQueueLocalService.deleteJobQueue(jobId);
	}
	...
	*/
	...
	public long dynamicQueryCount(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _jobQueueLocalService.dynamicQueryCount(dynamicQuery, projection);
	}

	@Override
	public com.ihg.brandstandards.db.model.JobQueue fetchJobQueue(long jobId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return _jobQueueLocalService.fetchJobQueue(jobId);
	}
	...
	*/
	...
	public com.ihg.brandstandards.db.model.JobQueue getJobQueue(long jobId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return _jobQueueLocalService.getJobQueue(jobId);
	}
	...
	*/
	...
	public boolean insertJobQueueUsingOraSequence(java.lang.String jobOwner,
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _jobQueueLocalService.insertJobQueueUsingOraSequence(jobOwner,
			jobType, metaData, linkURL, notificationEmail, createUserId);
	}
	...
	*/
	...
	public void addNewJobRequest(java.lang.String jobType,
		...
		_jobQueueLocalService.addNewJobRequest(jobType, metaData, screenName,
			notificationEmail);
	}
	...
	public com.ihg.brandstandards.db.model.JobQueue addJobQueue(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return _jobQueueLocalService.addJobQueue(jobOwner, jobType, metadata,
			link, notificationEmail, startTime, endTime, status, createdBy,
	...
	public com.ihg.brandstandards.db.model.JobQueue updateJobQueue(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return _jobQueueLocalService.updateJobQueue(jobQueueId, jobOwner,
			jobType, metadata, link, notificationEmail, startTime, endTime,
			status, updatedBy);
	}
	...
	public com.ihg.brandstandards.db.model.JobQueue updateJobQueueStatus(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return _jobQueueLocalService.updateJobQueueStatus(jobQueueId, link,
	...
	public java.util.List<com.ihg.brandstandards.db.model.JobQueue> getJobQueuesByOwnerAndType(
		java.lang.String jobOwner, java.lang.String jobType)
		throws com.liferay.portal.kernel.exception.SystemException {
		return _jobQueueLocalService.getJobQueuesByOwnerAndType(jobOwner,
			jobType);
	}
	...
	public java.util.List<com.ihg.brandstandards.db.model.JobQueue> getJobQueuesByOwnerTypeAndStatus(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _jobQueueLocalService.getJobQueuesByOwnerTypeAndStatus(jobOwner,
			jobType, status);
	}
	...
	public java.util.List<com.ihg.brandstandards.db.model.JobQueue> getJobQueuesByType(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _jobQueueLocalService.getJobQueuesByType(jobType);
	}
	...
	public java.util.List<com.ihg.brandstandards.db.model.JobQueue> getJobQueuesByTypeAndStatus(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _jobQueueLocalService.getJobQueuesByTypeAndStatus(jobType, status);
	}
	...
	public java.util.List<com.ihg.brandstandards.db.model.JobQueue> getJobQueuesByOwner(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _jobQueueLocalService.getJobQueuesByOwner(jobOwner);
	}
	...
	public java.util.List<com.ihg.brandstandards.db.model.JobQueue> getJobQueuesByOwnerAndStatus(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _jobQueueLocalService.getJobQueuesByOwnerAndStatus(jobOwner,
			status);
	}
	...
	public java.util.List<java.lang.String> getUniqueJobQueTypes()
		throws com.liferay.portal.kernel.exception.SystemException {
		return _jobQueueLocalService.getUniqueJobQueTypes();
	}
	...
	*/
	...
	public byte[] getFileAsByteStream(long fileEntryId) {
		return _jobQueueLocalService.getFileAsByteStream(fileEntryId);
	}

	@Override
	public byte[] getImageAsByteStream(long igImageId, boolean getLargeImage) {
		return _jobQueueLocalService.getImageAsByteStream(igImageId,
			getLargeImage);
	}
	...
	*/
	...
	public boolean isJobQueueExistWithSameMetadata(
		...
		java.lang.String jobType) {
		return _jobQueueLocalService.isJobQueueExistWithSameMetadata(xmlMetadata,
			jobOwner, jobType);
	}
	...
	*/
	...
	public boolean isJobQueueExistWithSameMetadata(
		...
		return _jobQueueLocalService.isJobQueueExistWithSameMetadata(xmlMetadata,
			jobOwner, jobType, jobStatus);
	}

	@Override
	public java.util.List<com.ihg.brandstandards.db.model.JobQueue> getJobQueuesExceptFullManuals() {
		return _jobQueueLocalService.getJobQueuesExceptFullManuals();
	}

	@Override
	public void clearCache() {
		_jobQueueLocalService.clearCache();
	}
