...
/**
 * The persistence utility for the g e m scoring value service. This utility wraps {@link GEMScoringValuePersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see GEMScoringValuePersistenceImpl
 * @generated
 */
public class GEMScoringValueUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(GEMScoringValue gemScoringValue) {
		getPersistence().clearCache(gemScoringValue);
	}
	 ...
	 */
	public static List<GEMScoringValue> findWithDynamicQuery(
	 ...
	 */
	public static GEMScoringValue update(GEMScoringValue gemScoringValue)
		throws SystemException {
		return getPersistence().update(gemScoringValue);
	}
	...
	public static GEMScoringValue update(GEMScoringValue gemScoringValue,
		...
		return getPersistence().update(gemScoringValue, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(gemScoringValue);
	}
	...
	*/
	public static void cacheResult(
		java.util.List<com.ihg.brandstandards.db.model.GEMScoringValue> gemScoringValues) {
		getPersistence().cacheResult(gemScoringValues);
	}
	...
	*/
	public static com.ihg.brandstandards.db.model.GEMScoringValue create(
		long scoringId) {
		return getPersistence().create(scoringId);
	}
	...
	*/
	public static com.ihg.brandstandards.db.model.GEMScoringValue remove(
		long scoringId)
		throws com.ihg.brandstandards.db.NoSuchGEMScoringValueException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(scoringId);
	}

	public static com.ihg.brandstandards.db.model.GEMScoringValue updateImpl(
		com.ihg.brandstandards.db.model.GEMScoringValue gemScoringValue)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(gemScoringValue);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.GEMScoringValue findByPrimaryKey(
		long scoringId)
		throws com.ihg.brandstandards.db.NoSuchGEMScoringValueException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().findByPrimaryKey(scoringId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.GEMScoringValue fetchByPrimaryKey(
		long scoringId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(scoringId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.ihg.brandstandards.db.model.GEMScoringValue> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static GEMScoringValuePersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (GEMScoringValuePersistence)PortletBeanLocatorUtil.locate(com.ihg.brandstandards.db.service.ClpSerializer.getServletContextName(),
					GEMScoringValuePersistence.class.getName());

			ReferenceRegistry.registerReference(GEMScoringValueUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(GEMScoringValuePersistence persistence) {
	}

	private static GEMScoringValuePersistence _persistence;
}