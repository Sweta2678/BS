...
import com.ihg.brandstandards.db.service.JobQueueLocalService;
...
/**
 * Provides the base implementation for the job queue local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.JobQueueLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
...
public abstract class JobQueueLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.JobQueueLocalServiceUtil} to access the job queue local service.
	 */
	...
	public JobQueue addJobQueue(JobQueue jobQueue) throws SystemException {
		...
		return jobQueuePersistence.update(jobQueue);
	}
	 ...
	 */
	@Override
	public JobQueue createJobQueue(long jobId) {
		return jobQueuePersistence.create(jobId);
	}
	...
	@Override
	public JobQueue deleteJobQueue(long jobId)
		throws PortalException, SystemException {
		return jobQueuePersistence.remove(jobId);
	}
	...
	@Override
	public JobQueue fetchJobQueue(long jobId) throws SystemException {
		return jobQueuePersistence.fetchByPrimaryKey(jobId);
	}
	 ...
	 */
	@Override
	public JobQueue getJobQueue(long jobId)
		throws PortalException, SystemException {
		return jobQueuePersistence.findByPrimaryKey(jobId);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.JobQueue",
