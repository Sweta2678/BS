...
/**
 * Provides the local service interface for FeedbackDetail. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author gulam.vora
 * @see FeedbackDetailLocalServiceUtil
...
public interface FeedbackDetailLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FeedbackDetailLocalServiceUtil} to access the feedback detail local service. Add custom service methods to {@link com.ihg.grs.common.service.impl.FeedbackDetailLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
