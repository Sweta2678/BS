...
public class StandardsCountryModelImpl extends BaseModelImpl<StandardsCountry>
	...
	public static final String TABLE_SQL_CREATE = "create table BRNDSTND_CTRY (CTRY_NM_CD VARCHAR(75) not null primary key,RGN_ID LONG,CREAT_USR_ID VARCHAR(75) null,CREAT_TS DATE null,LST_UPDT_USR_ID VARCHAR(75) null,LST_UPDT_TS DATE null)";
