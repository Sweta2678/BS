...
import com.ihg.brandstandards.db.service.PublishStdLocalService;
...
/**
 * Provides the base implementation for the publish std local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.PublishStdLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class PublishStdLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PublishStdLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.PublishStdLocalServiceUtil} to access the publish std local service.
	 */
	...
	@Override
	public PublishStd addPublishStd(PublishStd publishStd)
		throws SystemException {
		publishStd.setNew(true);

		return publishStdPersistence.update(publishStd);
	}
	 ...
	 */
	@Override
	public PublishStd createPublishStd(long publishStdVerId) {
		return publishStdPersistence.create(publishStdVerId);
	}
	...
	@Override
	public PublishStd deletePublishStd(long publishStdVerId)
		throws PortalException, SystemException {
		return publishStdPersistence.remove(publishStdVerId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PublishStd deletePublishStd(PublishStd publishStd)
		throws SystemException {
		return publishStdPersistence.remove(publishStd);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PublishStd.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return publishStdPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return publishStdPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return publishStdPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public PublishStd fetchPublishStd(long publishStdVerId)
		throws SystemException {
		return publishStdPersistence.fetchByPrimaryKey(publishStdVerId);
	}
	 ...
	 */
	@Override
	public PublishStd getPublishStd(long publishStdVerId)
		throws PortalException, SystemException {
		return publishStdPersistence.findByPrimaryKey(publishStdVerId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return publishStdPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PublishStd> getPublishStds(int start, int end)
		throws SystemException {
		return publishStdPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getPublishStdsCount() throws SystemException {
		return publishStdPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PublishStd updatePublishStd(PublishStd publishStd)
		throws SystemException {
		return publishStdPersistence.update(publishStd);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.PublishStd",
			publishStdLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.PublishStd");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = publishStdPersistence.getDataSource();
	...
	private PublishStdLocalServiceClpInvoker _clpInvoker = new PublishStdLocalServiceClpInvoker();
}