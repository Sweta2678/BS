...
import com.ihg.brandstandards.db.service.HistManualsLocalService;
...
/**
 * Provides the base implementation for the hist manuals local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.HistManualsLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class HistManualsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements HistManualsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.HistManualsLocalServiceUtil} to access the hist manuals local service.
	 */
	...
	@Override
	public HistManuals addHistManuals(HistManuals histManuals)
		throws SystemException {
		histManuals.setNew(true);

		return histManualsPersistence.update(histManuals);
	}
	 ...
	 */
	@Override
	public HistManuals createHistManuals(long histManualId) {
		return histManualsPersistence.create(histManualId);
	}
	...
	@Override
	public HistManuals deleteHistManuals(long histManualId)
		throws PortalException, SystemException {
		return histManualsPersistence.remove(histManualId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public HistManuals deleteHistManuals(HistManuals histManuals)
		throws SystemException {
		return histManualsPersistence.remove(histManuals);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(HistManuals.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return histManualsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return histManualsPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return histManualsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public HistManuals fetchHistManuals(long histManualId)
		throws SystemException {
		return histManualsPersistence.fetchByPrimaryKey(histManualId);
	}
	 ...
	 */
	@Override
	public HistManuals getHistManuals(long histManualId)
		throws PortalException, SystemException {
		return histManualsPersistence.findByPrimaryKey(histManualId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return histManualsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<HistManuals> getHistManualses(int start, int end)
		throws SystemException {
		return histManualsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getHistManualsesCount() throws SystemException {
		return histManualsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public HistManuals updateHistManuals(HistManuals histManuals)
		throws SystemException {
		return histManualsPersistence.update(histManuals);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.HistManuals",
			histManualsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.HistManuals");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = histManualsPersistence.getDataSource();
	...
	private HistManualsLocalServiceClpInvoker _clpInvoker = new HistManualsLocalServiceClpInvoker();
}