...
<c:when test="${seTemplateId > 0}">
	...
	<div id="std-gem-editable" class="gem-grid-panel">
	     <iframe src="/BSBridge-portlet/gem/ql-edit-grid?publishId=${publishId}&bridgePublishId=${bridgePublishId}&gemDepartmentId=${gemDepartmentId}&seTemplateId=${seTemplateId}&saTemplateId=${saTemplateId}&regionId=${regionId}&showMaximize=${showMaximize}" class="gem-grid-frame" id="gem-grid-frame"></iframe>
	</div>
</c:when>
