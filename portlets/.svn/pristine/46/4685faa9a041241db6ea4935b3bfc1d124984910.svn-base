...
/**
 * Provides the local service interface for PublishExtStd. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mummanedi
 * @see PublishExtStdLocalServiceUtil
...
public interface PublishExtStdLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PublishExtStdLocalServiceUtil} to access the Custom Query mapping between PUBLISH_STD and STD_CTRY_CHAIN tables. local service. Add custom service methods to {@link com.ihg.brandstandards.db.service.impl.PublishExtStdLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
