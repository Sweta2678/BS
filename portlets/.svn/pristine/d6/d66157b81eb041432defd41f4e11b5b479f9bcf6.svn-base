...
public class XLSRecordMappingFactory
{
    ...
    public static XlsRecordMapping getMapping(InputStream stream, String recordName) throws UnsupportedMappingException,
            JAXBException
    {
    ...
    public static XlsRecordMapping getMapping(String filePath, String recordName) throws UnsupportedMappingException,
    ...
    public static XlsRecordMapping getMappingByRecordType(String filePath, String recordType) throws UnsupportedMappingException,
            FileNotFoundException, JAXBException
    {
        Map<String, XlsRecordMapping> recordMap = createMapping(filePath);
    ...
    public static Map<String, XlsRecordMapping> createMappingByRecordType(String filePath) throws FileNotFoundException,
            JAXBException
    {
    ...
    private static Map<String, XlsRecordMapping> createMapping(InputStream stream, int keyType) throws JAXBException
    {
        ...
        JAXBElement<XlsRecordListMapping> recordMappingElement = (JAXBElement<XlsRecordListMapping>) unmarshaller
                .unmarshal(stream);
