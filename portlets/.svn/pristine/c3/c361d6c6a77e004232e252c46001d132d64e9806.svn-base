...
public class MailUtil 
{
    ...
    public static Map<String, String> getRoles()
    {
        ...
        rolesMap.put(BrandStandardsUtil.AUTHORS_GLOBAL_ROLE, "Global Standards Author");
        
        rolesMap.put(BrandStandardsUtil.AUTHORS_AMER_ROLE, "AMER Standards Author");
        rolesMap.put(BrandStandardsUtil.AUTHORS_EUROPE_ROLE, "Europe Standards Author");
        rolesMap.put(BrandStandardsUtil.AUTHORS_AMEA_ROLE, "AMEA Standards Author");
        rolesMap.put(BrandStandardsUtil.AUTHORS_GC_ROLE, "GC Standards Author");
        
        rolesMap.put(BrandStandardsUtil.VIEWERS_GLOBAL_ROLE, "Viewer Only");
        
        rolesMap.put(BrandStandardsUtil.TECHNICAL_WRITERS_GLOBAL_ROLE, "Global Standards Technical Writers");
       
        rolesMap.put(BrandStandardsUtil.TECHNICAL_WRITERS_AMER_ROLE, "AMER Standards Technical Writers");
        rolesMap.put(BrandStandardsUtil.TECHNICAL_WRITERS_EUROPE_ROLE, "EURO Standards Technical Writers");
        rolesMap.put(BrandStandardsUtil.TECHNICAL_WRITERS_AMEA_ROLE, "AMEA Standards Technical Writers");
        rolesMap.put(BrandStandardsUtil.TECHNICAL_WRITERS_GC_ROLE, "GC Standards Technical Writers");
        
        rolesMap.put(BrandStandardsUtil.BUSINESS_OWNERS_GLOBAL_ROLE, "Global Standards Owners");
      
        rolesMap.put(BrandStandardsUtil.BUSINESS_OWNERS_AMER_ROLE, "AMER  Standards Owners");
        rolesMap.put(BrandStandardsUtil.BUSINESS_OWNERS_EUROPE_ROLE, "EURO  Standards Owners");
        rolesMap.put(BrandStandardsUtil.BUSINESS_OWNERS_AMEA_ROLE, "AMEA Standards Owners");
        rolesMap.put(BrandStandardsUtil.BUSINESS_OWNERS_GC_ROLE, "GC Standards Owners");
        
        
        rolesMap.put("GLOBAL_MANUAL_AUTHOR", "Global Manual Author");
        rolesMap.put("AMER_MANUAL_AUTHOR", "AMER Manual Author");
        rolesMap.put("EUROPE_MANUAL_AUTHOR", "Europe Manual Author");
        rolesMap.put("AMEA_MANUAL_AUTHOR", "AMEA Manual Author");
        rolesMap.put("GC_MANUAL_AUTHOR", "GC Manual Author");
        
        rolesMap.put(BrandStandardsUtil.APPROVER_GLBL_ROLE, "Global Approver");
        
        rolesMap.put(BrandStandardsUtil.APPROVER_AMER_ROLE, "AMER Approver");
        rolesMap.put(BrandStandardsUtil.APPROVER_EUROPE_ROLE, "Europe Approver");
        rolesMap.put(BrandStandardsUtil.APPROVER_AMEA_ROLE, "AMEA Approver");
        rolesMap.put(BrandStandardsUtil.APPROVER_GC_ROLE, "GC Approver");
