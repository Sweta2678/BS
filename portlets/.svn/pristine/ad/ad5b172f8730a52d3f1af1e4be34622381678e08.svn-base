...
public class GlossaryLocalServiceWrapper implements GlossaryLocalService,
	...
	*/
	...
	public com.ihg.brandstandards.db.model.Glossary getGlossaries(
		...
		return _glossaryLocalService.getGlossaries(startChar, glossaryId);
	}
	...
	public com.ihg.brandstandards.db.model.Glossary getGlossaryByTermText(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _glossaryLocalService.getGlossaryByTermText(termTxt);
	}
	...
	*/
	...
	public java.util.List<com.ihg.brandstandards.db.model.Glossary> getGlossaryIdByBrandCode(
		...
		return _glossaryLocalService.getGlossaryIdByBrandCode(brandCode);
	}

	@Override
	public void clearCache() {
		_glossaryLocalService.clearCache();
	}
