...
import com.ihg.brandstandards.db.service.ExternalLinkStandardsCountryLocalService;
import com.ihg.brandstandards.db.service.persistence.AttachmentsStandardsCountryFinder;
...
import com.ihg.brandstandards.db.service.persistence.BridgeProgressCategoryPersistence;
import com.ihg.brandstandards.db.service.persistence.BridgeProgressDiscrepancyFinder;
import com.ihg.brandstandards.db.service.persistence.BridgeProgressDiscrepancyPersistence;
import com.ihg.brandstandards.db.service.persistence.BridgeProgressSubCategoryPersistence;
...
import com.ihg.brandstandards.db.service.persistence.CountryStandardsFinder;
...
import com.ihg.brandstandards.db.service.persistence.ExternalLinkStandardsCountryFinder;
...
import com.ihg.brandstandards.db.service.persistence.StandardTagPersistence;
...
import com.ihg.brandstandards.db.service.persistence.StandardsCountryImagesFinder;
...
import com.ihg.brandstandards.db.service.persistence.StandardsRegionFinder;
...
/**
 * Provides the base implementation for the external link standards country local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.ExternalLinkStandardsCountryLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 * @see com.ihg.brandstandards.db.service.impl.ExternalLinkStandardsCountryLocalServiceImpl
 * @see com.ihg.brandstandards.db.service.ExternalLinkStandardsCountryLocalServiceUtil
 * @generated
 */
public abstract class ExternalLinkStandardsCountryLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements ExternalLinkStandardsCountryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.ExternalLinkStandardsCountryLocalServiceUtil} to access the external link standards country local service.
	 */

	/**
	 * Adds the external link standards country to the database. Also notifies the appropriate model listeners.
	 *
	 * @param externalLinkStandardsCountry the external link standards country
	 * @return the external link standards country that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ExternalLinkStandardsCountry addExternalLinkStandardsCountry(
		ExternalLinkStandardsCountry externalLinkStandardsCountry)
		throws SystemException {
		externalLinkStandardsCountry.setNew(true);

		return externalLinkStandardsCountryPersistence.update(externalLinkStandardsCountry);
	}
	 ...
	 */
	@Override
	public ExternalLinkStandardsCountry createExternalLinkStandardsCountry(
		ExternalLinkStandardsCountryPK externalLinkStandardsCountryPK) {
		return externalLinkStandardsCountryPersistence.create(externalLinkStandardsCountryPK);
	}

	/**
	 * Deletes the external link standards country with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 ...
	 * @throws PortalException if a external link standards country with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ExternalLinkStandardsCountry deleteExternalLinkStandardsCountry(
		ExternalLinkStandardsCountryPK externalLinkStandardsCountryPK)
		throws PortalException, SystemException {
		return externalLinkStandardsCountryPersistence.remove(externalLinkStandardsCountryPK);
	}

	/**
	 * Deletes the external link standards country from the database. Also notifies the appropriate model listeners.
	 *
	 * @param externalLinkStandardsCountry the external link standards country
	 * @return the external link standards country that was removed
	 * @throws SystemException if a system exception occurred
	...
	public ExternalLinkStandardsCountry deleteExternalLinkStandardsCountry(
		ExternalLinkStandardsCountry externalLinkStandardsCountry)
		throws SystemException {
		return externalLinkStandardsCountryPersistence.remove(externalLinkStandardsCountry);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ExternalLinkStandardsCountry.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return externalLinkStandardsCountryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return externalLinkStandardsCountryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ExternalLinkStandardsCountry fetchExternalLinkStandardsCountry(
		ExternalLinkStandardsCountryPK externalLinkStandardsCountryPK)
		throws SystemException {
		return externalLinkStandardsCountryPersistence.fetchByPrimaryKey(externalLinkStandardsCountryPK);
	}

	/**
	 * Returns the external link standards country with the primary key.
	 *
	 * @param externalLinkStandardsCountryPK the primary key of the external link standards country
	 ...
	 */
	@Override
	public ExternalLinkStandardsCountry getExternalLinkStandardsCountry(
		ExternalLinkStandardsCountryPK externalLinkStandardsCountryPK)
		throws PortalException, SystemException {
		return externalLinkStandardsCountryPersistence.findByPrimaryKey(externalLinkStandardsCountryPK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return externalLinkStandardsCountryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ExternalLinkStandardsCountry> getExternalLinkStandardsCountries(
		int start, int end) throws SystemException {
		return externalLinkStandardsCountryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getExternalLinkStandardsCountriesCount()
		throws SystemException {
		return externalLinkStandardsCountryPersistence.countAll();
	}

	/**
	 * Updates the external link standards country in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param externalLinkStandardsCountry the external link standards country
	 * @return the external link standards country that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ExternalLinkStandardsCountry updateExternalLinkStandardsCountry(
		ExternalLinkStandardsCountry externalLinkStandardsCountry)
		throws SystemException {
		return externalLinkStandardsCountryPersistence.update(externalLinkStandardsCountry);
	}
	...
	/**
	 * Returns the attachments standards country finder.
	 *
	 * @return the attachments standards country finder
	 */
	public AttachmentsStandardsCountryFinder getAttachmentsStandardsCountryFinder() {
		return attachmentsStandardsCountryFinder;
	}

	/**
	 * Sets the attachments standards country finder.
	 *
	 * @param attachmentsStandardsCountryFinder the attachments standards country finder
	 */
	public void setAttachmentsStandardsCountryFinder(
		AttachmentsStandardsCountryFinder attachmentsStandardsCountryFinder) {
		this.attachmentsStandardsCountryFinder = attachmentsStandardsCountryFinder;
	}
	...
	/**
	 * Returns the bridge progress category local service.
	 *
	 * @return the bridge progress category local service
	 */
	public com.ihg.brandstandards.db.service.BridgeProgressCategoryLocalService getBridgeProgressCategoryLocalService() {
		return bridgeProgressCategoryLocalService;
	}

	/**
	 * Sets the bridge progress category local service.
	 *
	 * @param bridgeProgressCategoryLocalService the bridge progress category local service
	 */
	public void setBridgeProgressCategoryLocalService(
		com.ihg.brandstandards.db.service.BridgeProgressCategoryLocalService bridgeProgressCategoryLocalService) {
		this.bridgeProgressCategoryLocalService = bridgeProgressCategoryLocalService;
	}

	/**
	 * Returns the bridge progress category persistence.
	 *
	 * @return the bridge progress category persistence
	 */
	public BridgeProgressCategoryPersistence getBridgeProgressCategoryPersistence() {
		return bridgeProgressCategoryPersistence;
	}

	/**
	 * Sets the bridge progress category persistence.
	 *
	 * @param bridgeProgressCategoryPersistence the bridge progress category persistence
	 */
	public void setBridgeProgressCategoryPersistence(
		BridgeProgressCategoryPersistence bridgeProgressCategoryPersistence) {
		this.bridgeProgressCategoryPersistence = bridgeProgressCategoryPersistence;
	}

	/**
	 * Returns the bridge progress discrepancy local service.
	 *
	 * @return the bridge progress discrepancy local service
	 */
	public com.ihg.brandstandards.db.service.BridgeProgressDiscrepancyLocalService getBridgeProgressDiscrepancyLocalService() {
		return bridgeProgressDiscrepancyLocalService;
	}

	/**
	 * Sets the bridge progress discrepancy local service.
	 *
	 * @param bridgeProgressDiscrepancyLocalService the bridge progress discrepancy local service
	 */
	public void setBridgeProgressDiscrepancyLocalService(
		com.ihg.brandstandards.db.service.BridgeProgressDiscrepancyLocalService bridgeProgressDiscrepancyLocalService) {
		this.bridgeProgressDiscrepancyLocalService = bridgeProgressDiscrepancyLocalService;
	}

	/**
	 * Returns the bridge progress discrepancy persistence.
	 *
	 * @return the bridge progress discrepancy persistence
	 */
	public BridgeProgressDiscrepancyPersistence getBridgeProgressDiscrepancyPersistence() {
		return bridgeProgressDiscrepancyPersistence;
	}

	/**
	 * Sets the bridge progress discrepancy persistence.
	 *
	 * @param bridgeProgressDiscrepancyPersistence the bridge progress discrepancy persistence
	 */
	public void setBridgeProgressDiscrepancyPersistence(
		BridgeProgressDiscrepancyPersistence bridgeProgressDiscrepancyPersistence) {
		this.bridgeProgressDiscrepancyPersistence = bridgeProgressDiscrepancyPersistence;
	}

	/**
	 * Returns the bridge progress discrepancy finder.
	 *
	 * @return the bridge progress discrepancy finder
	 */
	public BridgeProgressDiscrepancyFinder getBridgeProgressDiscrepancyFinder() {
		return bridgeProgressDiscrepancyFinder;
	}

	/**
	 * Sets the bridge progress discrepancy finder.
	 *
	 * @param bridgeProgressDiscrepancyFinder the bridge progress discrepancy finder
	 */
	public void setBridgeProgressDiscrepancyFinder(
		BridgeProgressDiscrepancyFinder bridgeProgressDiscrepancyFinder) {
		this.bridgeProgressDiscrepancyFinder = bridgeProgressDiscrepancyFinder;
	}

	/**
	 * Returns the bridge progress sub category local service.
	 *
	 * @return the bridge progress sub category local service
	 */
	public com.ihg.brandstandards.db.service.BridgeProgressSubCategoryLocalService getBridgeProgressSubCategoryLocalService() {
		return bridgeProgressSubCategoryLocalService;
	}

	/**
	 * Sets the bridge progress sub category local service.
	 *
	 * @param bridgeProgressSubCategoryLocalService the bridge progress sub category local service
	 */
	public void setBridgeProgressSubCategoryLocalService(
		com.ihg.brandstandards.db.service.BridgeProgressSubCategoryLocalService bridgeProgressSubCategoryLocalService) {
		this.bridgeProgressSubCategoryLocalService = bridgeProgressSubCategoryLocalService;
	}

	/**
	 * Returns the bridge progress sub category persistence.
	 *
	 * @return the bridge progress sub category persistence
	 */
	public BridgeProgressSubCategoryPersistence getBridgeProgressSubCategoryPersistence() {
		return bridgeProgressSubCategoryPersistence;
	}

	/**
	 * Sets the bridge progress sub category persistence.
	 *
	 * @param bridgeProgressSubCategoryPersistence the bridge progress sub category persistence
	 */
	public void setBridgeProgressSubCategoryPersistence(
		BridgeProgressSubCategoryPersistence bridgeProgressSubCategoryPersistence) {
		this.bridgeProgressSubCategoryPersistence = bridgeProgressSubCategoryPersistence;
	}
	...
	/**
	 * Returns the country standards finder.
	 *
	 * @return the country standards finder
	 */
	public CountryStandardsFinder getCountryStandardsFinder() {
		return countryStandardsFinder;
	}

	/**
	 * Sets the country standards finder.
	 *
	 * @param countryStandardsFinder the country standards finder
	 */
	public void setCountryStandardsFinder(
		CountryStandardsFinder countryStandardsFinder) {
		this.countryStandardsFinder = countryStandardsFinder;
	}
	...
	/**
	 * Returns the external link standards country finder.
	 *
	 * @return the external link standards country finder
	 */
	public ExternalLinkStandardsCountryFinder getExternalLinkStandardsCountryFinder() {
		return externalLinkStandardsCountryFinder;
	}

	/**
	 * Sets the external link standards country finder.
	 *
	 * @param externalLinkStandardsCountryFinder the external link standards country finder
	 */
	public void setExternalLinkStandardsCountryFinder(
		ExternalLinkStandardsCountryFinder externalLinkStandardsCountryFinder) {
		this.externalLinkStandardsCountryFinder = externalLinkStandardsCountryFinder;
	}
	...
	/**
	 * Returns the standards country images finder.
	 *
	 * @return the standards country images finder
	 */
	public StandardsCountryImagesFinder getStandardsCountryImagesFinder() {
		return standardsCountryImagesFinder;
	}

	/**
	 * Sets the standards country images finder.
	 *
	 * @param standardsCountryImagesFinder the standards country images finder
	 */
	public void setStandardsCountryImagesFinder(
		StandardsCountryImagesFinder standardsCountryImagesFinder) {
		this.standardsCountryImagesFinder = standardsCountryImagesFinder;
	}
	...
	/**
	 * Returns the standards region finder.
	 *
	 * @return the standards region finder
	 */
	public StandardsRegionFinder getStandardsRegionFinder() {
		return standardsRegionFinder;
	}

	/**
	 * Sets the standards region finder.
	 *
	 * @param standardsRegionFinder the standards region finder
	 */
	public void setStandardsRegionFinder(
		StandardsRegionFinder standardsRegionFinder) {
		this.standardsRegionFinder = standardsRegionFinder;
	}
	...
	/**
	 * Returns the standard tag local service.
	 *
	 * @return the standard tag local service
	 */
	public com.ihg.brandstandards.db.service.StandardTagLocalService getStandardTagLocalService() {
		return standardTagLocalService;
	}

	/**
	 * Sets the standard tag local service.
	 *
	 * @param standardTagLocalService the standard tag local service
	 */
	public void setStandardTagLocalService(
		com.ihg.brandstandards.db.service.StandardTagLocalService standardTagLocalService) {
		this.standardTagLocalService = standardTagLocalService;
	}

	/**
	 * Returns the standard tag persistence.
	 *
	 * @return the standard tag persistence
	 */
	public StandardTagPersistence getStandardTagPersistence() {
		return standardTagPersistence;
	}

	/**
	 * Sets the standard tag persistence.
	 *
	 * @param standardTagPersistence the standard tag persistence
	 */
	public void setStandardTagPersistence(
		StandardTagPersistence standardTagPersistence) {
		this.standardTagPersistence = standardTagPersistence;
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.ExternalLinkStandardsCountry",
			externalLinkStandardsCountryLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = externalLinkStandardsCountryPersistence.getDataSource();
	...
	@BeanReference(type = AttachmentsStandardsCountryFinder.class)
	protected AttachmentsStandardsCountryFinder attachmentsStandardsCountryFinder;
	...
	@BeanReference(type = com.ihg.brandstandards.db.service.BridgeProgressCategoryLocalService.class)
	protected com.ihg.brandstandards.db.service.BridgeProgressCategoryLocalService bridgeProgressCategoryLocalService;
	@BeanReference(type = BridgeProgressCategoryPersistence.class)
	protected BridgeProgressCategoryPersistence bridgeProgressCategoryPersistence;
	@BeanReference(type = com.ihg.brandstandards.db.service.BridgeProgressDiscrepancyLocalService.class)
	protected com.ihg.brandstandards.db.service.BridgeProgressDiscrepancyLocalService bridgeProgressDiscrepancyLocalService;
	@BeanReference(type = BridgeProgressDiscrepancyPersistence.class)
	protected BridgeProgressDiscrepancyPersistence bridgeProgressDiscrepancyPersistence;
	@BeanReference(type = BridgeProgressDiscrepancyFinder.class)
	protected BridgeProgressDiscrepancyFinder bridgeProgressDiscrepancyFinder;
	@BeanReference(type = com.ihg.brandstandards.db.service.BridgeProgressSubCategoryLocalService.class)
	protected com.ihg.brandstandards.db.service.BridgeProgressSubCategoryLocalService bridgeProgressSubCategoryLocalService;
	@BeanReference(type = BridgeProgressSubCategoryPersistence.class)
	protected BridgeProgressSubCategoryPersistence bridgeProgressSubCategoryPersistence;
	...
	@BeanReference(type = CountryStandardsFinder.class)
	protected CountryStandardsFinder countryStandardsFinder;
	...
	@BeanReference(type = ExternalLinkStandardsCountryFinder.class)
	protected ExternalLinkStandardsCountryFinder externalLinkStandardsCountryFinder;
	...
	@BeanReference(type = StandardsCountryImagesFinder.class)
	protected StandardsCountryImagesFinder standardsCountryImagesFinder;
	...
	@BeanReference(type = StandardsRegionFinder.class)
	protected StandardsRegionFinder standardsRegionFinder;
	...
	@BeanReference(type = com.ihg.brandstandards.db.service.StandardTagLocalService.class)
	protected com.ihg.brandstandards.db.service.StandardTagLocalService standardTagLocalService;
	@BeanReference(type = StandardTagPersistence.class)
	protected StandardTagPersistence standardTagPersistence;
	...
	private ExternalLinkStandardsCountryLocalServiceClpInvoker _clpInvoker = new ExternalLinkStandardsCountryLocalServiceClpInvoker();
}