...
import com.ihg.brandstandards.db.service.GEMTemplateReferenceLocalService;
...
/**
 * Provides the base implementation for the g e m template reference local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.GEMTemplateReferenceLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 * @see com.ihg.brandstandards.db.service.impl.GEMTemplateReferenceLocalServiceImpl
 * @see com.ihg.brandstandards.db.service.GEMTemplateReferenceLocalServiceUtil
 * @generated
 */
public abstract class GEMTemplateReferenceLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements GEMTemplateReferenceLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.GEMTemplateReferenceLocalServiceUtil} to access the g e m template reference local service.
	 */
	...
	@Override
	public GEMTemplateReference addGEMTemplateReference(
		GEMTemplateReference gemTemplateReference) throws SystemException {
		gemTemplateReference.setNew(true);

		return gemTemplateReferencePersistence.update(gemTemplateReference);
	}
	 ...
	 */
	@Override
	public GEMTemplateReference createGEMTemplateReference(long templateRefId) {
		return gemTemplateReferencePersistence.create(templateRefId);
	}
	...
	@Override
	public GEMTemplateReference deleteGEMTemplateReference(long templateRefId)
		throws PortalException, SystemException {
		return gemTemplateReferencePersistence.remove(templateRefId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public GEMTemplateReference deleteGEMTemplateReference(
		GEMTemplateReference gemTemplateReference) throws SystemException {
		return gemTemplateReferencePersistence.remove(gemTemplateReference);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(GEMTemplateReference.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return gemTemplateReferencePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return gemTemplateReferencePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public GEMTemplateReference fetchGEMTemplateReference(long templateRefId)
		throws SystemException {
		return gemTemplateReferencePersistence.fetchByPrimaryKey(templateRefId);
	}
	 ...
	 */
	@Override
	public GEMTemplateReference getGEMTemplateReference(long templateRefId)
		throws PortalException, SystemException {
		return gemTemplateReferencePersistence.findByPrimaryKey(templateRefId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return gemTemplateReferencePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<GEMTemplateReference> getGEMTemplateReferences(int start,
		int end) throws SystemException {
		return gemTemplateReferencePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getGEMTemplateReferencesCount() throws SystemException {
		return gemTemplateReferencePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public GEMTemplateReference updateGEMTemplateReference(
		GEMTemplateReference gemTemplateReference) throws SystemException {
		return gemTemplateReferencePersistence.update(gemTemplateReference);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.GEMTemplateReference",
			gemTemplateReferenceLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.GEMTemplateReference");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = gemTemplateReferencePersistence.getDataSource();
	...
	private GEMTemplateReferenceLocalServiceClpInvoker _clpInvoker = new GEMTemplateReferenceLocalServiceClpInvoker();
}