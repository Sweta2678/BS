...
public class StandardsAuthorsLocalServiceClpInvoker {
	public StandardsAuthorsLocalServiceClpInvoker() {
		...
		_methodName587 = "getStandardsAuthorsByStdId";

		_methodParameterTypes587 = new String[] { "long" };

		_methodName588 = "getStandardsAuthorsByAuthor";

		_methodParameterTypes588 = new String[] {
				"java.lang.String", "java.lang.String"
			};

		_methodName589 = "getAuthorStdIdPrimary";

		_methodParameterTypes589 = new String[] { "long", "java.lang.String" };

		_methodName590 = "removeByStdAuthor";
