...
import com.ihg.brandstandards.db.service.GEMManagementBucketLocalService;
...
/**
 * Provides the base implementation for the g e m management bucket local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.GEMManagementBucketLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 * @see com.ihg.brandstandards.db.service.impl.GEMManagementBucketLocalServiceImpl
 * @see com.ihg.brandstandards.db.service.GEMManagementBucketLocalServiceUtil
 * @generated
 */
public abstract class GEMManagementBucketLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements GEMManagementBucketLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.GEMManagementBucketLocalServiceUtil} to access the g e m management bucket local service.
	 */

	/**
	 * Adds the g e m management bucket to the database. Also notifies the appropriate model listeners.
	 *
	 * @param gemManagementBucket the g e m management bucket
	 * @return the g e m management bucket that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public GEMManagementBucket addGEMManagementBucket(
		GEMManagementBucket gemManagementBucket) throws SystemException {
		gemManagementBucket.setNew(true);

		return gemManagementBucketPersistence.update(gemManagementBucket);
	}
	 ...
	 */
	@Override
	public GEMManagementBucket createGEMManagementBucket(long bucketId) {
		return gemManagementBucketPersistence.create(bucketId);
	}

	/**
	 * Deletes the g e m management bucket with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param bucketId the primary key of the g e m management bucket
	 * @return the g e m management bucket that was removed
	 * @throws PortalException if a g e m management bucket with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public GEMManagementBucket deleteGEMManagementBucket(long bucketId)
		throws PortalException, SystemException {
		return gemManagementBucketPersistence.remove(bucketId);
	}

	/**
	 * Deletes the g e m management bucket from the database. Also notifies the appropriate model listeners.
	 *
	 * @param gemManagementBucket the g e m management bucket
	 * @return the g e m management bucket that was removed
	 * @throws SystemException if a system exception occurred
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public GEMManagementBucket deleteGEMManagementBucket(
		GEMManagementBucket gemManagementBucket) throws SystemException {
		return gemManagementBucketPersistence.remove(gemManagementBucket);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(GEMManagementBucket.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return gemManagementBucketPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return gemManagementBucketPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public GEMManagementBucket fetchGEMManagementBucket(long bucketId)
		throws SystemException {
		return gemManagementBucketPersistence.fetchByPrimaryKey(bucketId);
	}

	/**
	 * Returns the g e m management bucket with the primary key.
	 *
	 * @param bucketId the primary key of the g e m management bucket
	 ...
	 */
	@Override
	public GEMManagementBucket getGEMManagementBucket(long bucketId)
		throws PortalException, SystemException {
		return gemManagementBucketPersistence.findByPrimaryKey(bucketId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return gemManagementBucketPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<GEMManagementBucket> getGEMManagementBuckets(int start, int end)
		throws SystemException {
		return gemManagementBucketPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getGEMManagementBucketsCount() throws SystemException {
		return gemManagementBucketPersistence.countAll();
	}

	/**
	 * Updates the g e m management bucket in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param gemManagementBucket the g e m management bucket
	 * @return the g e m management bucket that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public GEMManagementBucket updateGEMManagementBucket(
		GEMManagementBucket gemManagementBucket) throws SystemException {
		return gemManagementBucketPersistence.update(gemManagementBucket);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.GEMManagementBucket",
			gemManagementBucketLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.GEMManagementBucket");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = gemManagementBucketPersistence.getDataSource();
	...
	private GEMManagementBucketLocalServiceClpInvoker _clpInvoker = new GEMManagementBucketLocalServiceClpInvoker();
}