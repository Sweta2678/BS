...
import com.ihg.brandstandards.db.service.GEMMeasurementFormulaValueLocalService;
...
/**
 * Provides the base implementation for the g e m measurement formula value local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.GEMMeasurementFormulaValueLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 * @see com.ihg.brandstandards.db.service.impl.GEMMeasurementFormulaValueLocalServiceImpl
 * @see com.ihg.brandstandards.db.service.GEMMeasurementFormulaValueLocalServiceUtil
 * @generated
 */
public abstract class GEMMeasurementFormulaValueLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements GEMMeasurementFormulaValueLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.GEMMeasurementFormulaValueLocalServiceUtil} to access the g e m measurement formula value local service.
	 */
	...
	@Override
	public GEMMeasurementFormulaValue addGEMMeasurementFormulaValue(
		GEMMeasurementFormulaValue gemMeasurementFormulaValue)
		throws SystemException {
		gemMeasurementFormulaValue.setNew(true);

		return gemMeasurementFormulaValuePersistence.update(gemMeasurementFormulaValue);
	}
	 ...
	 */
	@Override
	public GEMMeasurementFormulaValue createGEMMeasurementFormulaValue(
		long formulaValueId) {
		return gemMeasurementFormulaValuePersistence.create(formulaValueId);
	}
	...
	@Override
	public GEMMeasurementFormulaValue deleteGEMMeasurementFormulaValue(
		long formulaValueId) throws PortalException, SystemException {
		return gemMeasurementFormulaValuePersistence.remove(formulaValueId);
	}
	...
	public GEMMeasurementFormulaValue deleteGEMMeasurementFormulaValue(
		GEMMeasurementFormulaValue gemMeasurementFormulaValue)
		throws SystemException {
		return gemMeasurementFormulaValuePersistence.remove(gemMeasurementFormulaValue);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(GEMMeasurementFormulaValue.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return gemMeasurementFormulaValuePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return gemMeasurementFormulaValuePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public GEMMeasurementFormulaValue fetchGEMMeasurementFormulaValue(
		long formulaValueId) throws SystemException {
		return gemMeasurementFormulaValuePersistence.fetchByPrimaryKey(formulaValueId);
	}
	 ...
	 */
	@Override
	public GEMMeasurementFormulaValue getGEMMeasurementFormulaValue(
		long formulaValueId) throws PortalException, SystemException {
		return gemMeasurementFormulaValuePersistence.findByPrimaryKey(formulaValueId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return gemMeasurementFormulaValuePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<GEMMeasurementFormulaValue> getGEMMeasurementFormulaValues(
		int start, int end) throws SystemException {
		return gemMeasurementFormulaValuePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getGEMMeasurementFormulaValuesCount() throws SystemException {
		return gemMeasurementFormulaValuePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public GEMMeasurementFormulaValue updateGEMMeasurementFormulaValue(
		GEMMeasurementFormulaValue gemMeasurementFormulaValue)
		throws SystemException {
		return gemMeasurementFormulaValuePersistence.update(gemMeasurementFormulaValue);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.GEMMeasurementFormulaValue",
			gemMeasurementFormulaValueLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.GEMMeasurementFormulaValue");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = gemMeasurementFormulaValuePersistence.getDataSource();
	...
	private GEMMeasurementFormulaValueLocalServiceClpInvoker _clpInvoker = new GEMMeasurementFormulaValueLocalServiceClpInvoker();
}