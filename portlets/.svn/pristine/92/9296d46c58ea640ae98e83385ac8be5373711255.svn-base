...
import com.ihg.brandstandards.db.service.BridgePublishLocalService;
...
/**
 * Provides the base implementation for the bridge publish local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.BridgePublishLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class BridgePublishLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements BridgePublishLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.BridgePublishLocalServiceUtil} to access the bridge publish local service.
	 */
	...
	@Override
	public BridgePublish addBridgePublish(BridgePublish bridgePublish)
		throws SystemException {
		bridgePublish.setNew(true);

		return bridgePublishPersistence.update(bridgePublish);
	}
	 ...
	 */
	@Override
	public BridgePublish createBridgePublish(long bridgePublishId) {
		return bridgePublishPersistence.create(bridgePublishId);
	}
	...
	@Override
	public BridgePublish deleteBridgePublish(long bridgePublishId)
		throws PortalException, SystemException {
		return bridgePublishPersistence.remove(bridgePublishId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public BridgePublish deleteBridgePublish(BridgePublish bridgePublish)
		throws SystemException {
		return bridgePublishPersistence.remove(bridgePublish);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(BridgePublish.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return bridgePublishPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return bridgePublishPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public BridgePublish fetchBridgePublish(long bridgePublishId)
		throws SystemException {
		return bridgePublishPersistence.fetchByPrimaryKey(bridgePublishId);
	}
	 ...
	 */
	@Override
	public BridgePublish getBridgePublish(long bridgePublishId)
		throws PortalException, SystemException {
		return bridgePublishPersistence.findByPrimaryKey(bridgePublishId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return bridgePublishPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<BridgePublish> getBridgePublishs(int start, int end)
		throws SystemException {
		return bridgePublishPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getBridgePublishsCount() throws SystemException {
		return bridgePublishPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public BridgePublish updateBridgePublish(BridgePublish bridgePublish)
		throws SystemException {
		return bridgePublishPersistence.update(bridgePublish);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.BridgePublish",
			bridgePublishLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = bridgePublishPersistence.getDataSource();
	...
	private BridgePublishLocalServiceClpInvoker _clpInvoker = new BridgePublishLocalServiceClpInvoker();
}