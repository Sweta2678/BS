...
import com.ihg.brandstandards.db.service.CountryStandardsExtLocalService;
...
/**
 * Provides the base implementation for the country standards ext local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.CountryStandardsExtLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class CountryStandardsExtLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CountryStandardsExtLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.CountryStandardsExtLocalServiceUtil} to access the country standards ext local service.
	 */
	...
	@Override
	public CountryStandardsExt addCountryStandardsExt(
		CountryStandardsExt countryStandardsExt) throws SystemException {
		countryStandardsExt.setNew(true);

		return countryStandardsExtPersistence.update(countryStandardsExt);
	}
	 ...
	 */
	@Override
	public CountryStandardsExt createCountryStandardsExt(
		CountryStandardsExtPK countryStandardsExtPK) {
		return countryStandardsExtPersistence.create(countryStandardsExtPK);
	}
	...
	@Override
	public CountryStandardsExt deleteCountryStandardsExt(
		CountryStandardsExtPK countryStandardsExtPK)
		throws PortalException, SystemException {
		return countryStandardsExtPersistence.remove(countryStandardsExtPK);
	}
	...
	public CountryStandardsExt deleteCountryStandardsExt(
		CountryStandardsExt countryStandardsExt) throws SystemException {
		return countryStandardsExtPersistence.remove(countryStandardsExt);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CountryStandardsExt.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return countryStandardsExtPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return countryStandardsExtPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CountryStandardsExt fetchCountryStandardsExt(
		CountryStandardsExtPK countryStandardsExtPK) throws SystemException {
		return countryStandardsExtPersistence.fetchByPrimaryKey(countryStandardsExtPK);
	}
	 ...
	 */
	@Override
	public CountryStandardsExt getCountryStandardsExt(
		CountryStandardsExtPK countryStandardsExtPK)
		throws PortalException, SystemException {
		return countryStandardsExtPersistence.findByPrimaryKey(countryStandardsExtPK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return countryStandardsExtPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CountryStandardsExt> getCountryStandardsExts(int start, int end)
		throws SystemException {
		return countryStandardsExtPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getCountryStandardsExtsCount() throws SystemException {
		return countryStandardsExtPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CountryStandardsExt updateCountryStandardsExt(
		CountryStandardsExt countryStandardsExt) throws SystemException {
		return countryStandardsExtPersistence.update(countryStandardsExt);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.CountryStandardsExt",
			countryStandardsExtLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = countryStandardsExtPersistence.getDataSource();
	...
	private CountryStandardsExtLocalServiceClpInvoker _clpInvoker = new CountryStandardsExtLocalServiceClpInvoker();
}