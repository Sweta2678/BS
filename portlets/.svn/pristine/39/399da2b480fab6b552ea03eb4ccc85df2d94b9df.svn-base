...
public class WorkflowLocalServiceClpInvoker {
	public WorkflowLocalServiceClpInvoker() {
		...
		_methodName587 = "getWorkflowObject";

		_methodParameterTypes587 = new String[] {  };

		_methodName588 = "getLogByObjectId";

		_methodParameterTypes588 = new String[] { "long" };

		_methodName589 = "getLogBySTDObjectId";

		_methodParameterTypes589 = new String[] { "long" };

		_methodName590 = "getLastLogBySTDObjectId";

		_methodParameterTypes590 = new String[] { "long" };

		_methodName591 = "getLastLogBySTDObjectId";

		_methodParameterTypes591 = new String[] { "long", "java.lang.String" };

		_methodName592 = "getLastLogByStdIdBrand";

		_methodParameterTypes592 = new String[] { "long", "java.util.Collection" };
	}
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return WorkflowLocalServiceUtil.addWorkflow((com.ihg.brandstandards.db.model.Workflow)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return WorkflowLocalServiceUtil.deleteWorkflow((com.ihg.brandstandards.db.model.Workflow)arguments[0]);
		}
		...
		if (_methodName15.equals(name) &&
			...
			return WorkflowLocalServiceUtil.updateWorkflow((com.ihg.brandstandards.db.model.Workflow)arguments[0]);
		}
		...
		if (_methodName587.equals(name) &&
			...
			return WorkflowLocalServiceUtil.getWorkflowObject();
		}

		if (_methodName588.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes588, parameterTypes)) {
			return WorkflowLocalServiceUtil.getLogByObjectId(((Long)arguments[0]).longValue());
		}

		if (_methodName589.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes589, parameterTypes)) {
			return WorkflowLocalServiceUtil.getLogBySTDObjectId(((Long)arguments[0]).longValue());
		}

		if (_methodName590.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes590, parameterTypes)) {
			return WorkflowLocalServiceUtil.getLastLogBySTDObjectId(((Long)arguments[0]).longValue());
		}
		...
		if (_methodName592.equals(name) &&
			...
			return WorkflowLocalServiceUtil.getLastLogByStdIdBrand(((Long)arguments[0]).longValue(),
				(java.util.Collection<java.lang.Object>)arguments[1]);
		}
