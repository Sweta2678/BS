...
import com.ihg.brandstandards.db.service.UniqueGroupCountryLocalService;
...
/**
 * Provides the base implementation for the unique group country local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.UniqueGroupCountryLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 * @see com.ihg.brandstandards.db.service.impl.UniqueGroupCountryLocalServiceImpl
 * @see com.ihg.brandstandards.db.service.UniqueGroupCountryLocalServiceUtil
 * @generated
 */
public abstract class UniqueGroupCountryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements UniqueGroupCountryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.UniqueGroupCountryLocalServiceUtil} to access the unique group country local service.
	 */

	/**
	 * Adds the unique group country to the database. Also notifies the appropriate model listeners.
	 *
	 * @param uniqueGroupCountry the unique group country
	 * @return the unique group country that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public UniqueGroupCountry addUniqueGroupCountry(
		UniqueGroupCountry uniqueGroupCountry) throws SystemException {
		uniqueGroupCountry.setNew(true);

		return uniqueGroupCountryPersistence.update(uniqueGroupCountry);
	}
	 ...
	 */
	@Override
	public UniqueGroupCountry createUniqueGroupCountry(long groupCountryId) {
		return uniqueGroupCountryPersistence.create(groupCountryId);
	}

	/**
	 * Deletes the unique group country with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param groupCountryId the primary key of the unique group country
	 * @return the unique group country that was removed
	 * @throws PortalException if a unique group country with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public UniqueGroupCountry deleteUniqueGroupCountry(long groupCountryId)
		throws PortalException, SystemException {
		return uniqueGroupCountryPersistence.remove(groupCountryId);
	}

	/**
	 * Deletes the unique group country from the database. Also notifies the appropriate model listeners.
	 *
	 * @param uniqueGroupCountry the unique group country
	 * @return the unique group country that was removed
	 * @throws SystemException if a system exception occurred
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public UniqueGroupCountry deleteUniqueGroupCountry(
		UniqueGroupCountry uniqueGroupCountry) throws SystemException {
		return uniqueGroupCountryPersistence.remove(uniqueGroupCountry);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(UniqueGroupCountry.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return uniqueGroupCountryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return uniqueGroupCountryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public UniqueGroupCountry fetchUniqueGroupCountry(long groupCountryId)
		throws SystemException {
		return uniqueGroupCountryPersistence.fetchByPrimaryKey(groupCountryId);
	}

	/**
	 * Returns the unique group country with the primary key.
	 *
	 * @param groupCountryId the primary key of the unique group country
	 ...
	 */
	@Override
	public UniqueGroupCountry getUniqueGroupCountry(long groupCountryId)
		throws PortalException, SystemException {
		return uniqueGroupCountryPersistence.findByPrimaryKey(groupCountryId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return uniqueGroupCountryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<UniqueGroupCountry> getUniqueGroupCountries(int start, int end)
		throws SystemException {
		return uniqueGroupCountryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getUniqueGroupCountriesCount() throws SystemException {
		return uniqueGroupCountryPersistence.countAll();
	}

	/**
	 * Updates the unique group country in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param uniqueGroupCountry the unique group country
	 * @return the unique group country that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public UniqueGroupCountry updateUniqueGroupCountry(
		UniqueGroupCountry uniqueGroupCountry) throws SystemException {
		return uniqueGroupCountryPersistence.update(uniqueGroupCountry);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.UniqueGroupCountry",
			uniqueGroupCountryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.UniqueGroupCountry");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = uniqueGroupCountryPersistence.getDataSource();
	...
	private UniqueGroupCountryLocalServiceClpInvoker _clpInvoker = new UniqueGroupCountryLocalServiceClpInvoker();
}