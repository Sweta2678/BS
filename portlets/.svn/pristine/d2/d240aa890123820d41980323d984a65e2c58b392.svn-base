 ...
 * @generated
 */
public abstract class StandardTagActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public StandardTagActionableDynamicQuery() throws SystemException {
		setBaseLocalService(StandardTagLocalServiceUtil.getService());
		setClass(StandardTag.class);
