...
import com.ihg.brandstandards.db.service.PublishExtStdLocalService;
...
/**
 * Provides the base implementation for the Custom Query mapping between PUBLISH_STD and STD_CTRY_CHAIN tables. local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.PublishExtStdLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class PublishExtStdLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PublishExtStdLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.PublishExtStdLocalServiceUtil} to access the Custom Query mapping between PUBLISH_STD and STD_CTRY_CHAIN tables. local service.
	 */
	...
	@Override
	public PublishExtStd addPublishExtStd(PublishExtStd publishExtStd)
		throws SystemException {
		publishExtStd.setNew(true);

		return publishExtStdPersistence.update(publishExtStd);
	}
	 ...
	 */
	@Override
	public PublishExtStd createPublishExtStd(long stdId) {
		return publishExtStdPersistence.create(stdId);
	}
	...
	@Override
	public PublishExtStd deletePublishExtStd(long stdId)
		throws PortalException, SystemException {
		return publishExtStdPersistence.remove(stdId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PublishExtStd deletePublishExtStd(PublishExtStd publishExtStd)
		throws SystemException {
		return publishExtStdPersistence.remove(publishExtStd);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PublishExtStd.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return publishExtStdPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return publishExtStdPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public PublishExtStd fetchPublishExtStd(long stdId)
		throws SystemException {
		return publishExtStdPersistence.fetchByPrimaryKey(stdId);
	}
	 ...
	 */
	@Override
	public PublishExtStd getPublishExtStd(long stdId)
		throws PortalException, SystemException {
		return publishExtStdPersistence.findByPrimaryKey(stdId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return publishExtStdPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PublishExtStd> getPublishExtStds(int start, int end)
		throws SystemException {
		return publishExtStdPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getPublishExtStdsCount() throws SystemException {
		return publishExtStdPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PublishExtStd updatePublishExtStd(PublishExtStd publishExtStd)
		throws SystemException {
		return publishExtStdPersistence.update(publishExtStd);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.PublishExtStd",
			publishExtStdLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = publishExtStdPersistence.getDataSource();
	...
	private PublishExtStdLocalServiceClpInvoker _clpInvoker = new PublishExtStdLocalServiceClpInvoker();
}