...
public class StandardsImagesLocalServiceClpInvoker {
	public StandardsImagesLocalServiceClpInvoker() {
		...
		_methodName587 = "getStdImages";

		_methodParameterTypes587 = new String[] { "long" };

		_methodName588 = "StandardsImagesCount";

		_methodParameterTypes588 = new String[] { "long" };

		_methodName589 = "getStandardsImagesByStdId";

		_methodParameterTypes589 = new String[] { "long" };

		_methodName590 = "getParentStdImages";

		_methodParameterTypes590 = new String[] { "long" };

		_methodName591 = "getParentStdImagesByLocaleCode";

		_methodParameterTypes591 = new String[] { "long", "java.lang.String" };

		_methodName592 = "getStdImagesByParentImageIdStdId";

		_methodParameterTypes592 = new String[] { "long", "long" };

		_methodName593 = "getStdImagesByParentImageIdStdIdLocaleCd";

		_methodParameterTypes593 = new String[] {
				"long", "long", "java.lang.String"
			};

		_methodName594 = "deleteStdImagesDeep";

		_methodParameterTypes594 = new String[] { "long" };

		_methodName595 = "getStandardsImagesByImageIdStdIdLocaleCd";

		_methodParameterTypes595 = new String[] {
				"long", "long", "java.lang.String"
			};

		_methodName596 = "deleteStandardsImages";

		_methodParameterTypes596 = new String[] { "long" };

		_methodName597 = "getStandardImagesByStdIdAndRgnIdAndLocale";
