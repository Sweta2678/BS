...
import com.ihg.brandstandards.db.service.BridgePublishImportLocalService;
...
/**
 * Provides the base implementation for the bridge publish import local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.BridgePublishImportLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class BridgePublishImportLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements BridgePublishImportLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.BridgePublishImportLocalServiceUtil} to access the bridge publish import local service.
	 */
	...
	@Override
	public BridgePublishImport addBridgePublishImport(
		BridgePublishImport bridgePublishImport) throws SystemException {
		bridgePublishImport.setNew(true);

		return bridgePublishImportPersistence.update(bridgePublishImport);
	}
	 ...
	 */
	@Override
	public BridgePublishImport createBridgePublishImport(long publishImportId) {
		return bridgePublishImportPersistence.create(publishImportId);
	}
	...
	@Override
	public BridgePublishImport deleteBridgePublishImport(long publishImportId)
		throws PortalException, SystemException {
		return bridgePublishImportPersistence.remove(publishImportId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public BridgePublishImport deleteBridgePublishImport(
		BridgePublishImport bridgePublishImport) throws SystemException {
		return bridgePublishImportPersistence.remove(bridgePublishImport);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(BridgePublishImport.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return bridgePublishImportPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return bridgePublishImportPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public BridgePublishImport fetchBridgePublishImport(long publishImportId)
		throws SystemException {
		return bridgePublishImportPersistence.fetchByPrimaryKey(publishImportId);
	}
	 ...
	 */
	@Override
	public BridgePublishImport getBridgePublishImport(long publishImportId)
		throws PortalException, SystemException {
		return bridgePublishImportPersistence.findByPrimaryKey(publishImportId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return bridgePublishImportPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<BridgePublishImport> getBridgePublishImports(int start, int end)
		throws SystemException {
		return bridgePublishImportPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getBridgePublishImportsCount() throws SystemException {
		return bridgePublishImportPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public BridgePublishImport updateBridgePublishImport(
		BridgePublishImport bridgePublishImport) throws SystemException {
		return bridgePublishImportPersistence.update(bridgePublishImport);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.BridgePublishImport",
			bridgePublishImportLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = bridgePublishImportPersistence.getDataSource();
	...
	private BridgePublishImportLocalServiceClpInvoker _clpInvoker = new BridgePublishImportLocalServiceClpInvoker();
}