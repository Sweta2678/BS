...
import com.ihg.brandstandards.db.service.PublishDeptLocalService;
...
/**
 * Provides the base implementation for the publish dept local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.PublishDeptLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class PublishDeptLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PublishDeptLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.PublishDeptLocalServiceUtil} to access the publish dept local service.
	 */
	...
	@Override
	public PublishDept addPublishDept(PublishDept publishDept)
		throws SystemException {
		publishDept.setNew(true);

		return publishDeptPersistence.update(publishDept);
	}
	 ...
	 */
	@Override
	public PublishDept createPublishDept(long publishDeptId) {
		return publishDeptPersistence.create(publishDeptId);
	}
	...
	@Override
	public PublishDept deletePublishDept(long publishDeptId)
		throws PortalException, SystemException {
		return publishDeptPersistence.remove(publishDeptId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PublishDept deletePublishDept(PublishDept publishDept)
		throws SystemException {
		return publishDeptPersistence.remove(publishDept);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PublishDept.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return publishDeptPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return publishDeptPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return publishDeptPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public PublishDept fetchPublishDept(long publishDeptId)
		throws SystemException {
		return publishDeptPersistence.fetchByPrimaryKey(publishDeptId);
	}
	 ...
	 */
	@Override
	public PublishDept getPublishDept(long publishDeptId)
		throws PortalException, SystemException {
		return publishDeptPersistence.findByPrimaryKey(publishDeptId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return publishDeptPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PublishDept> getPublishDepts(int start, int end)
		throws SystemException {
		return publishDeptPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getPublishDeptsCount() throws SystemException {
		return publishDeptPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PublishDept updatePublishDept(PublishDept publishDept)
		throws SystemException {
		return publishDeptPersistence.update(publishDept);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.PublishDept",
			publishDeptLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.PublishDept");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = publishDeptPersistence.getDataSource();
	...
	private PublishDeptLocalServiceClpInvoker _clpInvoker = new PublishDeptLocalServiceClpInvoker();
}