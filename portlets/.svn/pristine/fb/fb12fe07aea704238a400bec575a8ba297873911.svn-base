 ...
 * @generated
 */
public abstract class StandardsRegionChainActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public StandardsRegionChainActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(StandardsRegionChainLocalServiceUtil.getService());
		setClass(StandardsRegionChain.class);
