...
import com.ihg.brandstandards.db.service.SpecialWordDictionaryLocalService;
...
/**
 * Provides the base implementation for the special word dictionary local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.SpecialWordDictionaryLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 * @see com.ihg.brandstandards.db.service.impl.SpecialWordDictionaryLocalServiceImpl
 * @see com.ihg.brandstandards.db.service.SpecialWordDictionaryLocalServiceUtil
 * @generated
 */
public abstract class SpecialWordDictionaryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SpecialWordDictionaryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.SpecialWordDictionaryLocalServiceUtil} to access the special word dictionary local service.
	 */
	...
	@Override
	public SpecialWordDictionary addSpecialWordDictionary(
		SpecialWordDictionary specialWordDictionary) throws SystemException {
		specialWordDictionary.setNew(true);

		return specialWordDictionaryPersistence.update(specialWordDictionary);
	}
	 ...
	 */
	@Override
	public SpecialWordDictionary createSpecialWordDictionary(long specialWordId) {
		return specialWordDictionaryPersistence.create(specialWordId);
	}
	...
	@Override
	public SpecialWordDictionary deleteSpecialWordDictionary(long specialWordId)
		throws PortalException, SystemException {
		return specialWordDictionaryPersistence.remove(specialWordId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SpecialWordDictionary deleteSpecialWordDictionary(
		SpecialWordDictionary specialWordDictionary) throws SystemException {
		return specialWordDictionaryPersistence.remove(specialWordDictionary);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SpecialWordDictionary.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return specialWordDictionaryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return specialWordDictionaryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public SpecialWordDictionary fetchSpecialWordDictionary(long specialWordId)
		throws SystemException {
		return specialWordDictionaryPersistence.fetchByPrimaryKey(specialWordId);
	}
	 ...
	 */
	@Override
	public SpecialWordDictionary getSpecialWordDictionary(long specialWordId)
		throws PortalException, SystemException {
		return specialWordDictionaryPersistence.findByPrimaryKey(specialWordId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return specialWordDictionaryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SpecialWordDictionary> getSpecialWordDictionaries(int start,
		int end) throws SystemException {
		return specialWordDictionaryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getSpecialWordDictionariesCount() throws SystemException {
		return specialWordDictionaryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SpecialWordDictionary updateSpecialWordDictionary(
		SpecialWordDictionary specialWordDictionary) throws SystemException {
		return specialWordDictionaryPersistence.update(specialWordDictionary);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.SpecialWordDictionary",
			specialWordDictionaryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.SpecialWordDictionary");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = specialWordDictionaryPersistence.getDataSource();
	...
	private SpecialWordDictionaryLocalServiceClpInvoker _clpInvoker = new SpecialWordDictionaryLocalServiceClpInvoker();
}