...
import com.ihg.brandstandards.db.service.StandardsCountryLocalService;
...
/**
 * Provides the base implementation for the standards country local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.StandardsCountryLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class StandardsCountryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements StandardsCountryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.StandardsCountryLocalServiceUtil} to access the standards country local service.
	 */
	...
	@Override
	public StandardsCountry addStandardsCountry(
		StandardsCountry standardsCountry) throws SystemException {
		standardsCountry.setNew(true);

		return standardsCountryPersistence.update(standardsCountry);
	}
	 ...
	 */
	@Override
	public StandardsCountry createStandardsCountry(String countryNameCode) {
		return standardsCountryPersistence.create(countryNameCode);
	}
	...
	@Override
	public StandardsCountry deleteStandardsCountry(String countryNameCode)
		throws PortalException, SystemException {
		return standardsCountryPersistence.remove(countryNameCode);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public StandardsCountry deleteStandardsCountry(
		StandardsCountry standardsCountry) throws SystemException {
		return standardsCountryPersistence.remove(standardsCountry);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(StandardsCountry.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return standardsCountryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return standardsCountryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public StandardsCountry fetchStandardsCountry(String countryNameCode)
		throws SystemException {
		return standardsCountryPersistence.fetchByPrimaryKey(countryNameCode);
	}
	 ...
	 */
	@Override
	public StandardsCountry getStandardsCountry(String countryNameCode)
		throws PortalException, SystemException {
		return standardsCountryPersistence.findByPrimaryKey(countryNameCode);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return standardsCountryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<StandardsCountry> getStandardsCountries(int start, int end)
		throws SystemException {
		return standardsCountryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getStandardsCountriesCount() throws SystemException {
		return standardsCountryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public StandardsCountry updateStandardsCountry(
		StandardsCountry standardsCountry) throws SystemException {
		return standardsCountryPersistence.update(standardsCountry);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.StandardsCountry",
			standardsCountryLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = standardsCountryPersistence.getDataSource();
	...
	private StandardsCountryLocalServiceClpInvoker _clpInvoker = new StandardsCountryLocalServiceClpInvoker();
}