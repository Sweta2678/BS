...
import com.ihg.brandstandards.db.service.WorkflowLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.WorkflowLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
...
public abstract class WorkflowLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.WorkflowLocalServiceUtil} to access the workflow local service.
	 */
	 ...
	 */
	@Override
	public Workflow createWorkflow(long workflowActvtId) {
		return workflowPersistence.create(workflowActvtId);
	}
	...
	@Override
	public Workflow deleteWorkflow(long workflowActvtId)
		throws PortalException, SystemException {
		return workflowPersistence.remove(workflowActvtId);
	}
	...
	@Override
	public Workflow fetchWorkflow(long workflowActvtId)
		throws SystemException {
		return workflowPersistence.fetchByPrimaryKey(workflowActvtId);
	}
	 ...
	 */
	@Override
	public Workflow getWorkflow(long workflowActvtId)
		throws PortalException, SystemException {
		return workflowPersistence.findByPrimaryKey(workflowActvtId);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.Workflow",
