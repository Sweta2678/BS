...
import com.ihg.brandstandards.db.service.TreeXMLLocalService;
...
/**
 * Provides the base implementation for the tree x m l local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.TreeXMLLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class TreeXMLLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements TreeXMLLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.TreeXMLLocalServiceUtil} to access the tree x m l local service.
	 */
	...
	@Override
	public TreeXML addTreeXML(TreeXML treeXML) throws SystemException {
		treeXML.setNew(true);

		return treeXMLPersistence.update(treeXML);
	}
	 ...
	 */
	@Override
	public TreeXML createTreeXML(long ID) {
		return treeXMLPersistence.create(ID);
	}
	...
	@Override
	public TreeXML deleteTreeXML(long ID)
		throws PortalException, SystemException {
		return treeXMLPersistence.remove(ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TreeXML deleteTreeXML(TreeXML treeXML) throws SystemException {
		return treeXMLPersistence.remove(treeXML);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TreeXML.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return treeXMLPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return treeXMLPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return treeXMLPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return treeXMLPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return treeXMLPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public TreeXML fetchTreeXML(long ID) throws SystemException {
		return treeXMLPersistence.fetchByPrimaryKey(ID);
	}
	 ...
	 */
	@Override
	public TreeXML getTreeXML(long ID) throws PortalException, SystemException {
		return treeXMLPersistence.findByPrimaryKey(ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return treeXMLPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TreeXML> getTreeXMLs(int start, int end)
		throws SystemException {
		return treeXMLPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTreeXMLsCount() throws SystemException {
		return treeXMLPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TreeXML updateTreeXML(TreeXML treeXML) throws SystemException {
		return treeXMLPersistence.update(treeXML);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.TreeXML",
			treeXMLLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.TreeXML");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = treeXMLPersistence.getDataSource();
	...
	private TreeXMLLocalServiceClpInvoker _clpInvoker = new TreeXMLLocalServiceClpInvoker();
}