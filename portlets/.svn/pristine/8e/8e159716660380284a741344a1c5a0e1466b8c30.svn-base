...
import com.ihg.brandstandards.db.service.UIElementTranslateLocalService;
...
/**
 * Provides the base implementation for the u i element translate local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.UIElementTranslateLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class UIElementTranslateLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements UIElementTranslateLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.UIElementTranslateLocalServiceUtil} to access the u i element translate local service.
	 */
	...
	@Override
	public UIElementTranslate addUIElementTranslate(
		UIElementTranslate uiElementTranslate) throws SystemException {
		uiElementTranslate.setNew(true);

		return uiElementTranslatePersistence.update(uiElementTranslate);
	}
	 ...
	 */
	@Override
	public UIElementTranslate createUIElementTranslate(
		UIElementTranslatePK uiElementTranslatePK) {
		return uiElementTranslatePersistence.create(uiElementTranslatePK);
	}
	...
	@Override
	public UIElementTranslate deleteUIElementTranslate(
		UIElementTranslatePK uiElementTranslatePK)
		throws PortalException, SystemException {
		return uiElementTranslatePersistence.remove(uiElementTranslatePK);
	}
	...
	public UIElementTranslate deleteUIElementTranslate(
		UIElementTranslate uiElementTranslate) throws SystemException {
		return uiElementTranslatePersistence.remove(uiElementTranslate);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(UIElementTranslate.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return uiElementTranslatePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return uiElementTranslatePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public UIElementTranslate fetchUIElementTranslate(
		UIElementTranslatePK uiElementTranslatePK) throws SystemException {
		return uiElementTranslatePersistence.fetchByPrimaryKey(uiElementTranslatePK);
	}
	 ...
	 */
	@Override
	public UIElementTranslate getUIElementTranslate(
		UIElementTranslatePK uiElementTranslatePK)
		throws PortalException, SystemException {
		return uiElementTranslatePersistence.findByPrimaryKey(uiElementTranslatePK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return uiElementTranslatePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<UIElementTranslate> getUIElementTranslates(int start, int end)
		throws SystemException {
		return uiElementTranslatePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getUIElementTranslatesCount() throws SystemException {
		return uiElementTranslatePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public UIElementTranslate updateUIElementTranslate(
		UIElementTranslate uiElementTranslate) throws SystemException {
		return uiElementTranslatePersistence.update(uiElementTranslate);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.UIElementTranslate",
			uiElementTranslateLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = uiElementTranslatePersistence.getDataSource();
	...
	private UIElementTranslateLocalServiceClpInvoker _clpInvoker = new UIElementTranslateLocalServiceClpInvoker();
}