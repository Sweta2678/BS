...
import com.ihg.brandstandards.db.service.GEMStdCategoryLocalService;
...
/**
 * Provides the base implementation for the g e m std category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.GEMStdCategoryLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class GEMStdCategoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements GEMStdCategoryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.GEMStdCategoryLocalServiceUtil} to access the g e m std category local service.
	 */
	...
	@Override
	public GEMStdCategory addGEMStdCategory(GEMStdCategory gemStdCategory)
		throws SystemException {
		gemStdCategory.setNew(true);

		return gemStdCategoryPersistence.update(gemStdCategory);
	}
	 ...
	 */
	@Override
	public GEMStdCategory createGEMStdCategory(long gemStdCategoryId) {
		return gemStdCategoryPersistence.create(gemStdCategoryId);
	}
	...
	@Override
	public GEMStdCategory deleteGEMStdCategory(long gemStdCategoryId)
		throws PortalException, SystemException {
		return gemStdCategoryPersistence.remove(gemStdCategoryId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public GEMStdCategory deleteGEMStdCategory(GEMStdCategory gemStdCategory)
		throws SystemException {
		return gemStdCategoryPersistence.remove(gemStdCategory);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(GEMStdCategory.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return gemStdCategoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return gemStdCategoryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public GEMStdCategory fetchGEMStdCategory(long gemStdCategoryId)
		throws SystemException {
		return gemStdCategoryPersistence.fetchByPrimaryKey(gemStdCategoryId);
	}
	 ...
	 */
	@Override
	public GEMStdCategory getGEMStdCategory(long gemStdCategoryId)
		throws PortalException, SystemException {
		return gemStdCategoryPersistence.findByPrimaryKey(gemStdCategoryId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return gemStdCategoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<GEMStdCategory> getGEMStdCategories(int start, int end)
		throws SystemException {
		return gemStdCategoryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getGEMStdCategoriesCount() throws SystemException {
		return gemStdCategoryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public GEMStdCategory updateGEMStdCategory(GEMStdCategory gemStdCategory)
		throws SystemException {
		return gemStdCategoryPersistence.update(gemStdCategory);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.GEMStdCategory",
			gemStdCategoryLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = gemStdCategoryPersistence.getDataSource();
	...
	private GEMStdCategoryLocalServiceClpInvoker _clpInvoker = new GEMStdCategoryLocalServiceClpInvoker();
}