...
public class GEMTemplateLocalServiceClpInvoker {
	public GEMTemplateLocalServiceClpInvoker() {
		...
		_methodName587 = "getByTypeAndRegionAndPublication";

		_methodParameterTypes587 = new String[] {
				"java.lang.String", "long", "long"
			};

		_methodName588 = "getByTypeAndRegionAndPublicationList";

		_methodParameterTypes588 = new String[] {
				"java.lang.String", "long", "long"
			};

		_methodName589 = "getByPublishId";

		_methodParameterTypes589 = new String[] { "long" };

		_methodName590 = "getByPublishIdAndRgnId";

		_methodParameterTypes590 = new String[] { "long", "long" };

		_methodName591 = "getByPublishIdAndRgnIdAndType";

		_methodParameterTypes591 = new String[] {
				"long", "long", "java.lang.String"
			};

		_methodName592 = "getByPublishIdAndTemplateType";

		_methodParameterTypes592 = new String[] { "long", "java.lang.String" };

		_methodName593 = "getByTemplateType";

		_methodParameterTypes593 = new String[] { "java.lang.String" };

		_methodName594 = "deleteTemplateConfigurations";

		_methodParameterTypes594 = new String[] { "long" };

		_methodName595 = "getSequenceNumber";

		_methodParameterTypes595 = new String[] { "java.lang.String" };

		_methodName596 = "insertTemplateValueUsingSequence";
