...
import com.ihg.brandstandards.db.service.GlossaryLocalService;
...
/**
 * Provides the base implementation for the glossary local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.GlossaryLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 * @see com.ihg.brandstandards.db.service.impl.GlossaryLocalServiceImpl
 * @see com.ihg.brandstandards.db.service.GlossaryLocalServiceUtil
 * @generated
 */
public abstract class GlossaryLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements GlossaryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.GlossaryLocalServiceUtil} to access the glossary local service.
	 */
	...
	@Override
	public Glossary addGlossary(Glossary glossary) throws SystemException {
		glossary.setNew(true);

		return glossaryPersistence.update(glossary);
	}
	 ...
	 */
	@Override
	public Glossary createGlossary(long glossaryId) {
		return glossaryPersistence.create(glossaryId);
	}
	...
	@Override
	public Glossary deleteGlossary(long glossaryId)
		throws PortalException, SystemException {
		return glossaryPersistence.remove(glossaryId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Glossary deleteGlossary(Glossary glossary) throws SystemException {
		return glossaryPersistence.remove(glossary);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Glossary.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return glossaryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return glossaryPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return glossaryPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return glossaryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public Glossary fetchGlossary(long glossaryId) throws SystemException {
		return glossaryPersistence.fetchByPrimaryKey(glossaryId);
	}
	...
	public Glossary getGlossary(long glossaryId)
		throws PortalException, SystemException {
		return glossaryPersistence.findByPrimaryKey(glossaryId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return glossaryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Glossary> getGlossaries(int start, int end)
		throws SystemException {
		return glossaryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getGlossariesCount() throws SystemException {
		return glossaryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Glossary updateGlossary(Glossary glossary) throws SystemException {
		return glossaryPersistence.update(glossary);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.Glossary",
			glossaryLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = glossaryPersistence.getDataSource();
	...
	private GlossaryLocalServiceClpInvoker _clpInvoker = new GlossaryLocalServiceClpInvoker();
}