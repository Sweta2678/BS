...
public class ManageGemPortlet extends BrandStandardsGemPortlet
{
	...
	public void doView(RenderRequest renderRequest, RenderResponse renderResponse) throws IOException, PortletException {
        ...
        Publication publish = getBridgePublishForGem(preferences.getDepartmentId(), brandCode);//getActiveBridgePublication(brandCode, httpRequest);
	...
	public void serveResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse) throws IOException, PortletException {
        ...
        Publication publish = getActiveGEMPublication(preferences.getDepartmentId(), brandCode);//getActiveBridgePublication(brandCode, httpRequest);
		if(publish != null) 
		{
	    	...
	    	else if ("generateGEMReport".equals(requestType))
	        {
		      ...
		      //Get manual types from configuration
	            ...
	            addMetadataFields(publish, GemConstants.GEM_ENVIRONMENT, themeDisplay.getUser().getFirstName(), templateId, reportType, reportTitle, 
	            		regionCode, subBrands, metadataParams, compareMetadataParams, manualTypes);
	...
	private void uploadTemplateRequest (UploadPortletRequest uploadRequest, ResourceRequest resourceRequest, ResourceResponse resourceResponse) 
		...
		try {
			if (preferences != null && Validator.isNotNull(preferences.getBrand())) {
				...
				Publication publication = getActiveGEMPublication(preferences.getDepartmentId(), preferences.getBrand());//getActiveBridgePublication(preferences.getBrand(), httpRequest);
    ...
    public void addMetadataFields(Publication publish, String environment, String userName, String templateId, String reportType, String reportTitle, 
    		String regionCode, String subBrandCode, Map<String, String> metadataParams, Map<String, String> compareMetadataParams, Map<String, String> manualTypes)
    {
    	long regionId = StandardsRegionLocalServiceUtil.getRegionIdByCode(regionCode);
        ...
        metadataParams.put(BridgeConstants.METADATA_PARAM_LOCALE_LIST, "");
        ...
        compareMetadataParams.put(BridgeConstants.METADATA_PARAM_LOCALE_LIST, "");
