 ...
 * @generated
 */
public class MustPublishLocalServiceClp implements MustPublishLocalService {
	public MustPublishLocalServiceClp(
		...
		_methodName20 = "deleteRegionalRecordCountries";
	...
	public com.ihg.brandstandards.db.model.MustPublish addMustPublish(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(mustPublish) });
		}
		catch (Throwable t) {
		...
		return (com.ihg.brandstandards.db.model.MustPublish)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<com.ihg.brandstandards.db.model.MustPublish> getMustPublishs(
		...
		return (java.util.List<com.ihg.brandstandards.db.model.MustPublish>)ClpSerializer.translateOutput(returnObj);
	}
