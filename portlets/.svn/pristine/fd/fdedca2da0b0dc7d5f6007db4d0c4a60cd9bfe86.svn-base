...
public class BridgePublishCountryLocalServiceClpInvoker {
	public BridgePublishCountryLocalServiceClpInvoker() {
		...
		_methodName615 = "getCountriesByPublishId";

		_methodParameterTypes615 = new String[] { "long" };

		_methodName616 = "getCountriesByPublishIdAndCountryCode";

		_methodParameterTypes616 = new String[] { "long", "java.lang.String" };

		_methodName617 = "saveBridgePublishCountry";

		_methodParameterTypes617 = new String[] { "long", "java.util.List" };

		_methodName618 = "deleteBridgePublishCountries";
