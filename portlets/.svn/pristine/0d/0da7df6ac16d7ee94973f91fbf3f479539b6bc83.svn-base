...
import com.ihg.brandstandards.db.service.GEMCodeLocalService;
...
/**
 * Provides the base implementation for the g e m code local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.GEMCodeLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 * @see com.ihg.brandstandards.db.service.impl.GEMCodeLocalServiceImpl
 * @see com.ihg.brandstandards.db.service.GEMCodeLocalServiceUtil
 * @generated
 */
public abstract class GEMCodeLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements GEMCodeLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.GEMCodeLocalServiceUtil} to access the g e m code local service.
	 */
	...
	@Override
	public GEMCode addGEMCode(GEMCode gemCode) throws SystemException {
		gemCode.setNew(true);

		return gemCodePersistence.update(gemCode);
	}
	 ...
	 */
	@Override
	public GEMCode createGEMCode(String code) {
		return gemCodePersistence.create(code);
	}
	...
	@Override
	public GEMCode deleteGEMCode(String code)
		throws PortalException, SystemException {
		return gemCodePersistence.remove(code);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public GEMCode deleteGEMCode(GEMCode gemCode) throws SystemException {
		return gemCodePersistence.remove(gemCode);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(GEMCode.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return gemCodePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return gemCodePersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return gemCodePersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return gemCodePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return gemCodePersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public GEMCode fetchGEMCode(String code) throws SystemException {
		return gemCodePersistence.fetchByPrimaryKey(code);
	}
	 ...
	 */
	@Override
	public GEMCode getGEMCode(String code)
		throws PortalException, SystemException {
		return gemCodePersistence.findByPrimaryKey(code);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return gemCodePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<GEMCode> getGEMCodes(int start, int end)
		throws SystemException {
		return gemCodePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getGEMCodesCount() throws SystemException {
		return gemCodePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public GEMCode updateGEMCode(GEMCode gemCode) throws SystemException {
		return gemCodePersistence.update(gemCode);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.GEMCode",
			gemCodeLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = gemCodePersistence.getDataSource();
	...
	private GEMCodeLocalServiceClpInvoker _clpInvoker = new GEMCodeLocalServiceClpInvoker();
}