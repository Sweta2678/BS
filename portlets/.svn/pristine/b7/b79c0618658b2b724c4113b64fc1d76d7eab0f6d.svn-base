...
import com.ihg.brandstandards.db.service.TaxonomyTranslateLocalService;
...
/**
 * Provides the base implementation for the taxonomy translate local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.TaxonomyTranslateLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 * @see com.ihg.brandstandards.db.service.impl.TaxonomyTranslateLocalServiceImpl
 * @see com.ihg.brandstandards.db.service.TaxonomyTranslateLocalServiceUtil
 * @generated
 */
public abstract class TaxonomyTranslateLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TaxonomyTranslateLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.TaxonomyTranslateLocalServiceUtil} to access the taxonomy translate local service.
	 */
	...
	@Override
	public TaxonomyTranslate addTaxonomyTranslate(
		TaxonomyTranslate taxonomyTranslate) throws SystemException {
		taxonomyTranslate.setNew(true);

		return taxonomyTranslatePersistence.update(taxonomyTranslate);
	}
	 ...
	 */
	@Override
	public TaxonomyTranslate createTaxonomyTranslate(
		TaxonomyTranslatePK taxonomyTranslatePK) {
		return taxonomyTranslatePersistence.create(taxonomyTranslatePK);
	}
	...
	@Override
	public TaxonomyTranslate deleteTaxonomyTranslate(
		TaxonomyTranslatePK taxonomyTranslatePK)
		throws PortalException, SystemException {
		return taxonomyTranslatePersistence.remove(taxonomyTranslatePK);
	}
	...
	public TaxonomyTranslate deleteTaxonomyTranslate(
		TaxonomyTranslate taxonomyTranslate) throws SystemException {
		return taxonomyTranslatePersistence.remove(taxonomyTranslate);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TaxonomyTranslate.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return taxonomyTranslatePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return taxonomyTranslatePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TaxonomyTranslate fetchTaxonomyTranslate(
		TaxonomyTranslatePK taxonomyTranslatePK) throws SystemException {
		return taxonomyTranslatePersistence.fetchByPrimaryKey(taxonomyTranslatePK);
	}
	 ...
	 */
	@Override
	public TaxonomyTranslate getTaxonomyTranslate(
		TaxonomyTranslatePK taxonomyTranslatePK)
		throws PortalException, SystemException {
		return taxonomyTranslatePersistence.findByPrimaryKey(taxonomyTranslatePK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return taxonomyTranslatePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TaxonomyTranslate> getTaxonomyTranslates(int start, int end)
		throws SystemException {
		return taxonomyTranslatePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTaxonomyTranslatesCount() throws SystemException {
		return taxonomyTranslatePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TaxonomyTranslate updateTaxonomyTranslate(
		TaxonomyTranslate taxonomyTranslate) throws SystemException {
		return taxonomyTranslatePersistence.update(taxonomyTranslate);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.TaxonomyTranslate",
			taxonomyTranslateLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = taxonomyTranslatePersistence.getDataSource();
	...
	private TaxonomyTranslateLocalServiceClpInvoker _clpInvoker = new TaxonomyTranslateLocalServiceClpInvoker();
}