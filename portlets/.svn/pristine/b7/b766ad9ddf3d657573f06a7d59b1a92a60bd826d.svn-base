                                ...
                                <%} %>
                         		...
                         		<td class="le">
                            		...
                            		%>
                            			...
                            			role="button" class="btn btn-small btn-primary btn-block" data-toggle="modal">Push to Staging</button>
							...
							<tr>
								<td><%=stagePublication.getPublishId() %></td>
                         		...
                         		%>
                         			<td class="le">
	                            		<c:choose>
	                            			<c:when test="${publishToProd eq true}">
                    ...
                    <tbody>
                        ...
                        %>                  
							<tr>
								...
								%>
											<button href="#" role="button" class="btn btn-small btn-danger btn-block" data-toggle="modal" 
											onclick="javascript:openManualsDialog(<%=prodPublication.getPublishId() %>,'PRODUCTION')">Regenerate Manuals</button>
                                        <!-- Production Reports -->
