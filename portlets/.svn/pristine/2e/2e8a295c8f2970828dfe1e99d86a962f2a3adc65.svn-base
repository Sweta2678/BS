...
import com.ihg.brandstandards.db.service.PublishCountryStandardLocalService;
...
/**
 * Provides the base implementation for the publish country standard local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.PublishCountryStandardLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class PublishCountryStandardLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PublishCountryStandardLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.PublishCountryStandardLocalServiceUtil} to access the publish country standard local service.
	 */
	...
	@Override
	public PublishCountryStandard addPublishCountryStandard(
		PublishCountryStandard publishCountryStandard)
		throws SystemException {
		publishCountryStandard.setNew(true);

		return publishCountryStandardPersistence.update(publishCountryStandard);
	}
	 ...
	 */
	@Override
	public PublishCountryStandard createPublishCountryStandard(
		String publishCountryStdId) {
		return publishCountryStandardPersistence.create(publishCountryStdId);
	}
	...
	@Override
	public PublishCountryStandard deletePublishCountryStandard(
		String publishCountryStdId) throws PortalException, SystemException {
		return publishCountryStandardPersistence.remove(publishCountryStdId);
	}
	...
	public PublishCountryStandard deletePublishCountryStandard(
		PublishCountryStandard publishCountryStandard)
		throws SystemException {
		return publishCountryStandardPersistence.remove(publishCountryStandard);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PublishCountryStandard.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return publishCountryStandardPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return publishCountryStandardPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public PublishCountryStandard fetchPublishCountryStandard(
		String publishCountryStdId) throws SystemException {
		return publishCountryStandardPersistence.fetchByPrimaryKey(publishCountryStdId);
	}
	 ...
	 */
	@Override
	public PublishCountryStandard getPublishCountryStandard(
		String publishCountryStdId) throws PortalException, SystemException {
		return publishCountryStandardPersistence.findByPrimaryKey(publishCountryStdId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return publishCountryStandardPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PublishCountryStandard> getPublishCountryStandards(int start,
		int end) throws SystemException {
		return publishCountryStandardPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getPublishCountryStandardsCount() throws SystemException {
		return publishCountryStandardPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PublishCountryStandard updatePublishCountryStandard(
		PublishCountryStandard publishCountryStandard)
		throws SystemException {
		return publishCountryStandardPersistence.update(publishCountryStandard);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.PublishCountryStandard",
			publishCountryStandardLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.PublishCountryStandard");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = publishCountryStandardPersistence.getDataSource();
	...
	private PublishCountryStandardLocalServiceClpInvoker _clpInvoker = new PublishCountryStandardLocalServiceClpInvoker();
}