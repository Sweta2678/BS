...
import com.ihg.brandstandards.db.service.PublishTaxonomyLocalService;
...
/**
 * Provides the base implementation for the publish taxonomy local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.PublishTaxonomyLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 * @see com.ihg.brandstandards.db.service.impl.PublishTaxonomyLocalServiceImpl
 * @see com.ihg.brandstandards.db.service.PublishTaxonomyLocalServiceUtil
 * @generated
 */
public abstract class PublishTaxonomyLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PublishTaxonomyLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.PublishTaxonomyLocalServiceUtil} to access the publish taxonomy local service.
	 */
	...
	@Override
	public PublishTaxonomy addPublishTaxonomy(PublishTaxonomy publishTaxonomy)
		throws SystemException {
		publishTaxonomy.setNew(true);

		return publishTaxonomyPersistence.update(publishTaxonomy);
	}
	 ...
	 */
	@Override
	public PublishTaxonomy createPublishTaxonomy(long publishTaxId) {
		return publishTaxonomyPersistence.create(publishTaxId);
	}
	...
	@Override
	public PublishTaxonomy deletePublishTaxonomy(long publishTaxId)
		throws PortalException, SystemException {
		return publishTaxonomyPersistence.remove(publishTaxId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PublishTaxonomy deletePublishTaxonomy(
		PublishTaxonomy publishTaxonomy) throws SystemException {
		return publishTaxonomyPersistence.remove(publishTaxonomy);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PublishTaxonomy.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return publishTaxonomyPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return publishTaxonomyPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public PublishTaxonomy fetchPublishTaxonomy(long publishTaxId)
		throws SystemException {
		return publishTaxonomyPersistence.fetchByPrimaryKey(publishTaxId);
	}
	 ...
	 */
	@Override
	public PublishTaxonomy getPublishTaxonomy(long publishTaxId)
		throws PortalException, SystemException {
		return publishTaxonomyPersistence.findByPrimaryKey(publishTaxId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return publishTaxonomyPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PublishTaxonomy> getPublishTaxonomies(int start, int end)
		throws SystemException {
		return publishTaxonomyPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getPublishTaxonomiesCount() throws SystemException {
		return publishTaxonomyPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PublishTaxonomy updatePublishTaxonomy(
		PublishTaxonomy publishTaxonomy) throws SystemException {
		return publishTaxonomyPersistence.update(publishTaxonomy);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.PublishTaxonomy",
			publishTaxonomyLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.PublishTaxonomy");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = publishTaxonomyPersistence.getDataSource();
	...
	private PublishTaxonomyLocalServiceClpInvoker _clpInvoker = new PublishTaxonomyLocalServiceClpInvoker();
}