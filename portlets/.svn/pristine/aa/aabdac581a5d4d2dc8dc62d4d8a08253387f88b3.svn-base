...
<script type="text/javascript" src="/BSTheme-theme/js/jquery.highlight.js"></script>
...
if(stdSearchCriteria !=null  && !stdSearchCriteria.isEmpty()){
	for(String str :stdSearchCriteria.getSearchCriteria()){
	 keyword = keyword+" "+str;  
	}
}
...
String strSearchOptions = stdSearchCriteria == null ? "exact" : stdSearchCriteria.getTextSearchType(); 
...
jQuery(document).ready(function () {
	...
	if($('.results_right_util .filter_results_button').hasClass('button_red')){
		$('.view_details').each(function(obj) {
			var temp = $(this);
		   setTimeout(function () { temp.trigger("click");}, 100);
		  });
	}
	 ...
	 var keyword = '<%=keyword%>';
		...
		$('.highlight').addClass("keyHi");
		$('.keyHi').css("background", "#ffff00ab");
           ...
           <div id="searchCounter"> <p class="totals_display"><strong><%=standardsCount %></strong> Standards match this criteria</p></div>
			<div class="filter_results_form">
				...
				<table class="filter_table" summary="Data table for filtered results">
					...
					<tr>
						<td>Click to Add Countries/Region:</td>
						<td colspan="3" style="text-align:left;">
							<div class="countries_cont_left_filter">
								<a href="#" class="move_countries_filter" id="add_all_countries" title="Move All countries/region">Click here to add all countries/region</a>
							...
							<div class="countries_cont_right_filter">
								<a href="#" class="remove_countries_filter" id="remove_all_countries" title="remove countries/region">Click here to remove all countries/region</a>
					...
					<tr>
						...
						<td colspan="2">
							<input type="radio" name="searchOptions" id="searchOptions" value="exact" class="standard_radio"  <%=strSearchOptions.equals("exact")? "checked='checked'":"" %> > Match Exact Phrase 
							...
							<input type="radio" name="searchOptions" id="searchOptions" value="any" class="standard_radio" <%=strSearchOptions.equals("any")? "checked='checked'":"" %> > Match Any Words 
							...
							<input type="radio" name="searchOptions" id="searchOptions" value="all" class="standard_radio" <%=strSearchOptions.equals("all")? "checked='checked'":"" %>> Search All Words 
						...
						<%-- <%if(strSearchOptions.equals("all")){ %>
							...
							<span><a class="help_icon tooltip" href="javascript:return false;"><img src="/BSTheme-theme/images/help.png" alt="Match Exact Phrase help icon"/>
                            <span class="classic">Returns all content with words/phrases that exactly match the search criteria. E.g. Search for &#34;ice&#34; returns content with the word &#34;ice&#34; only. Search for &#34;ice machines&#34; returns content with the words &#34;ice machines&#34; only.</span></a></span>
							&nbsp;&nbsp;&nbsp;

							<input type="radio" name="searchOptions" id="searchOptions" value="any" class="standard_radio"> Match Any of the Words 
							<span><a class="help_icon tooltip" href="javascript:return false;"><img src="/BSTheme-theme/images/help.png" alt="Match Any of the Words help icon"/>
                            <span class="classic">Returns all content containing the exact search criteria on multiple words/phrases. E.g. Search for &#34;ice bucket&#34; returns content with the phrase &#34;ice bucket&#34; and content with the words &#34;ice&#34; and &#34;bucket&#34; separately.</span></a></span>
							&nbsp;&nbsp;&nbsp;
							
							<input type="radio" name="searchOptions" id="searchOptions" value="all" class="standard_radio" checked="checked"> Search All Words 
							<span><a class="help_icon tooltip" href="javascript:return false;"><img src="/BSTheme-theme/images/help.png" alt="Search All Words help icon"/>
                            <span class="classic">A single word search returns all content containing the search criteria. E.g. Search for &#34;ice&#34; returns content with the word &#34;ice&#34; and will also return content with &#34;ice&#34; within words like &#34;service&#34;, &#34;device&#34;, or &#34;office&#34;, etc.
								<br/>A multiple word search returns all content matching all search words anywhere in the text.  Note word match can be partial (example ice will match to device)   
								E.g. &#34;ice machine&#34; returns devices and machines.  </span></a></span>
							&nbsp;&nbsp;&nbsp;
            ...
            <table class="results_table" summary="Data table for all results">
					...
					<%String selectName = "status_"+standard.getStdId(); %>
						<tr>
						   <c:choose>
						    <c:when test="<%=standard.isSearchMatches()%>">
						    	<td class="parent_id" style="border-left:2px solid orange"><%=standard.getStdId() %></td>
							</c:when>
							<c:otherwise>
