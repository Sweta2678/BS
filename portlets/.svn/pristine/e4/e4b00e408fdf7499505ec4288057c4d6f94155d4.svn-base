...
import com.ihg.brandstandards.db.service.StandardsAuthorsLocalService;
...
/**
 * Provides the base implementation for the standards authors local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.StandardsAuthorsLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class StandardsAuthorsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements StandardsAuthorsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.StandardsAuthorsLocalServiceUtil} to access the standards authors local service.
	 */
	...
	@Override
	public StandardsAuthors addStandardsAuthors(
		StandardsAuthors standardsAuthors) throws SystemException {
		standardsAuthors.setNew(true);

		return standardsAuthorsPersistence.update(standardsAuthors);
	}
	 ...
	 */
	@Override
	public StandardsAuthors createStandardsAuthors(long stdAuthorId) {
		return standardsAuthorsPersistence.create(stdAuthorId);
	}
	...
	@Override
	public StandardsAuthors deleteStandardsAuthors(long stdAuthorId)
		throws PortalException, SystemException {
		return standardsAuthorsPersistence.remove(stdAuthorId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public StandardsAuthors deleteStandardsAuthors(
		StandardsAuthors standardsAuthors) throws SystemException {
		return standardsAuthorsPersistence.remove(standardsAuthors);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(StandardsAuthors.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return standardsAuthorsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return standardsAuthorsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public StandardsAuthors fetchStandardsAuthors(long stdAuthorId)
		throws SystemException {
		return standardsAuthorsPersistence.fetchByPrimaryKey(stdAuthorId);
	}
	 ...
	 */
	@Override
	public StandardsAuthors getStandardsAuthors(long stdAuthorId)
		throws PortalException, SystemException {
		return standardsAuthorsPersistence.findByPrimaryKey(stdAuthorId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return standardsAuthorsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<StandardsAuthors> getStandardsAuthorses(int start, int end)
		throws SystemException {
		return standardsAuthorsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getStandardsAuthorsesCount() throws SystemException {
		return standardsAuthorsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public StandardsAuthors updateStandardsAuthors(
		StandardsAuthors standardsAuthors) throws SystemException {
		return standardsAuthorsPersistence.update(standardsAuthors);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.StandardsAuthors",
			standardsAuthorsLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = standardsAuthorsPersistence.getDataSource();
	...
	private StandardsAuthorsLocalServiceClpInvoker _clpInvoker = new StandardsAuthorsLocalServiceClpInvoker();
}