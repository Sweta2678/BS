...
/**
 * Provides the local service interface for BridgeGlobalPublishCountry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mummanedi
 * @see BridgeGlobalPublishCountryLocalServiceUtil
...
public interface BridgeGlobalPublishCountryLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BridgeGlobalPublishCountryLocalServiceUtil} to access the bridge global publish country local service. Add custom service methods to {@link com.ihg.brandstandards.db.service.impl.BridgeGlobalPublishCountryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
