...
public class ArchivePublishPortlet extends MVCPortlet {
	...
	public void serveResource(ResourceRequest resourceRequest,
		...
		if(Validator.isNotNull(resourceId) && resourceId.equals("getPublicationDateByBrand")){
			...
			for(Object ob:publicationDates){
				JSONObject objso=JSONFactoryUtil.createJSONObject();
				objso.put(formatter.format(ob),formatter.format(ob));
				jsonArray.put(objso);
			}
	...
	public static String insertIntoJobQeue(String enviornment,String publishdate,long userId){
        ...
        try {
        	...
        	if(Validator.isNotNull(userId)){
        		...
        		toEmail = "GTBrandStandards@ihg.com";
    			screenName = "SYSTEM";
        	}
			
			 addMetadataFields(enviornment, publishdate,userId, screenName, toEmail,metadataParams);
		     addCompareMetadataFields(enviornment, publishdate,userId, screenName, toEmail,compareMetadataParams);
		     String metaData = BSCommonUtil.buildJobQueueMetadataXML(JOB_TYPE_PUBLICATION_PURGE, metadataParams, null, null);
		        ...
		        {
		        	returnMsg = "This publication being purged. Please check later.";
		        } 
		        else
		        {	
					try 
					{
		    			JobQueueLocalServiceUtil.insertJobQueueUsingOraSequence(screenName,JOB_TYPE_PUBLICATION_PURGE, metaData, 
		    					null, toEmail, screenName);
		    			returnMsg= "Purge publication process started in backend. you will be notified of the status by Email.";
					} 
					catch(Exception e)
					{
						returnMsg = "Failure";
			...
			LOG.info("Mailing function Here to ....."+toEmail);
	...
	public void executePurgeJob(final String pubEnv,final String pubdate,final long userId){
	  ...
	  public static void addMetadataFields(String env, String pubDate, long userId, String userScreenName, String userEmailAdd,Map<String, String> metadataParams) {
	  ...
	  public static void addCompareMetadataFields(String env, String pubDate, long userId, String userScreenName, String userEmailAdd, Map<String, String> compareMetadataParams) {
