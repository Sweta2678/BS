...
import com.ihg.brandstandards.db.service.GEMMeasurementLocalService;
...
/**
 * Provides the base implementation for the g e m measurement local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.GEMMeasurementLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 * @see com.ihg.brandstandards.db.service.impl.GEMMeasurementLocalServiceImpl
 * @see com.ihg.brandstandards.db.service.GEMMeasurementLocalServiceUtil
 * @generated
 */
public abstract class GEMMeasurementLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements GEMMeasurementLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.GEMMeasurementLocalServiceUtil} to access the g e m measurement local service.
	 */

	/**
	 * Adds the g e m measurement to the database. Also notifies the appropriate model listeners.
	 *
	 * @param gemMeasurement the g e m measurement
	 * @return the g e m measurement that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public GEMMeasurement addGEMMeasurement(GEMMeasurement gemMeasurement)
		throws SystemException {
		gemMeasurement.setNew(true);

		return gemMeasurementPersistence.update(gemMeasurement);
	}
	 ...
	 */
	@Override
	public GEMMeasurement createGEMMeasurement(long measurementId) {
		return gemMeasurementPersistence.create(measurementId);
	}

	/**
	 * Deletes the g e m measurement with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param measurementId the primary key of the g e m measurement
	 * @return the g e m measurement that was removed
	 * @throws PortalException if a g e m measurement with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public GEMMeasurement deleteGEMMeasurement(long measurementId)
		throws PortalException, SystemException {
		return gemMeasurementPersistence.remove(measurementId);
	}

	/**
	 * Deletes the g e m measurement from the database. Also notifies the appropriate model listeners.
	 *
	 * @param gemMeasurement the g e m measurement
	 * @return the g e m measurement that was removed
	 * @throws SystemException if a system exception occurred
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public GEMMeasurement deleteGEMMeasurement(GEMMeasurement gemMeasurement)
		throws SystemException {
		return gemMeasurementPersistence.remove(gemMeasurement);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(GEMMeasurement.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return gemMeasurementPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return gemMeasurementPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public GEMMeasurement fetchGEMMeasurement(long measurementId)
		throws SystemException {
		return gemMeasurementPersistence.fetchByPrimaryKey(measurementId);
	}

	/**
	 * Returns the g e m measurement with the primary key.
	 *
	 * @param measurementId the primary key of the g e m measurement
	 ...
	 */
	@Override
	public GEMMeasurement getGEMMeasurement(long measurementId)
		throws PortalException, SystemException {
		return gemMeasurementPersistence.findByPrimaryKey(measurementId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return gemMeasurementPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<GEMMeasurement> getGEMMeasurements(int start, int end)
		throws SystemException {
		return gemMeasurementPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getGEMMeasurementsCount() throws SystemException {
		return gemMeasurementPersistence.countAll();
	}

	/**
	 * Updates the g e m measurement in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param gemMeasurement the g e m measurement
	 * @return the g e m measurement that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public GEMMeasurement updateGEMMeasurement(GEMMeasurement gemMeasurement)
		throws SystemException {
		return gemMeasurementPersistence.update(gemMeasurement);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.GEMMeasurement",
			gemMeasurementLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.GEMMeasurement");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = gemMeasurementPersistence.getDataSource();
	...
	private GEMMeasurementLocalServiceClpInvoker _clpInvoker = new GEMMeasurementLocalServiceClpInvoker();
}