 ...
 * @generated
 */
public abstract class TreeXMLActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public TreeXMLActionableDynamicQuery() throws SystemException {
		setBaseLocalService(TreeXMLLocalServiceUtil.getService());
		setClass(TreeXML.class);
