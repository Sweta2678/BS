...
import com.ihg.brandstandards.db.service.ChainAttachmentsStandardsLocalService;
...
/**
 * Provides the base implementation for the chain attachments standards local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.ChainAttachmentsStandardsLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 * @see com.ihg.brandstandards.db.service.impl.ChainAttachmentsStandardsLocalServiceImpl
 * @see com.ihg.brandstandards.db.service.ChainAttachmentsStandardsLocalServiceUtil
 * @generated
 */
public abstract class ChainAttachmentsStandardsLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements ChainAttachmentsStandardsLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.ChainAttachmentsStandardsLocalServiceUtil} to access the chain attachments standards local service.
	 */
	...
	@Override
	public ChainAttachmentsStandards addChainAttachmentsStandards(
		ChainAttachmentsStandards chainAttachmentsStandards)
		throws SystemException {
		chainAttachmentsStandards.setNew(true);

		return chainAttachmentsStandardsPersistence.update(chainAttachmentsStandards);
	}
	 ...
	 */
	@Override
	public ChainAttachmentsStandards createChainAttachmentsStandards(
		long chainAttachmentId) {
		return chainAttachmentsStandardsPersistence.create(chainAttachmentId);
	}
	...
	@Override
	public ChainAttachmentsStandards deleteChainAttachmentsStandards(
		long chainAttachmentId) throws PortalException, SystemException {
		return chainAttachmentsStandardsPersistence.remove(chainAttachmentId);
	}
	...
	public ChainAttachmentsStandards deleteChainAttachmentsStandards(
		ChainAttachmentsStandards chainAttachmentsStandards)
		throws SystemException {
		return chainAttachmentsStandardsPersistence.remove(chainAttachmentsStandards);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ChainAttachmentsStandards.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return chainAttachmentsStandardsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return chainAttachmentsStandardsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ChainAttachmentsStandards fetchChainAttachmentsStandards(
		long chainAttachmentId) throws SystemException {
		return chainAttachmentsStandardsPersistence.fetchByPrimaryKey(chainAttachmentId);
	}
	 ...
	 */
	@Override
	public ChainAttachmentsStandards getChainAttachmentsStandards(
		long chainAttachmentId) throws PortalException, SystemException {
		return chainAttachmentsStandardsPersistence.findByPrimaryKey(chainAttachmentId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return chainAttachmentsStandardsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ChainAttachmentsStandards> getChainAttachmentsStandardses(
		int start, int end) throws SystemException {
		return chainAttachmentsStandardsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getChainAttachmentsStandardsesCount() throws SystemException {
		return chainAttachmentsStandardsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ChainAttachmentsStandards updateChainAttachmentsStandards(
		ChainAttachmentsStandards chainAttachmentsStandards)
		throws SystemException {
		return chainAttachmentsStandardsPersistence.update(chainAttachmentsStandards);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.ChainAttachmentsStandards",
			chainAttachmentsStandardsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.ChainAttachmentsStandards");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = chainAttachmentsStandardsPersistence.getDataSource();
	...
	private ChainAttachmentsStandardsLocalServiceClpInvoker _clpInvoker = new ChainAttachmentsStandardsLocalServiceClpInvoker();
}