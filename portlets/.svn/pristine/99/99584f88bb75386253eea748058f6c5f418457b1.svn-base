 ...
 * @generated
 */
public abstract class StandardsTranslateActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public StandardsTranslateActionableDynamicQuery() throws SystemException {
		setBaseLocalService(StandardsTranslateLocalServiceUtil.getService());
		setClass(StandardsTranslate.class);
