...
import com.ihg.brandstandards.db.service.StandardsLocaleLocalService;
...
/**
 * Provides the base implementation for the standards locale local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.StandardsLocaleLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class StandardsLocaleLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements StandardsLocaleLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.StandardsLocaleLocalServiceUtil} to access the standards locale local service.
	 */
	...
	@Override
	public StandardsLocale addStandardsLocale(StandardsLocale standardsLocale)
		throws SystemException {
		standardsLocale.setNew(true);

		return standardsLocalePersistence.update(standardsLocale);
	}
	 ...
	 */
	@Override
	public StandardsLocale createStandardsLocale(String localeCode) {
		return standardsLocalePersistence.create(localeCode);
	}
	...
	@Override
	public StandardsLocale deleteStandardsLocale(String localeCode)
		throws PortalException, SystemException {
		return standardsLocalePersistence.remove(localeCode);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public StandardsLocale deleteStandardsLocale(
		StandardsLocale standardsLocale) throws SystemException {
		return standardsLocalePersistence.remove(standardsLocale);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(StandardsLocale.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return standardsLocalePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return standardsLocalePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public StandardsLocale fetchStandardsLocale(String localeCode)
		throws SystemException {
		return standardsLocalePersistence.fetchByPrimaryKey(localeCode);
	}
	 ...
	 */
	@Override
	public StandardsLocale getStandardsLocale(String localeCode)
		throws PortalException, SystemException {
		return standardsLocalePersistence.findByPrimaryKey(localeCode);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return standardsLocalePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<StandardsLocale> getStandardsLocales(int start, int end)
		throws SystemException {
		return standardsLocalePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getStandardsLocalesCount() throws SystemException {
		return standardsLocalePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public StandardsLocale updateStandardsLocale(
		StandardsLocale standardsLocale) throws SystemException {
		return standardsLocalePersistence.update(standardsLocale);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.StandardsLocale",
			standardsLocaleLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.StandardsLocale");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = standardsLocalePersistence.getDataSource();
	...
	private StandardsLocaleLocalServiceClpInvoker _clpInvoker = new StandardsLocaleLocalServiceClpInvoker();
}