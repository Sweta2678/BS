...
import com.ihg.brandstandards.db.service.HistManualRegionLocalService;
...
/**
 * Provides the base implementation for the hist manual region local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.HistManualRegionLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 * @see com.ihg.brandstandards.db.service.impl.HistManualRegionLocalServiceImpl
 * @see com.ihg.brandstandards.db.service.HistManualRegionLocalServiceUtil
 * @generated
 */
public abstract class HistManualRegionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements HistManualRegionLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.HistManualRegionLocalServiceUtil} to access the hist manual region local service.
	 */
	...
	@Override
	public HistManualRegion addHistManualRegion(
		HistManualRegion histManualRegion) throws SystemException {
		histManualRegion.setNew(true);

		return histManualRegionPersistence.update(histManualRegion);
	}
	 ...
	 */
	@Override
	public HistManualRegion createHistManualRegion(
		HistManualRegionPK histManualRegionPK) {
		return histManualRegionPersistence.create(histManualRegionPK);
	}
	...
	@Override
	public HistManualRegion deleteHistManualRegion(
		HistManualRegionPK histManualRegionPK)
		throws PortalException, SystemException {
		return histManualRegionPersistence.remove(histManualRegionPK);
	}
	...
	public HistManualRegion deleteHistManualRegion(
		HistManualRegion histManualRegion) throws SystemException {
		return histManualRegionPersistence.remove(histManualRegion);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(HistManualRegion.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return histManualRegionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return histManualRegionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public HistManualRegion fetchHistManualRegion(
		HistManualRegionPK histManualRegionPK) throws SystemException {
		return histManualRegionPersistence.fetchByPrimaryKey(histManualRegionPK);
	}
	 ...
	 */
	@Override
	public HistManualRegion getHistManualRegion(
		HistManualRegionPK histManualRegionPK)
		throws PortalException, SystemException {
		return histManualRegionPersistence.findByPrimaryKey(histManualRegionPK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return histManualRegionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<HistManualRegion> getHistManualRegions(int start, int end)
		throws SystemException {
		return histManualRegionPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getHistManualRegionsCount() throws SystemException {
		return histManualRegionPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public HistManualRegion updateHistManualRegion(
		HistManualRegion histManualRegion) throws SystemException {
		return histManualRegionPersistence.update(histManualRegion);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.HistManualRegion",
			histManualRegionLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = histManualRegionPersistence.getDataSource();
	...
	private HistManualRegionLocalServiceClpInvoker _clpInvoker = new HistManualRegionLocalServiceClpInvoker();
}