...
import com.ihg.brandstandards.db.service.StandardTagLocalService;
...
/**
 * Provides the base implementation for the standard tag local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.StandardTagLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class StandardTagLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements StandardTagLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.StandardTagLocalServiceUtil} to access the standard tag local service.
	 */
	...
	@Override
	public StandardTag addStandardTag(StandardTag standardTag)
		throws SystemException {
		standardTag.setNew(true);

		return standardTagPersistence.update(standardTag);
	}
	 ...
	 */
	@Override
	public StandardTag createStandardTag(StandardTagPK standardTagPK) {
		return standardTagPersistence.create(standardTagPK);
	}
	...
	@Override
	public StandardTag deleteStandardTag(StandardTagPK standardTagPK)
		throws PortalException, SystemException {
		return standardTagPersistence.remove(standardTagPK);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public StandardTag deleteStandardTag(StandardTag standardTag)
		throws SystemException {
		return standardTagPersistence.remove(standardTag);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(StandardTag.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return standardTagPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return standardTagPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return standardTagPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public StandardTag fetchStandardTag(StandardTagPK standardTagPK)
		throws SystemException {
		return standardTagPersistence.fetchByPrimaryKey(standardTagPK);
	}
	 ...
	 */
	@Override
	public StandardTag getStandardTag(StandardTagPK standardTagPK)
		throws PortalException, SystemException {
		return standardTagPersistence.findByPrimaryKey(standardTagPK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return standardTagPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<StandardTag> getStandardTags(int start, int end)
		throws SystemException {
		return standardTagPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getStandardTagsCount() throws SystemException {
		return standardTagPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public StandardTag updateStandardTag(StandardTag standardTag)
		throws SystemException {
		return standardTagPersistence.update(standardTag);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.StandardTag",
			standardTagLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.StandardTag");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = standardTagPersistence.getDataSource();
	...
	private StandardTagLocalServiceClpInvoker _clpInvoker = new StandardTagLocalServiceClpInvoker();
}