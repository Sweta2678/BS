...
import com.ihg.brandstandards.db.service.PublishTaxonomyExtLocalService;
...
/**
 * Provides the base implementation for the Custom Query mapping to create index path. local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.PublishTaxonomyExtLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class PublishTaxonomyExtLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PublishTaxonomyExtLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.PublishTaxonomyExtLocalServiceUtil} to access the Custom Query mapping to create index path. local service.
	 */
	...
	@Override
	public PublishTaxonomyExt addPublishTaxonomyExt(
		PublishTaxonomyExt publishTaxonomyExt) throws SystemException {
		publishTaxonomyExt.setNew(true);

		return publishTaxonomyExtPersistence.update(publishTaxonomyExt);
	}
	 ...
	 */
	@Override
	public PublishTaxonomyExt createPublishTaxonomyExt(long publishTaxId) {
		return publishTaxonomyExtPersistence.create(publishTaxId);
	}
	...
	@Override
	public PublishTaxonomyExt deletePublishTaxonomyExt(long publishTaxId)
		throws PortalException, SystemException {
		return publishTaxonomyExtPersistence.remove(publishTaxId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PublishTaxonomyExt deletePublishTaxonomyExt(
		PublishTaxonomyExt publishTaxonomyExt) throws SystemException {
		return publishTaxonomyExtPersistence.remove(publishTaxonomyExt);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PublishTaxonomyExt.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return publishTaxonomyExtPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return publishTaxonomyExtPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public PublishTaxonomyExt fetchPublishTaxonomyExt(long publishTaxId)
		throws SystemException {
		return publishTaxonomyExtPersistence.fetchByPrimaryKey(publishTaxId);
	}
	 ...
	 */
	@Override
	public PublishTaxonomyExt getPublishTaxonomyExt(long publishTaxId)
		throws PortalException, SystemException {
		return publishTaxonomyExtPersistence.findByPrimaryKey(publishTaxId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return publishTaxonomyExtPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PublishTaxonomyExt> getPublishTaxonomyExts(int start, int end)
		throws SystemException {
		return publishTaxonomyExtPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getPublishTaxonomyExtsCount() throws SystemException {
		return publishTaxonomyExtPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PublishTaxonomyExt updatePublishTaxonomyExt(
		PublishTaxonomyExt publishTaxonomyExt) throws SystemException {
		return publishTaxonomyExtPersistence.update(publishTaxonomyExt);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.PublishTaxonomyExt",
			publishTaxonomyExtLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.PublishTaxonomyExt");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = publishTaxonomyExtPersistence.getDataSource();
	...
	private PublishTaxonomyExtLocalServiceClpInvoker _clpInvoker = new PublishTaxonomyExtLocalServiceClpInvoker();
}