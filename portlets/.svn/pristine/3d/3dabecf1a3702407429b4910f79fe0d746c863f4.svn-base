...
import com.ihg.brandstandards.db.service.MustPublishLocalService;
...
/**
 * Provides the base implementation for the must publish local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.MustPublishLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 * @see com.ihg.brandstandards.db.service.impl.MustPublishLocalServiceImpl
 * @see com.ihg.brandstandards.db.service.MustPublishLocalServiceUtil
 * @generated
 */
public abstract class MustPublishLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements MustPublishLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.MustPublishLocalServiceUtil} to access the must publish local service.
	 */
	...
	@Override
	public MustPublish addMustPublish(MustPublish mustPublish)
		throws SystemException {
		mustPublish.setNew(true);

		return mustPublishPersistence.update(mustPublish);
	}
	 ...
	 */
	@Override
	public MustPublish createMustPublish(long stdId) {
		return mustPublishPersistence.create(stdId);
	}
	...
	@Override
	public MustPublish deleteMustPublish(long stdId)
		throws PortalException, SystemException {
		return mustPublishPersistence.remove(stdId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public MustPublish deleteMustPublish(MustPublish mustPublish)
		throws SystemException {
		return mustPublishPersistence.remove(mustPublish);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(MustPublish.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return mustPublishPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return mustPublishPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return mustPublishPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public MustPublish fetchMustPublish(long stdId) throws SystemException {
		return mustPublishPersistence.fetchByPrimaryKey(stdId);
	}
	 ...
	 */
	@Override
	public MustPublish getMustPublish(long stdId)
		throws PortalException, SystemException {
		return mustPublishPersistence.findByPrimaryKey(stdId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return mustPublishPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MustPublish> getMustPublishs(int start, int end)
		throws SystemException {
		return mustPublishPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getMustPublishsCount() throws SystemException {
		return mustPublishPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public MustPublish updateMustPublish(MustPublish mustPublish)
		throws SystemException {
		return mustPublishPersistence.update(mustPublish);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.MustPublish",
			mustPublishLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = mustPublishPersistence.getDataSource();
	...
	private MustPublishLocalServiceClpInvoker _clpInvoker = new MustPublishLocalServiceClpInvoker();
}