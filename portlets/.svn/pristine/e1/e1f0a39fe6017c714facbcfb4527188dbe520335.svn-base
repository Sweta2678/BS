...
import com.ihg.brandstandards.db.service.BridgePublishLangLocalService;
...
/**
 * Provides the base implementation for the bridge publish lang local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.BridgePublishLangLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class BridgePublishLangLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements BridgePublishLangLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.BridgePublishLangLocalServiceUtil} to access the bridge publish lang local service.
	 */
	...
	@Override
	public BridgePublishLang addBridgePublishLang(
		BridgePublishLang bridgePublishLang) throws SystemException {
		bridgePublishLang.setNew(true);

		return bridgePublishLangPersistence.update(bridgePublishLang);
	}
	 ...
	 */
	@Override
	public BridgePublishLang createBridgePublishLang(long publishLangId) {
		return bridgePublishLangPersistence.create(publishLangId);
	}
	...
	@Override
	public BridgePublishLang deleteBridgePublishLang(long publishLangId)
		throws PortalException, SystemException {
		return bridgePublishLangPersistence.remove(publishLangId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public BridgePublishLang deleteBridgePublishLang(
		BridgePublishLang bridgePublishLang) throws SystemException {
		return bridgePublishLangPersistence.remove(bridgePublishLang);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(BridgePublishLang.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return bridgePublishLangPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return bridgePublishLangPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public BridgePublishLang fetchBridgePublishLang(long publishLangId)
		throws SystemException {
		return bridgePublishLangPersistence.fetchByPrimaryKey(publishLangId);
	}
	 ...
	 */
	@Override
	public BridgePublishLang getBridgePublishLang(long publishLangId)
		throws PortalException, SystemException {
		return bridgePublishLangPersistence.findByPrimaryKey(publishLangId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return bridgePublishLangPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<BridgePublishLang> getBridgePublishLangs(int start, int end)
		throws SystemException {
		return bridgePublishLangPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getBridgePublishLangsCount() throws SystemException {
		return bridgePublishLangPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public BridgePublishLang updateBridgePublishLang(
		BridgePublishLang bridgePublishLang) throws SystemException {
		return bridgePublishLangPersistence.update(bridgePublishLang);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.BridgePublishLang",
			bridgePublishLangLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.BridgePublishLang");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = bridgePublishLangPersistence.getDataSource();
	...
	private BridgePublishLangLocalServiceClpInvoker _clpInvoker = new BridgePublishLangLocalServiceClpInvoker();
}