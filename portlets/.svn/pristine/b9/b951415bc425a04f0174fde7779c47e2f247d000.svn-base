...
import com.ihg.brandstandards.db.service.ChainExternalLinkStandardsLocalService;
...
/**
 * Provides the base implementation for the chain external link standards local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.ChainExternalLinkStandardsLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 * @see com.ihg.brandstandards.db.service.impl.ChainExternalLinkStandardsLocalServiceImpl
 * @see com.ihg.brandstandards.db.service.ChainExternalLinkStandardsLocalServiceUtil
 * @generated
 */
public abstract class ChainExternalLinkStandardsLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements ChainExternalLinkStandardsLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.ChainExternalLinkStandardsLocalServiceUtil} to access the chain external link standards local service.
	 */

	/**
	 * Adds the chain external link standards to the database. Also notifies the appropriate model listeners.
	 *
	 * @param chainExternalLinkStandards the chain external link standards
	 * @return the chain external link standards that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ChainExternalLinkStandards addChainExternalLinkStandards(
		ChainExternalLinkStandards chainExternalLinkStandards)
		throws SystemException {
		chainExternalLinkStandards.setNew(true);

		return chainExternalLinkStandardsPersistence.update(chainExternalLinkStandards);
	}
	 ...
	 */
	@Override
	public ChainExternalLinkStandards createChainExternalLinkStandards(
		ChainExternalLinkStandardsPK chainExternalLinkStandardsPK) {
		return chainExternalLinkStandardsPersistence.create(chainExternalLinkStandardsPK);
	}

	/**
	 * Deletes the chain external link standards with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 ...
	 * @throws PortalException if a chain external link standards with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ChainExternalLinkStandards deleteChainExternalLinkStandards(
		ChainExternalLinkStandardsPK chainExternalLinkStandardsPK)
		throws PortalException, SystemException {
		return chainExternalLinkStandardsPersistence.remove(chainExternalLinkStandardsPK);
	}

	/**
	 * Deletes the chain external link standards from the database. Also notifies the appropriate model listeners.
	 *
	 * @param chainExternalLinkStandards the chain external link standards
	 * @return the chain external link standards that was removed
	 * @throws SystemException if a system exception occurred
	...
	public ChainExternalLinkStandards deleteChainExternalLinkStandards(
		ChainExternalLinkStandards chainExternalLinkStandards)
		throws SystemException {
		return chainExternalLinkStandardsPersistence.remove(chainExternalLinkStandards);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ChainExternalLinkStandards.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return chainExternalLinkStandardsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return chainExternalLinkStandardsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ChainExternalLinkStandards fetchChainExternalLinkStandards(
		ChainExternalLinkStandardsPK chainExternalLinkStandardsPK)
		throws SystemException {
		return chainExternalLinkStandardsPersistence.fetchByPrimaryKey(chainExternalLinkStandardsPK);
	}

	/**
	 * Returns the chain external link standards with the primary key.
	 *
	 * @param chainExternalLinkStandardsPK the primary key of the chain external link standards
	 ...
	 */
	@Override
	public ChainExternalLinkStandards getChainExternalLinkStandards(
		ChainExternalLinkStandardsPK chainExternalLinkStandardsPK)
		throws PortalException, SystemException {
		return chainExternalLinkStandardsPersistence.findByPrimaryKey(chainExternalLinkStandardsPK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return chainExternalLinkStandardsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ChainExternalLinkStandards> getChainExternalLinkStandardses(
		int start, int end) throws SystemException {
		return chainExternalLinkStandardsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getChainExternalLinkStandardsesCount() throws SystemException {
		return chainExternalLinkStandardsPersistence.countAll();
	}

	/**
	 * Updates the chain external link standards in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param chainExternalLinkStandards the chain external link standards
	 * @return the chain external link standards that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ChainExternalLinkStandards updateChainExternalLinkStandards(
		ChainExternalLinkStandards chainExternalLinkStandards)
		throws SystemException {
		return chainExternalLinkStandardsPersistence.update(chainExternalLinkStandards);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.ChainExternalLinkStandards",
			chainExternalLinkStandardsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.ChainExternalLinkStandards");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = chainExternalLinkStandardsPersistence.getDataSource();
	...
	private ChainExternalLinkStandardsLocalServiceClpInvoker _clpInvoker = new ChainExternalLinkStandardsLocalServiceClpInvoker();
}