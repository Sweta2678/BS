...
import com.ihg.brandstandards.db.service.CountryStandardsLocalService;
...
/**
 * Provides the base implementation for the country standards local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.CountryStandardsLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class CountryStandardsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CountryStandardsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.CountryStandardsLocalServiceUtil} to access the country standards local service.
	 */
	...
	@Override
	public CountryStandards addCountryStandards(
		CountryStandards countryStandards) throws SystemException {
		countryStandards.setNew(true);

		return countryStandardsPersistence.update(countryStandards);
	}
	 ...
	 */
	@Override
	public CountryStandards createCountryStandards(
		CountryStandardsPK countryStandardsPK) {
		return countryStandardsPersistence.create(countryStandardsPK);
	}
	...
	@Override
	public CountryStandards deleteCountryStandards(
		CountryStandardsPK countryStandardsPK)
		throws PortalException, SystemException {
		return countryStandardsPersistence.remove(countryStandardsPK);
	}
	...
	public CountryStandards deleteCountryStandards(
		CountryStandards countryStandards) throws SystemException {
		return countryStandardsPersistence.remove(countryStandards);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CountryStandards.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return countryStandardsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return countryStandardsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CountryStandards fetchCountryStandards(
		CountryStandardsPK countryStandardsPK) throws SystemException {
		return countryStandardsPersistence.fetchByPrimaryKey(countryStandardsPK);
	}
	 ...
	 */
	@Override
	public CountryStandards getCountryStandards(
		CountryStandardsPK countryStandardsPK)
		throws PortalException, SystemException {
		return countryStandardsPersistence.findByPrimaryKey(countryStandardsPK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return countryStandardsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CountryStandards> getCountryStandardses(int start, int end)
		throws SystemException {
		return countryStandardsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getCountryStandardsesCount() throws SystemException {
		return countryStandardsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CountryStandards updateCountryStandards(
		CountryStandards countryStandards) throws SystemException {
		return countryStandardsPersistence.update(countryStandards);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.CountryStandards",
			countryStandardsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.CountryStandards");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = countryStandardsPersistence.getDataSource();
	...
	private CountryStandardsLocalServiceClpInvoker _clpInvoker = new CountryStandardsLocalServiceClpInvoker();
}