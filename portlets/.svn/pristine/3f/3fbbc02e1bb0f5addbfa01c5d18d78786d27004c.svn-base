...
import com.ihg.brandstandards.db.service.HistManualChainLocalService;
...
/**
 * Provides the base implementation for the hist manual chain local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.HistManualChainLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class HistManualChainLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements HistManualChainLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.HistManualChainLocalServiceUtil} to access the hist manual chain local service.
	 */
	...
	@Override
	public HistManualChain addHistManualChain(HistManualChain histManualChain)
		throws SystemException {
		histManualChain.setNew(true);

		return histManualChainPersistence.update(histManualChain);
	}
	 ...
	 */
	@Override
	public HistManualChain createHistManualChain(
		HistManualChainPK histManualChainPK) {
		return histManualChainPersistence.create(histManualChainPK);
	}
	...
	@Override
	public HistManualChain deleteHistManualChain(
		HistManualChainPK histManualChainPK)
		throws PortalException, SystemException {
		return histManualChainPersistence.remove(histManualChainPK);
	}
	...
	@Override
	public HistManualChain deleteHistManualChain(
		HistManualChain histManualChain) throws SystemException {
		return histManualChainPersistence.remove(histManualChain);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(HistManualChain.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return histManualChainPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return histManualChainPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public HistManualChain fetchHistManualChain(
		HistManualChainPK histManualChainPK) throws SystemException {
		return histManualChainPersistence.fetchByPrimaryKey(histManualChainPK);
	}
	 ...
	 */
	@Override
	public HistManualChain getHistManualChain(
		HistManualChainPK histManualChainPK)
		throws PortalException, SystemException {
		return histManualChainPersistence.findByPrimaryKey(histManualChainPK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return histManualChainPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<HistManualChain> getHistManualChains(int start, int end)
		throws SystemException {
		return histManualChainPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getHistManualChainsCount() throws SystemException {
		return histManualChainPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public HistManualChain updateHistManualChain(
		HistManualChain histManualChain) throws SystemException {
		return histManualChainPersistence.update(histManualChain);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.HistManualChain",
			histManualChainLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.HistManualChain");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = histManualChainPersistence.getDataSource();
	...
	private HistManualChainLocalServiceClpInvoker _clpInvoker = new HistManualChainLocalServiceClpInvoker();
}