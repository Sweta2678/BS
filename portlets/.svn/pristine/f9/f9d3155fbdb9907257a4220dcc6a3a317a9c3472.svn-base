...
public class ImageLocalServiceClpInvoker {
	public ImageLocalServiceClpInvoker() {
		...
		_methodName598 = "getImages";

		_methodParameterTypes598 = new String[] { "java.util.List" };

		_methodName599 = "findImageByDescAndTitle";

		_methodParameterTypes599 = new String[] {
				"java.lang.String", "java.lang.String"
			};

		_methodName600 = "clearCache";
