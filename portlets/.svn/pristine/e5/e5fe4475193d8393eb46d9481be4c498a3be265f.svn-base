...
/**
 * The persistence utility for the standards display order ext service. This utility wraps {@link StandardsDisplayOrderExtPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class StandardsDisplayOrderExtUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public static void clearCache(
		...
		getPersistence().clearCache(standardsDisplayOrderExt);
	}
	 ...
	 */
	public static List<StandardsDisplayOrderExt> findWithDynamicQuery(
	 ...
	 */
	public static StandardsDisplayOrderExt update(
		StandardsDisplayOrderExt standardsDisplayOrderExt)
		throws SystemException {
		return getPersistence().update(standardsDisplayOrderExt);
	}
	...
	public static StandardsDisplayOrderExt update(
		...
		return getPersistence().update(standardsDisplayOrderExt, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(standardsDisplayOrderExt);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(standardsDisplayOrderExts);
	}
	...
	*/
	public static com.ihg.brandstandards.db.model.StandardsDisplayOrderExt create(
		long stdId) {
	...
	*/
	public static com.ihg.brandstandards.db.model.StandardsDisplayOrderExt remove(
		long stdId)
	...
	public static com.ihg.brandstandards.db.model.StandardsDisplayOrderExt updateImpl(
		com.ihg.brandstandards.db.model.StandardsDisplayOrderExt standardsDisplayOrderExt)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(standardsDisplayOrderExt);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.StandardsDisplayOrderExt findByPrimaryKey(
		long stdId)
		throws com.ihg.brandstandards.db.NoSuchStandardsDisplayOrderExtException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.StandardsDisplayOrderExt fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.ihg.brandstandards.db.model.StandardsDisplayOrderExt> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static StandardsDisplayOrderExtPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (StandardsDisplayOrderExtPersistence)PortletBeanLocatorUtil.locate(com.ihg.brandstandards.db.service.ClpSerializer.getServletContextName(),
					StandardsDisplayOrderExtPersistence.class.getName());

			ReferenceRegistry.registerReference(StandardsDisplayOrderExtUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(StandardsDisplayOrderExtPersistence persistence) {
	}

	private static StandardsDisplayOrderExtPersistence _persistence;
}