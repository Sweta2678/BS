...
import com.ihg.brandstandards.db.service.StandardsRegionLocaleLocalService;
...
/**
 * Provides the base implementation for the standards region locale local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.StandardsRegionLocaleLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class StandardsRegionLocaleLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements StandardsRegionLocaleLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.StandardsRegionLocaleLocalServiceUtil} to access the standards region locale local service.
	 */
	...
	@Override
	public StandardsRegionLocale addStandardsRegionLocale(
		StandardsRegionLocale standardsRegionLocale) throws SystemException {
		standardsRegionLocale.setNew(true);

		return standardsRegionLocalePersistence.update(standardsRegionLocale);
	}
	 ...
	 */
	@Override
	public StandardsRegionLocale createStandardsRegionLocale(
		StandardsRegionLocalePK standardsRegionLocalePK) {
		return standardsRegionLocalePersistence.create(standardsRegionLocalePK);
	}
	...
	@Override
	public StandardsRegionLocale deleteStandardsRegionLocale(
		StandardsRegionLocalePK standardsRegionLocalePK)
		throws PortalException, SystemException {
		return standardsRegionLocalePersistence.remove(standardsRegionLocalePK);
	}
	...
	public StandardsRegionLocale deleteStandardsRegionLocale(
		StandardsRegionLocale standardsRegionLocale) throws SystemException {
		return standardsRegionLocalePersistence.remove(standardsRegionLocale);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(StandardsRegionLocale.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return standardsRegionLocalePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return standardsRegionLocalePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public StandardsRegionLocale fetchStandardsRegionLocale(
		StandardsRegionLocalePK standardsRegionLocalePK)
		throws SystemException {
		return standardsRegionLocalePersistence.fetchByPrimaryKey(standardsRegionLocalePK);
	}
	 ...
	 */
	@Override
	public StandardsRegionLocale getStandardsRegionLocale(
		StandardsRegionLocalePK standardsRegionLocalePK)
		throws PortalException, SystemException {
		return standardsRegionLocalePersistence.findByPrimaryKey(standardsRegionLocalePK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return standardsRegionLocalePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<StandardsRegionLocale> getStandardsRegionLocales(int start,
		int end) throws SystemException {
		return standardsRegionLocalePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getStandardsRegionLocalesCount() throws SystemException {
		return standardsRegionLocalePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public StandardsRegionLocale updateStandardsRegionLocale(
		StandardsRegionLocale standardsRegionLocale) throws SystemException {
		return standardsRegionLocalePersistence.update(standardsRegionLocale);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.StandardsRegionLocale",
			standardsRegionLocaleLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.StandardsRegionLocale");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = standardsRegionLocalePersistence.getDataSource();
	...
	private StandardsRegionLocaleLocalServiceClpInvoker _clpInvoker = new StandardsRegionLocaleLocalServiceClpInvoker();
}