...
public class GEMTemplateLocalServiceClpInvoker {
	public GEMTemplateLocalServiceClpInvoker() {
		...
		_methodName597 = "getByTypeAndRegionAndPublication";

		_methodParameterTypes597 = new String[] {
				"java.lang.String", "long", "long"
			};

		_methodName598 = "getByTypeAndRegionAndPublicationList";

		_methodParameterTypes598 = new String[] {
				"java.lang.String", "long", "long"
			};

		_methodName599 = "getByPublishId";

		_methodParameterTypes599 = new String[] { "long" };

		_methodName600 = "getByPublishIdAndRgnId";

		_methodParameterTypes600 = new String[] { "long", "long" };

		_methodName601 = "getByPublishIdAndRgnIdAndType";

		_methodParameterTypes601 = new String[] {
				"long", "long", "java.lang.String"
			};

		_methodName602 = "getByPublishIdAndTemplateType";

		_methodParameterTypes602 = new String[] { "long", "java.lang.String" };

		_methodName603 = "getByTemplateType";

		_methodParameterTypes603 = new String[] { "java.lang.String" };

		_methodName604 = "deleteTemplateConfigurations";

		_methodParameterTypes604 = new String[] { "long" };

		_methodName605 = "getSequenceNumber";

		_methodParameterTypes605 = new String[] { "java.lang.String" };

		_methodName606 = "insertTemplateValueUsingSequence";
