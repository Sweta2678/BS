...
public class ImageLocalServiceClpInvoker {
	public ImageLocalServiceClpInvoker() {
		...
		_methodName614 = "addImage";

		_methodParameterTypes614 = new String[] {
				"com.liferay.portlet.documentlibrary.model.DLFileEntry", "long"
			};

		_methodName615 = "updateImage";
		...
		_methodName616 = "getImages";

		_methodParameterTypes616 = new String[] { "java.util.List" };

		_methodName617 = "findImageByDescAndTitle";

		_methodParameterTypes617 = new String[] {
				"java.lang.String", "java.lang.String"
			};

		_methodName618 = "clearCache";
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return ImageLocalServiceUtil.addImage((com.ihg.brandstandards.db.model.Image)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return ImageLocalServiceUtil.deleteImage((com.ihg.brandstandards.db.model.Image)arguments[0]);
		}
		...
		if (_methodName15.equals(name) &&
			...
			return ImageLocalServiceUtil.updateImage((com.ihg.brandstandards.db.model.Image)arguments[0]);
		}
		...
		if (_methodName614.equals(name) &&
			...
			return ImageLocalServiceUtil.addImage((com.liferay.portlet.documentlibrary.model.DLFileEntry)arguments[0],
				((Long)arguments[1]).longValue());
		}

		if (_methodName615.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes615, parameterTypes)) {
			return ImageLocalServiceUtil.updateImage((com.liferay.portlet.documentlibrary.model.DLFileEntry)arguments[0],
				((Long)arguments[1]).longValue(),
		...
		if (_methodName616.equals(name) &&
			...
			return ImageLocalServiceUtil.getImages((java.util.List<java.lang.Object>)arguments[0]);
		}

		if (_methodName617.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes617, parameterTypes)) {
			return ImageLocalServiceUtil.findImageByDescAndTitle((java.lang.String)arguments[0],
				(java.lang.String)arguments[1]);
		}

		if (_methodName618.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes618, parameterTypes)) {
			ImageLocalServiceUtil.clearCache();
