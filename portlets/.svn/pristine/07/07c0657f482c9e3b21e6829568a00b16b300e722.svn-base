...
import com.ihg.brandstandards.db.service.BridgeGlobalPublishLocalService;
...
/**
 * Provides the base implementation for the bridge global publish local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.BridgeGlobalPublishLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class BridgeGlobalPublishLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements BridgeGlobalPublishLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.BridgeGlobalPublishLocalServiceUtil} to access the bridge global publish local service.
	 */
	...
	@Override
	public BridgeGlobalPublish addBridgeGlobalPublish(
		BridgeGlobalPublish bridgeGlobalPublish) throws SystemException {
		bridgeGlobalPublish.setNew(true);

		return bridgeGlobalPublishPersistence.update(bridgeGlobalPublish);
	}
	 ...
	 */
	@Override
	public BridgeGlobalPublish createBridgeGlobalPublish(long globalPublishId) {
		return bridgeGlobalPublishPersistence.create(globalPublishId);
	}
	...
	@Override
	public BridgeGlobalPublish deleteBridgeGlobalPublish(long globalPublishId)
		throws PortalException, SystemException {
		return bridgeGlobalPublishPersistence.remove(globalPublishId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public BridgeGlobalPublish deleteBridgeGlobalPublish(
		BridgeGlobalPublish bridgeGlobalPublish) throws SystemException {
		return bridgeGlobalPublishPersistence.remove(bridgeGlobalPublish);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(BridgeGlobalPublish.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return bridgeGlobalPublishPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return bridgeGlobalPublishPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public BridgeGlobalPublish fetchBridgeGlobalPublish(long globalPublishId)
		throws SystemException {
		return bridgeGlobalPublishPersistence.fetchByPrimaryKey(globalPublishId);
	}
	 ...
	 */
	@Override
	public BridgeGlobalPublish getBridgeGlobalPublish(long globalPublishId)
		throws PortalException, SystemException {
		return bridgeGlobalPublishPersistence.findByPrimaryKey(globalPublishId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return bridgeGlobalPublishPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<BridgeGlobalPublish> getBridgeGlobalPublishs(int start, int end)
		throws SystemException {
		return bridgeGlobalPublishPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getBridgeGlobalPublishsCount() throws SystemException {
		return bridgeGlobalPublishPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public BridgeGlobalPublish updateBridgeGlobalPublish(
		BridgeGlobalPublish bridgeGlobalPublish) throws SystemException {
		return bridgeGlobalPublishPersistence.update(bridgeGlobalPublish);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.BridgeGlobalPublish",
			bridgeGlobalPublishLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = bridgeGlobalPublishPersistence.getDataSource();
	...
	private BridgeGlobalPublishLocalServiceClpInvoker _clpInvoker = new BridgeGlobalPublishLocalServiceClpInvoker();
}