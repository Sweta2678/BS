...
import com.ihg.brandstandards.db.service.PublishStandardsExtLocalService;
...
/**
 * Provides the base implementation for the Custom Query mapping to createlist of standards with translations. local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.PublishStandardsExtLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class PublishStandardsExtLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PublishStandardsExtLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.PublishStandardsExtLocalServiceUtil} to access the Custom Query mapping to createlist of standards with translations. local service.
	 */
	...
	@Override
	public PublishStandardsExt addPublishStandardsExt(
		PublishStandardsExt publishStandardsExt) throws SystemException {
		publishStandardsExt.setNew(true);

		return publishStandardsExtPersistence.update(publishStandardsExt);
	}
	 ...
	 */
	@Override
	public PublishStandardsExt createPublishStandardsExt(long publishStdId) {
		return publishStandardsExtPersistence.create(publishStdId);
	}
	...
	@Override
	public PublishStandardsExt deletePublishStandardsExt(long publishStdId)
		throws PortalException, SystemException {
		return publishStandardsExtPersistence.remove(publishStdId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PublishStandardsExt deletePublishStandardsExt(
		PublishStandardsExt publishStandardsExt) throws SystemException {
		return publishStandardsExtPersistence.remove(publishStandardsExt);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PublishStandardsExt.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return publishStandardsExtPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return publishStandardsExtPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public PublishStandardsExt fetchPublishStandardsExt(long publishStdId)
		throws SystemException {
		return publishStandardsExtPersistence.fetchByPrimaryKey(publishStdId);
	}
	 ...
	 */
	@Override
	public PublishStandardsExt getPublishStandardsExt(long publishStdId)
		throws PortalException, SystemException {
		return publishStandardsExtPersistence.findByPrimaryKey(publishStdId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return publishStandardsExtPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PublishStandardsExt> getPublishStandardsExts(int start, int end)
		throws SystemException {
		return publishStandardsExtPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getPublishStandardsExtsCount() throws SystemException {
		return publishStandardsExtPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PublishStandardsExt updatePublishStandardsExt(
		PublishStandardsExt publishStandardsExt) throws SystemException {
		return publishStandardsExtPersistence.update(publishStandardsExt);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.PublishStandardsExt",
			publishStandardsExtLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.PublishStandardsExt");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = publishStandardsExtPersistence.getDataSource();
	...
	private PublishStandardsExtLocalServiceClpInvoker _clpInvoker = new PublishStandardsExtLocalServiceClpInvoker();
}