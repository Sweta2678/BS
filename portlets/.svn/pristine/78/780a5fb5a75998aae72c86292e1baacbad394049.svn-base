...
import com.ihg.brandstandards.db.service.StandardsLocalService;
...
/**
 * Provides the base implementation for the standards local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.StandardsLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class StandardsLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements StandardsLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.StandardsLocalServiceUtil} to access the standards local service.
	 */
	...
	@Override
	public Standards addStandards(Standards standards)
		throws SystemException {
		standards.setNew(true);

		return standardsPersistence.update(standards);
	}
	 ...
	 */
	@Override
	public Standards createStandards(long stdId) {
		return standardsPersistence.create(stdId);
	}
	...
	@Override
	public Standards deleteStandards(long stdId)
		throws PortalException, SystemException {
		return standardsPersistence.remove(stdId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Standards deleteStandards(Standards standards)
		throws SystemException {
		return standardsPersistence.remove(standards);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Standards.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return standardsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return standardsPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return standardsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public Standards fetchStandards(long stdId) throws SystemException {
		return standardsPersistence.fetchByPrimaryKey(stdId);
	}
	 ...
	 */
	@Override
	public Standards getStandards(long stdId)
		throws PortalException, SystemException {
		return standardsPersistence.findByPrimaryKey(stdId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return standardsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Standards> getStandardses(int start, int end)
		throws SystemException {
		return standardsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getStandardsesCount() throws SystemException {
		return standardsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Standards updateStandards(Standards standards)
		throws SystemException {
		return standardsPersistence.update(standards);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.Standards",
			standardsLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = standardsPersistence.getDataSource();
	...
	private StandardsLocalServiceClpInvoker _clpInvoker = new StandardsLocalServiceClpInvoker();
}