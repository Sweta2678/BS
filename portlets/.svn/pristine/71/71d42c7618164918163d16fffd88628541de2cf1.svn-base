...
import com.ihg.brandstandards.db.service.GEMSeverityLocalService;
...
/**
 * Provides the base implementation for the g e m severity local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.GEMSeverityLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 * @see com.ihg.brandstandards.db.service.impl.GEMSeverityLocalServiceImpl
 * @see com.ihg.brandstandards.db.service.GEMSeverityLocalServiceUtil
 * @generated
 */
public abstract class GEMSeverityLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements GEMSeverityLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.GEMSeverityLocalServiceUtil} to access the g e m severity local service.
	 */
	...
	@Override
	public GEMSeverity addGEMSeverity(GEMSeverity gemSeverity)
		throws SystemException {
		gemSeverity.setNew(true);

		return gemSeverityPersistence.update(gemSeverity);
	}
	 ...
	 */
	@Override
	public GEMSeverity createGEMSeverity(long severityId) {
		return gemSeverityPersistence.create(severityId);
	}
	...
	@Override
	public GEMSeverity deleteGEMSeverity(long severityId)
		throws PortalException, SystemException {
		return gemSeverityPersistence.remove(severityId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public GEMSeverity deleteGEMSeverity(GEMSeverity gemSeverity)
		throws SystemException {
		return gemSeverityPersistence.remove(gemSeverity);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(GEMSeverity.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return gemSeverityPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return gemSeverityPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return gemSeverityPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public GEMSeverity fetchGEMSeverity(long severityId)
		throws SystemException {
		return gemSeverityPersistence.fetchByPrimaryKey(severityId);
	}
	 ...
	 */
	@Override
	public GEMSeverity getGEMSeverity(long severityId)
		throws PortalException, SystemException {
		return gemSeverityPersistence.findByPrimaryKey(severityId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return gemSeverityPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<GEMSeverity> getGEMSeverities(int start, int end)
		throws SystemException {
		return gemSeverityPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getGEMSeveritiesCount() throws SystemException {
		return gemSeverityPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public GEMSeverity updateGEMSeverity(GEMSeverity gemSeverity)
		throws SystemException {
		return gemSeverityPersistence.update(gemSeverity);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.GEMSeverity",
			gemSeverityLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = gemSeverityPersistence.getDataSource();
	...
	private GEMSeverityLocalServiceClpInvoker _clpInvoker = new GEMSeverityLocalServiceClpInvoker();
}