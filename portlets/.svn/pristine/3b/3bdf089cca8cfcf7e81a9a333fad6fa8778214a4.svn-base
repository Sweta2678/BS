...
import com.ihg.brandstandards.db.service.StandardsRegionChainLocalService;
...
/**
 * Provides the base implementation for the standards region chain local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.StandardsRegionChainLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class StandardsRegionChainLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements StandardsRegionChainLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.StandardsRegionChainLocalServiceUtil} to access the standards region chain local service.
	 */
	...
	@Override
	public StandardsRegionChain addStandardsRegionChain(
		StandardsRegionChain standardsRegionChain) throws SystemException {
		standardsRegionChain.setNew(true);

		return standardsRegionChainPersistence.update(standardsRegionChain);
	}
	 ...
	 */
	@Override
	public StandardsRegionChain createStandardsRegionChain(
		StandardsRegionChainPK standardsRegionChainPK) {
		return standardsRegionChainPersistence.create(standardsRegionChainPK);
	}
	...
	@Override
	public StandardsRegionChain deleteStandardsRegionChain(
		StandardsRegionChainPK standardsRegionChainPK)
		throws PortalException, SystemException {
		return standardsRegionChainPersistence.remove(standardsRegionChainPK);
	}
	...
	public StandardsRegionChain deleteStandardsRegionChain(
		StandardsRegionChain standardsRegionChain) throws SystemException {
		return standardsRegionChainPersistence.remove(standardsRegionChain);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(StandardsRegionChain.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return standardsRegionChainPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return standardsRegionChainPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public StandardsRegionChain fetchStandardsRegionChain(
		StandardsRegionChainPK standardsRegionChainPK)
		throws SystemException {
		return standardsRegionChainPersistence.fetchByPrimaryKey(standardsRegionChainPK);
	}
	 ...
	 */
	@Override
	public StandardsRegionChain getStandardsRegionChain(
		StandardsRegionChainPK standardsRegionChainPK)
		throws PortalException, SystemException {
		return standardsRegionChainPersistence.findByPrimaryKey(standardsRegionChainPK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return standardsRegionChainPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<StandardsRegionChain> getStandardsRegionChains(int start,
		int end) throws SystemException {
		return standardsRegionChainPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getStandardsRegionChainsCount() throws SystemException {
		return standardsRegionChainPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public StandardsRegionChain updateStandardsRegionChain(
		StandardsRegionChain standardsRegionChain) throws SystemException {
		return standardsRegionChainPersistence.update(standardsRegionChain);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.StandardsRegionChain",
			standardsRegionChainLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = standardsRegionChainPersistence.getDataSource();
	...
	private StandardsRegionChainLocalServiceClpInvoker _clpInvoker = new StandardsRegionChainLocalServiceClpInvoker();
}