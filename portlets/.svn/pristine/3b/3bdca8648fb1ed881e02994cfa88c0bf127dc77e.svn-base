...
public class UIElementTranslateLocalServiceClpInvoker {
	public UIElementTranslateLocalServiceClpInvoker() {
		...
		_methodName587 = "getUIElementTranslateObject";

		_methodParameterTypes587 = new String[] {  };

		_methodName588 = "addNewUIElementData";

		_methodParameterTypes588 = new String[] {
				"com.ihg.brandstandards.db.model.UIElementTranslate"
			};

		_methodName589 = "getByElementId";

		_methodParameterTypes589 = new String[] { "long" };

		_methodName590 = "getByLocaleCode";

		_methodParameterTypes590 = new String[] { "java.lang.String" };

		_methodName591 = "getByIdAndLocaleCode";
