 ...
 * @generated
 */
public class UserPreferenceLocalServiceClp implements UserPreferenceLocalService {
	public UserPreferenceLocalServiceClp(
		...
		_methodName20 = "getUserPreferencesByUserId";

		_methodParameterTypes20 = new String[] { "long", "java.lang.String" };

		_methodName21 = "getUserPreferencePK";
	...
	public com.ihg.brandstandards.db.model.UserPreference addUserPreference(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(userPreference) });
		}
		catch (Throwable t) {
		...
		return (com.ihg.brandstandards.db.model.UserPreference)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<com.ihg.brandstandards.db.model.UserPreference> getUserPreferences(
		...
		return (java.util.List<com.ihg.brandstandards.db.model.UserPreference>)ClpSerializer.translateOutput(returnObj);
	}
