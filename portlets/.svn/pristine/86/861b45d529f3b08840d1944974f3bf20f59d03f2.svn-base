...
import com.ihg.brandstandards.db.service.UIElementLocalService;
...
/**
 * Provides the base implementation for the u i element local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.UIElementLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 * @see com.ihg.brandstandards.db.service.impl.UIElementLocalServiceImpl
 * @see com.ihg.brandstandards.db.service.UIElementLocalServiceUtil
 * @generated
 */
public abstract class UIElementLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements UIElementLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.UIElementLocalServiceUtil} to access the u i element local service.
	 */

	/**
	 * Adds the u i element to the database. Also notifies the appropriate model listeners.
	 *
	 * @param uiElement the u i element
	 * @return the u i element that was added
	...
	public UIElement addUIElement(UIElement uiElement)
		...
		return uiElementPersistence.update(uiElement);
	}
	 ...
	 */
	@Override
	public UIElement createUIElement(long elementId) {
		return uiElementPersistence.create(elementId);
	}

	/**
	 * Deletes the u i element with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param elementId the primary key of the u i element
	 * @return the u i element that was removed
	 * @throws PortalException if a u i element with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public UIElement deleteUIElement(long elementId)
		throws PortalException, SystemException {
		return uiElementPersistence.remove(elementId);
	}

	/**
	 * Deletes the u i element from the database. Also notifies the appropriate model listeners.
	 *
	 * @param uiElement the u i element
	 * @return the u i element that was removed
	 * @throws SystemException if a system exception occurred
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public UIElement deleteUIElement(UIElement uiElement)
		throws SystemException {
		return uiElementPersistence.remove(uiElement);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(UIElement.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return uiElementPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return uiElementPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return uiElementPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public UIElement fetchUIElement(long elementId) throws SystemException {
		return uiElementPersistence.fetchByPrimaryKey(elementId);
	}

	/**
	 * Returns the u i element with the primary key.
	 *
	 * @param elementId the primary key of the u i element
	 ...
	 */
	@Override
	public UIElement getUIElement(long elementId)
		throws PortalException, SystemException {
		return uiElementPersistence.findByPrimaryKey(elementId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return uiElementPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<UIElement> getUIElements(int start, int end)
		throws SystemException {
		return uiElementPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getUIElementsCount() throws SystemException {
		return uiElementPersistence.countAll();
	}

	/**
	 * Updates the u i element in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param uiElement the u i element
	 * @return the u i element that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public UIElement updateUIElement(UIElement uiElement)
		throws SystemException {
		return uiElementPersistence.update(uiElement);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.UIElement",
			uiElementLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = uiElementPersistence.getDataSource();
	...
	private UIElementLocalServiceClpInvoker _clpInvoker = new UIElementLocalServiceClpInvoker();
}