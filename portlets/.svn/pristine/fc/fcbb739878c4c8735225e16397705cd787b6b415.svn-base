 ...
 * @author Mummanedi
 */
public class GEMUniqueGroupCountryClp extends BaseModelImpl<GEMUniqueGroupCountry>
	implements GEMUniqueGroupCountry {
	public GEMUniqueGroupCountryClp() {
	}
	...
	public void setGroupCountryId(long groupCountryId) {
		...
		if (_gemUniqueGroupCountryRemoteModel != null) {
			try {
				Class<?> clazz = _gemUniqueGroupCountryRemoteModel.getClass();

				Method method = clazz.getMethod("setGroupCountryId", long.class);

				method.invoke(_gemUniqueGroupCountryRemoteModel, groupCountryId);
			}
			catch (Exception e) {
	...
	public void setUniqueGroupId(long uniqueGroupId) {
		...
		if (_gemUniqueGroupCountryRemoteModel != null) {
			try {
				...
				method.invoke(_gemUniqueGroupCountryRemoteModel, uniqueGroupId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setCountryCode(String countryCode) {
		...
		if (_gemUniqueGroupCountryRemoteModel != null) {
			try {
				...
				method.invoke(_gemUniqueGroupCountryRemoteModel, countryCode);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setCreatorId(String creatorId) {
		...
		if (_gemUniqueGroupCountryRemoteModel != null) {
			try {
				...
				method.invoke(_gemUniqueGroupCountryRemoteModel, creatorId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setCreatedDate(Date createdDate) {
		...
		if (_gemUniqueGroupCountryRemoteModel != null) {
			try {
				...
				method.invoke(_gemUniqueGroupCountryRemoteModel, createdDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setUpdatedBy(String updatedBy) {
		...
		if (_gemUniqueGroupCountryRemoteModel != null) {
			try {
				...
				method.invoke(_gemUniqueGroupCountryRemoteModel, updatedBy);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setUpdatedDate(Date updatedDate) {
		...
		if (_gemUniqueGroupCountryRemoteModel != null) {
			try {
				...
				method.invoke(_gemUniqueGroupCountryRemoteModel, updatedDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public BaseModel<?> getGEMUniqueGroupCountryRemoteModel() {
		return _gemUniqueGroupCountryRemoteModel;
	}

	public void setGEMUniqueGroupCountryRemoteModel(
		BaseModel<?> gemUniqueGroupCountryRemoteModel) {
		_gemUniqueGroupCountryRemoteModel = gemUniqueGroupCountryRemoteModel;
	}
	...
	public Object invokeOnRemoteModel(String methodName,
		...
		Class<?> remoteModelClass = _gemUniqueGroupCountryRemoteModel.getClass();
		...
		Object returnValue = method.invoke(_gemUniqueGroupCountryRemoteModel,
	...
	public GEMUniqueGroupCountry toEscapedModel() {
		return (GEMUniqueGroupCountry)ProxyUtil.newProxyInstance(GEMUniqueGroupCountry.class.getClassLoader(),
			new Class[] { GEMUniqueGroupCountry.class },
			new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		GEMUniqueGroupCountryClp clone = new GEMUniqueGroupCountryClp();
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof GEMUniqueGroupCountryClp)) {
			return false;
		}

		GEMUniqueGroupCountryClp gemUniqueGroupCountry = (GEMUniqueGroupCountryClp)obj;
	...
	private BaseModel<?> _gemUniqueGroupCountryRemoteModel;
}