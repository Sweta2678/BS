...
public class TaxonomyLocalServiceClpInvoker {
	public TaxonomyLocalServiceClpInvoker() {
		...
		_methodName593 = "getTaxonomyCountByPid";

		_methodParameterTypes593 = new String[] { "long" };

		_methodName594 = "getTaxonomiesById";
