...
import com.ihg.brandstandards.db.service.UniqueGroupStandardLocalService;
...
/**
 * Provides the base implementation for the unique group standard local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.UniqueGroupStandardLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 * @see com.ihg.brandstandards.db.service.impl.UniqueGroupStandardLocalServiceImpl
 * @see com.ihg.brandstandards.db.service.UniqueGroupStandardLocalServiceUtil
 * @generated
 */
public abstract class UniqueGroupStandardLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements UniqueGroupStandardLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.UniqueGroupStandardLocalServiceUtil} to access the unique group standard local service.
	 */

	/**
	 * Adds the unique group standard to the database. Also notifies the appropriate model listeners.
	 *
	 * @param uniqueGroupStandard the unique group standard
	 * @return the unique group standard that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public UniqueGroupStandard addUniqueGroupStandard(
		UniqueGroupStandard uniqueGroupStandard) throws SystemException {
		uniqueGroupStandard.setNew(true);

		return uniqueGroupStandardPersistence.update(uniqueGroupStandard);
	}
	 ...
	 */
	@Override
	public UniqueGroupStandard createUniqueGroupStandard(long groupStandardId) {
		return uniqueGroupStandardPersistence.create(groupStandardId);
	}

	/**
	 * Deletes the unique group standard with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param groupStandardId the primary key of the unique group standard
	 * @return the unique group standard that was removed
	 * @throws PortalException if a unique group standard with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public UniqueGroupStandard deleteUniqueGroupStandard(long groupStandardId)
		throws PortalException, SystemException {
		return uniqueGroupStandardPersistence.remove(groupStandardId);
	}

	/**
	 * Deletes the unique group standard from the database. Also notifies the appropriate model listeners.
	 *
	 * @param uniqueGroupStandard the unique group standard
	 * @return the unique group standard that was removed
	 * @throws SystemException if a system exception occurred
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public UniqueGroupStandard deleteUniqueGroupStandard(
		UniqueGroupStandard uniqueGroupStandard) throws SystemException {
		return uniqueGroupStandardPersistence.remove(uniqueGroupStandard);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(UniqueGroupStandard.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return uniqueGroupStandardPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return uniqueGroupStandardPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public UniqueGroupStandard fetchUniqueGroupStandard(long groupStandardId)
		throws SystemException {
		return uniqueGroupStandardPersistence.fetchByPrimaryKey(groupStandardId);
	}

	/**
	 * Returns the unique group standard with the primary key.
	 *
	 * @param groupStandardId the primary key of the unique group standard
	 ...
	 */
	@Override
	public UniqueGroupStandard getUniqueGroupStandard(long groupStandardId)
		throws PortalException, SystemException {
		return uniqueGroupStandardPersistence.findByPrimaryKey(groupStandardId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return uniqueGroupStandardPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<UniqueGroupStandard> getUniqueGroupStandards(int start, int end)
		throws SystemException {
		return uniqueGroupStandardPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getUniqueGroupStandardsCount() throws SystemException {
		return uniqueGroupStandardPersistence.countAll();
	}

	/**
	 * Updates the unique group standard in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param uniqueGroupStandard the unique group standard
	 * @return the unique group standard that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public UniqueGroupStandard updateUniqueGroupStandard(
		UniqueGroupStandard uniqueGroupStandard) throws SystemException {
		return uniqueGroupStandardPersistence.update(uniqueGroupStandard);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.UniqueGroupStandard",
			uniqueGroupStandardLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.UniqueGroupStandard");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = uniqueGroupStandardPersistence.getDataSource();
	...
	private UniqueGroupStandardLocalServiceClpInvoker _clpInvoker = new UniqueGroupStandardLocalServiceClpInvoker();
}