...
/**
 * Provides the local service interface for GEMChainMeasurement. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mummanedi
 * @see GEMChainMeasurementLocalServiceUtil
...
public interface GEMChainMeasurementLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link GEMChainMeasurementLocalServiceUtil} to access the g e m chain measurement local service. Add custom service methods to {@link com.ihg.brandstandards.db.service.impl.GEMChainMeasurementLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
