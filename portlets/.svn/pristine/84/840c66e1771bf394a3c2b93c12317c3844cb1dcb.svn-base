...
import com.ihg.brandstandards.db.service.StandardsTranslateLocalService;
...
/**
 * Provides the base implementation for the standards translate local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ihg.brandstandards.db.service.impl.StandardsTranslateLocalServiceImpl}.
 * </p>
 *
 * @author Mummanedi
 ...
 * @generated
 */
public abstract class StandardsTranslateLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements StandardsTranslateLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ihg.brandstandards.db.service.StandardsTranslateLocalServiceUtil} to access the standards translate local service.
	 */
	...
	@Override
	public StandardsTranslate addStandardsTranslate(
		StandardsTranslate standardsTranslate) throws SystemException {
		standardsTranslate.setNew(true);

		return standardsTranslatePersistence.update(standardsTranslate);
	}
	 ...
	 */
	@Override
	public StandardsTranslate createStandardsTranslate(
		StandardsTranslatePK standardsTranslatePK) {
		return standardsTranslatePersistence.create(standardsTranslatePK);
	}
	...
	@Override
	public StandardsTranslate deleteStandardsTranslate(
		StandardsTranslatePK standardsTranslatePK)
		throws PortalException, SystemException {
		return standardsTranslatePersistence.remove(standardsTranslatePK);
	}
	...
	public StandardsTranslate deleteStandardsTranslate(
		StandardsTranslate standardsTranslate) throws SystemException {
		return standardsTranslatePersistence.remove(standardsTranslate);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(StandardsTranslate.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return standardsTranslatePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return standardsTranslatePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public StandardsTranslate fetchStandardsTranslate(
		StandardsTranslatePK standardsTranslatePK) throws SystemException {
		return standardsTranslatePersistence.fetchByPrimaryKey(standardsTranslatePK);
	}
	 ...
	 */
	@Override
	public StandardsTranslate getStandardsTranslate(
		StandardsTranslatePK standardsTranslatePK)
		throws PortalException, SystemException {
		return standardsTranslatePersistence.findByPrimaryKey(standardsTranslatePK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return standardsTranslatePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<StandardsTranslate> getStandardsTranslates(int start, int end)
		throws SystemException {
		return standardsTranslatePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getStandardsTranslatesCount() throws SystemException {
		return standardsTranslatePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public StandardsTranslate updateStandardsTranslate(
		StandardsTranslate standardsTranslate) throws SystemException {
		return standardsTranslatePersistence.update(standardsTranslate);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ihg.brandstandards.db.model.StandardsTranslate",
			standardsTranslateLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ihg.brandstandards.db.model.StandardsTranslate");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = standardsTranslatePersistence.getDataSource();
	...
	private StandardsTranslateLocalServiceClpInvoker _clpInvoker = new StandardsTranslateLocalServiceClpInvoker();
}