...
<portlet:resourceURL id='languageUpdateRefreshURL'
	var="languageUpdateRefreshURL">
	<portlet:param name="requestType" value="LanguageRefreshURL" />
</portlet:resourceURL>
...
<div class="accordion" id="Manageaccordion">
	...
	<div class="accordian-inner">
		...
		<div id="language"> 
		 <%@include file="/html/GEM/manage/language.jsp"%>
		 </div>
	</div>
				...
				GEMTemplate gemTemplate = (GEMTemplate)pageContext.getAttribute("gemTemplate");
          	  	...
          	  	if (Validator.isNotNull(gemTemplate.getCreatorId())) {
          	    	try {
          	    		User creator = null;
          	    		try {
          	    			creator = UserLocalServiceUtil.getUserById(GetterUtil.getLong(gemTemplate.getCreatorId()));
          	    		} catch(Exception e) { }
          	    		if(creator != null) {
