...
public class ExternalLinkStandardsCountryLocalServiceImpl
	...
	public String assignLinkAttributeToCountry(String fromCountryCode, String toCountryCode){
		...
		return externalLinkStandardsCountryFinder.assignLinkAttributeToCountry(fromCountryCode, toCountryCode);
	}
	
	public String deleteCountryExtLinkAttribute(String ctryNameCode){
		
		return externalLinkStandardsCountryFinder.deleteCountryExtLinkAttribute(ctryNameCode);
	}
}