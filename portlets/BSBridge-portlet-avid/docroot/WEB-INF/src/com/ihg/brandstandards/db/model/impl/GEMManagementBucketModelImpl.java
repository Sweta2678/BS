...
public class GEMManagementBucketModelImpl extends BaseModelImpl<GEMManagementBucket>
	...
	public Object clone() {
		...
		gemManagementBucketImpl.setBucketCode(getBucketCode());
	...
	public CacheModel<GEMManagementBucket> toCacheModel() {
		...
		gemManagementBucketCacheModel.bucketCode = getBucketCode();

		String bucketCode = gemManagementBucketCacheModel.bucketCode;

		if ((bucketCode != null) && (bucketCode.length() == 0)) {
			gemManagementBucketCacheModel.bucketCode = null;
		}
