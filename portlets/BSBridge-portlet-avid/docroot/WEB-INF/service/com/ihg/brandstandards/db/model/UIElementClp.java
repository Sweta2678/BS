 ...
 * @author Mummanedi
 */
public class UIElementClp extends BaseModelImpl<UIElement> implements UIElement {
	public UIElementClp() {
	}
	...
	public void setElementId(long elementId) {
		...
		if (_uiElementRemoteModel != null) {
			try {
				Class<?> clazz = _uiElementRemoteModel.getClass();

				Method method = clazz.getMethod("setElementId", long.class);

				method.invoke(_uiElementRemoteModel, elementId);
			}
			catch (Exception e) {
	...
	public void setElementKey(String elementKey) {
		...
		if (_uiElementRemoteModel != null) {
			try {
				...
				method.invoke(_uiElementRemoteModel, elementKey);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setModuleName(String moduleName) {
		...
		if (_uiElementRemoteModel != null) {
			try {
				...
				method.invoke(_uiElementRemoteModel, moduleName);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setCreatorId(String creatorId) {
		...
		if (_uiElementRemoteModel != null) {
			try {
				...
				method.invoke(_uiElementRemoteModel, creatorId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setCreatedDate(Date createdDate) {
		...
		if (_uiElementRemoteModel != null) {
			try {
				...
				method.invoke(_uiElementRemoteModel, createdDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setUpdatedBy(String updatedBy) {
		...
		if (_uiElementRemoteModel != null) {
			try {
				...
				method.invoke(_uiElementRemoteModel, updatedBy);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setUpdatedDate(Date updatedDate) {
		...
		if (_uiElementRemoteModel != null) {
			try {
				...
				method.invoke(_uiElementRemoteModel, updatedDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public BaseModel<?> getUIElementRemoteModel() {
		return _uiElementRemoteModel;
	}

	public void setUIElementRemoteModel(BaseModel<?> uiElementRemoteModel) {
		_uiElementRemoteModel = uiElementRemoteModel;
	}
	...
	public Object invokeOnRemoteModel(String methodName,
		...
		Class<?> remoteModelClass = _uiElementRemoteModel.getClass();
		...
		Object returnValue = method.invoke(_uiElementRemoteModel,
	...
	public UIElement toEscapedModel() {
		return (UIElement)ProxyUtil.newProxyInstance(UIElement.class.getClassLoader(),
			new Class[] { UIElement.class }, new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		UIElementClp clone = new UIElementClp();
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof UIElementClp)) {
			return false;
		}

		UIElementClp uiElement = (UIElementClp)obj;
	...
	private BaseModel<?> _uiElementRemoteModel;
}