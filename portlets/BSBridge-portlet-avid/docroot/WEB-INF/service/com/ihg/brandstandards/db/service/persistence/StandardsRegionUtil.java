...
/**
 * The persistence utility for the standards region service. This utility wraps {@link StandardsRegionPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class StandardsRegionUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(StandardsRegion standardsRegion) {
		getPersistence().clearCache(standardsRegion);
	}
	 ...
	 */
	public static List<StandardsRegion> findWithDynamicQuery(
	 ...
	 */
	public static StandardsRegion update(StandardsRegion standardsRegion)
		throws SystemException {
		return getPersistence().update(standardsRegion);
	}
	...
	public static StandardsRegion update(StandardsRegion standardsRegion,
		...
		return getPersistence().update(standardsRegion, serviceContext);
	}
	...
	*/
	public static com.ihg.brandstandards.db.model.StandardsRegion findByregionId(
		long regionId)
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.StandardsRegion fetchByregionId(
		long regionId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByregionId(regionId);
	}
	...
	*/
	public static com.ihg.brandstandards.db.model.StandardsRegion fetchByregionId(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByregionId(regionId, retrieveFromCache);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.StandardsRegion removeByregionId(
		long regionId)
		throws com.ihg.brandstandards.db.NoSuchStandardsRegionException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().removeByregionId(regionId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.StandardsRegion findByRegionCode(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.StandardsRegion fetchByRegionCode(
		java.lang.String regionCode)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByRegionCode(regionCode);
	}
	...
	*/
	public static com.ihg.brandstandards.db.model.StandardsRegion fetchByRegionCode(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByRegionCode(regionCode, retrieveFromCache);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.StandardsRegion removeByRegionCode(
		java.lang.String regionCode)
		throws com.ihg.brandstandards.db.NoSuchStandardsRegionException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().removeByRegionCode(regionCode);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(standardsRegion);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(standardsRegions);
	}
	...
	*/
	public static com.ihg.brandstandards.db.model.StandardsRegion create(
		long regionId) {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.StandardsRegion remove(
		long regionId)
		throws com.ihg.brandstandards.db.NoSuchStandardsRegionException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	public static com.ihg.brandstandards.db.model.StandardsRegion updateImpl(
		com.ihg.brandstandards.db.model.StandardsRegion standardsRegion)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(standardsRegion);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.StandardsRegion findByPrimaryKey(
		long regionId)
		throws com.ihg.brandstandards.db.NoSuchStandardsRegionException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.StandardsRegion fetchByPrimaryKey(
		long regionId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.ihg.brandstandards.db.model.StandardsRegion> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static StandardsRegionPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (StandardsRegionPersistence)PortletBeanLocatorUtil.locate(com.ihg.brandstandards.db.service.ClpSerializer.getServletContextName(),
					StandardsRegionPersistence.class.getName());

			ReferenceRegistry.registerReference(StandardsRegionUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(StandardsRegionPersistence persistence) {
	}

	private static StandardsRegionPersistence _persistence;
}