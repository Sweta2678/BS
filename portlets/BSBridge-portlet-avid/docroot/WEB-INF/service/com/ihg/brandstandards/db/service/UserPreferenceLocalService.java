...
/**
 * Provides the local service interface for UserPreference. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mummanedi
 * @see UserPreferenceLocalServiceUtil
...
public interface UserPreferenceLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link UserPreferenceLocalServiceUtil} to access the user preference local service. Add custom service methods to {@link com.ihg.brandstandards.db.service.impl.UserPreferenceLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
