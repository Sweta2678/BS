...
/**
 * Provides the local service interface for UserSearchCriteria. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mummanedi
 * @see UserSearchCriteriaLocalServiceUtil
...
public interface UserSearchCriteriaLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link UserSearchCriteriaLocalServiceUtil} to access the user search criteria local service. Add custom service methods to {@link com.ihg.brandstandards.db.service.impl.UserSearchCriteriaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
