...
/**
 * The persistence utility for the brand taxonomy translate service. This utility wraps {@link BrandTaxonomyTranslatePersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class BrandTaxonomyTranslateUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(BrandTaxonomyTranslate brandTaxonomyTranslate) {
		getPersistence().clearCache(brandTaxonomyTranslate);
	}
	 ...
	 */
	public static List<BrandTaxonomyTranslate> findWithDynamicQuery(
	 ...
	 */
	public static BrandTaxonomyTranslate update(
		BrandTaxonomyTranslate brandTaxonomyTranslate)
		throws SystemException {
		return getPersistence().update(brandTaxonomyTranslate);
	}
	...
	public static BrandTaxonomyTranslate update(
		...
		return getPersistence().update(brandTaxonomyTranslate, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(brandTaxonomyTranslate);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(brandTaxonomyTranslates);
	}
	...
	*/
	public static com.ihg.brandstandards.db.model.BrandTaxonomyTranslate create(
		com.ihg.brandstandards.db.service.persistence.BrandTaxonomyTranslatePK brandTaxonomyTranslatePK) {
		return getPersistence().create(brandTaxonomyTranslatePK);
	}
	...
	*/
	public static com.ihg.brandstandards.db.model.BrandTaxonomyTranslate remove(
		com.ihg.brandstandards.db.service.persistence.BrandTaxonomyTranslatePK brandTaxonomyTranslatePK)
		throws com.ihg.brandstandards.db.NoSuchBrandTaxonomyTranslateException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(brandTaxonomyTranslatePK);
	}

	public static com.ihg.brandstandards.db.model.BrandTaxonomyTranslate updateImpl(
		com.ihg.brandstandards.db.model.BrandTaxonomyTranslate brandTaxonomyTranslate)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(brandTaxonomyTranslate);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.BrandTaxonomyTranslate findByPrimaryKey(
		com.ihg.brandstandards.db.service.persistence.BrandTaxonomyTranslatePK brandTaxonomyTranslatePK)
		throws com.ihg.brandstandards.db.NoSuchBrandTaxonomyTranslateException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().findByPrimaryKey(brandTaxonomyTranslatePK);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.BrandTaxonomyTranslate fetchByPrimaryKey(
		com.ihg.brandstandards.db.service.persistence.BrandTaxonomyTranslatePK brandTaxonomyTranslatePK)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(brandTaxonomyTranslatePK);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.ihg.brandstandards.db.model.BrandTaxonomyTranslate> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static BrandTaxonomyTranslatePersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (BrandTaxonomyTranslatePersistence)PortletBeanLocatorUtil.locate(com.ihg.brandstandards.db.service.ClpSerializer.getServletContextName(),
					BrandTaxonomyTranslatePersistence.class.getName());

			ReferenceRegistry.registerReference(BrandTaxonomyTranslateUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(BrandTaxonomyTranslatePersistence persistence) {
	}

	private static BrandTaxonomyTranslatePersistence _persistence;
}