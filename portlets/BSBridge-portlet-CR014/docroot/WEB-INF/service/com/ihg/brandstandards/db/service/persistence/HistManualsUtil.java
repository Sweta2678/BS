...
/**
 * The persistence utility for the hist manuals service. This utility wraps {@link HistManualsPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class HistManualsUtil {
	 ...
	 */
	public static void clearCache(HistManuals histManuals) {
		getPersistence().clearCache(histManuals);
	}
	 ...
	 */
	public static List<HistManuals> findWithDynamicQuery(
	 ...
	 */
	public static HistManuals update(HistManuals histManuals)
		throws SystemException {
		return getPersistence().update(histManuals);
	}
	...
	public static HistManuals update(HistManuals histManuals,
		...
		return getPersistence().update(histManuals, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(histManuals);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(histManualses);
	}
	...
	*/
	public static com.ihg.brandstandards.db.model.HistManuals create(
		long histManualId) {
	...
	*/
	public static com.ihg.brandstandards.db.model.HistManuals remove(
		long histManualId)
	...
	public static com.ihg.brandstandards.db.model.HistManuals updateImpl(
		com.ihg.brandstandards.db.model.HistManuals histManuals)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(histManuals);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.HistManuals findByPrimaryKey(
		long histManualId)
		throws com.ihg.brandstandards.db.NoSuchHistManualsException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.HistManuals fetchByPrimaryKey(
		long histManualId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.ihg.brandstandards.db.model.HistManuals> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static HistManualsPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (HistManualsPersistence)PortletBeanLocatorUtil.locate(com.ihg.brandstandards.db.service.ClpSerializer.getServletContextName(),
					HistManualsPersistence.class.getName());

			ReferenceRegistry.registerReference(HistManualsUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(HistManualsPersistence persistence) {
	}

	private static HistManualsPersistence _persistence;
}