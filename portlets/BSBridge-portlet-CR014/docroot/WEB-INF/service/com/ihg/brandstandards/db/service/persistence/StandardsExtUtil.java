...
/**
 * The persistence utility for the Custom Query mapping between STD and Taxonomy tables. service. This utility wraps {@link StandardsExtPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see StandardsExtPersistenceImpl
 * @generated
 */
public class StandardsExtUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(StandardsExt standardsExt) {
		getPersistence().clearCache(standardsExt);
	}
	 ...
	 */
	public static List<StandardsExt> findWithDynamicQuery(
	 ...
	 */
	public static StandardsExt update(StandardsExt standardsExt)
		throws SystemException {
		return getPersistence().update(standardsExt);
	}
	...
	public static StandardsExt update(StandardsExt standardsExt,
		...
		return getPersistence().update(standardsExt, serviceContext);
	}
	...
	*/
	public static com.ihg.brandstandards.db.model.StandardsExt findByStdId(
		long stdId)
		throws com.ihg.brandstandards.db.NoSuchStandardsExtException,
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.StandardsExt fetchByStdId(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.StandardsExt removeByStdId(
		long stdId)
		throws com.ihg.brandstandards.db.NoSuchStandardsExtException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(standardsExt);
	}
	...
	*/
	public static void cacheResult(
		java.util.List<com.ihg.brandstandards.db.model.StandardsExt> standardsExts) {
		getPersistence().cacheResult(standardsExts);
	}
	...
	*/
	public static com.ihg.brandstandards.db.model.StandardsExt create(
		com.ihg.brandstandards.db.service.persistence.StandardsExtPK standardsExtPK) {
		return getPersistence().create(standardsExtPK);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.StandardsExt remove(
		com.ihg.brandstandards.db.service.persistence.StandardsExtPK standardsExtPK)
		throws com.ihg.brandstandards.db.NoSuchStandardsExtException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(standardsExtPK);
	}

	public static com.ihg.brandstandards.db.model.StandardsExt updateImpl(
		com.ihg.brandstandards.db.model.StandardsExt standardsExt)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(standardsExt);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.StandardsExt findByPrimaryKey(
		com.ihg.brandstandards.db.service.persistence.StandardsExtPK standardsExtPK)
		throws com.ihg.brandstandards.db.NoSuchStandardsExtException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().findByPrimaryKey(standardsExtPK);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.StandardsExt fetchByPrimaryKey(
		com.ihg.brandstandards.db.service.persistence.StandardsExtPK standardsExtPK)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(standardsExtPK);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.ihg.brandstandards.db.model.StandardsExt> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static StandardsExtPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (StandardsExtPersistence)PortletBeanLocatorUtil.locate(com.ihg.brandstandards.db.service.ClpSerializer.getServletContextName(),
					StandardsExtPersistence.class.getName());

			ReferenceRegistry.registerReference(StandardsExtUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(StandardsExtPersistence persistence) {
	}

	private static StandardsExtPersistence _persistence;
}