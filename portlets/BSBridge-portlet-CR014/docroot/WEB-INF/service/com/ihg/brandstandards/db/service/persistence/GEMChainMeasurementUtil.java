...
/**
 * The persistence utility for the g e m chain measurement service. This utility wraps {@link GEMChainMeasurementPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see GEMChainMeasurementPersistenceImpl
 * @generated
 */
public class GEMChainMeasurementUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(GEMChainMeasurement gemChainMeasurement) {
		getPersistence().clearCache(gemChainMeasurement);
	}
	 ...
	 */
	public static List<GEMChainMeasurement> findWithDynamicQuery(
	 ...
	 */
	public static GEMChainMeasurement update(
		GEMChainMeasurement gemChainMeasurement) throws SystemException {
		return getPersistence().update(gemChainMeasurement);
	}
	 ...
	 */
	public static GEMChainMeasurement update(
		GEMChainMeasurement gemChainMeasurement, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(gemChainMeasurement, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(gemChainMeasurement);
	}
	...
	*/
	public static void cacheResult(
		java.util.List<com.ihg.brandstandards.db.model.GEMChainMeasurement> gemChainMeasurements) {
		getPersistence().cacheResult(gemChainMeasurements);
	}
	...
	*/
	public static com.ihg.brandstandards.db.model.GEMChainMeasurement create(
		long chainMeasurementId) {
		return getPersistence().create(chainMeasurementId);
	}
	...
	*/
	public static com.ihg.brandstandards.db.model.GEMChainMeasurement remove(
		long chainMeasurementId)
		throws com.ihg.brandstandards.db.NoSuchGEMChainMeasurementException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(chainMeasurementId);
	}

	public static com.ihg.brandstandards.db.model.GEMChainMeasurement updateImpl(
		com.ihg.brandstandards.db.model.GEMChainMeasurement gemChainMeasurement)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(gemChainMeasurement);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.GEMChainMeasurement findByPrimaryKey(
		long chainMeasurementId)
		throws com.ihg.brandstandards.db.NoSuchGEMChainMeasurementException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().findByPrimaryKey(chainMeasurementId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.brandstandards.db.model.GEMChainMeasurement fetchByPrimaryKey(
		long chainMeasurementId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(chainMeasurementId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.ihg.brandstandards.db.model.GEMChainMeasurement> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static GEMChainMeasurementPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (GEMChainMeasurementPersistence)PortletBeanLocatorUtil.locate(com.ihg.brandstandards.db.service.ClpSerializer.getServletContextName(),
					GEMChainMeasurementPersistence.class.getName());

			ReferenceRegistry.registerReference(GEMChainMeasurementUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(GEMChainMeasurementPersistence persistence) {
	}

	private static GEMChainMeasurementPersistence _persistence;
}