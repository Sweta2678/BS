...
public class AttachmentsStandardsLocalServiceClpInvoker {
	public AttachmentsStandardsLocalServiceClpInvoker() {
		...
		_methodName587 = "getAttachmentsStandardsByStandardId";

		_methodParameterTypes587 = new String[] { "long" };

		_methodName588 = "getAttachmentsStandardsByParentId";

		_methodParameterTypes588 = new String[] { "long" };

		_methodName589 = "getAttachmentsStandardsByParentIdStdIdLangId";

		_methodParameterTypes589 = new String[] {
				"long", "long", "java.lang.String"
			};

		_methodName590 = "getAttachmentsStandardsByLocaleCdStdId";

		_methodParameterTypes590 = new String[] { "java.lang.String", "long" };

		_methodName591 = "getAttachmentsStandardsByParentIdStdId";

		_methodParameterTypes591 = new String[] { "long", "long" };

		_methodName592 = "getAttachmentsStandardsParentsByStdId";

		_methodParameterTypes592 = new String[] { "long" };

		_methodName593 = "getAttachmentsStandardsByParentIdAttachId";

		_methodParameterTypes593 = new String[] { "long", "long" };

		_methodName594 = "deleteAttachmentsStandards";

		_methodParameterTypes594 = new String[] {
				"com.ihg.brandstandards.db.model.AttachmentsStandards"
			};

		_methodName595 = "getAttchmentByAttachmendId";

		_methodParameterTypes595 = new String[] { "long" };

		_methodName596 = "getStandardAttachmentsByStdIdAndRgnIdAndLocale";
