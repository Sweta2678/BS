package com.ihg.brandstandards.spreadsheet.process;
...
*/
    public List<Record> processXls(File xlsFile,ProgressTracker progressTracker,List<String> taxonomyObjIds) throws InvalidFormatException,IOException,JAXBException
	{
	    ...
	    records =process(xlsFile, inputStream);
	    printReport(records);
	    return records;
	}
    
    
    public List<Record> process(File xlsFileName, InputStream inpurtStream)
    ...
    protected XlsModelData getXlsHeader(List<XlsModelData> data) throws InvalidFormatException
    {
        ...
        else
        {
            ...
            if (xlsHeader == null)
                throw new InvalidFormatException("Header NOT found in spreadsheet!");
        }
        return xlsHeader;
    }
