						...
						<div class="span6">
							<div class="pull-left">
					   		...
					   		<div class="pull-right">
					   			<a class="btn btn-primary" href="javascript:groupCountryPopup(${publishId}, ${regionId}, '${selectedGroupName}')">Country Info</a>
					   		</div> 
...
<div id="groupCountry_popup" style="display: none;" title="Countries"></div>
</c:when>
