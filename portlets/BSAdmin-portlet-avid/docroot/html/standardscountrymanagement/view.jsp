...
<div class="rounded_container">
	...
	<h4 class="short_page_subtitle">Manage Countries</h4>
	<div class="report_container">
		...
		<div class="button uielem_btn">
			<a class="results_filter" title="Add New Country" href="javascript: void(0)" onclick="createCountryRegionPopup('${createCountryRegionPopup}')">Add New Country</a>
			<span></span>
		</div>
	...
	<table class="results_table">
		...
		<liferay-ui:search-container hover="false" searchContainer="${searchContainer}">
			...
			<tr>
				...
				<td><a title="Edit Country" href="#" onclick="editCountryRegionPopup('${editCountryRegionPopup}', this)" > <img alt="Edit Country" title="Edit Country" src="/BSTheme-theme/images/edit_pencil_icon.png"> </a></td>
			</tr>
...
<script type="text/javascript">
	...
	var standardsCountryRegion = 'Add Country';
		...
		jQuery.ajax({
			...
			success: function(data) {
				...
				if (data != null && data != '' && typeof data != 'undefined') {
					...
					countryRegionDialog.dialog('option', 'title', 'Add Country');
	...
	function editCountryRegionPopup(editCountryRegionPopupURL, editCountryCode) {
		...
		jQuery.ajax({
			...
			success: function(data) {
				...
				if (data != null && data != '' && typeof data != 'undefined') {
					jQuery('#createCountryRegion_popup').html(data);
					countryRegionDialog.dialog('option', 'title', 'Edit Country');
					countryRegionDialog.dialog("open");
				}
			}
		});
