...
<aui:form  action="${assignRoleURL}" method="post" name="RoleAssignmentForm" id="RoleAssignmentForm">
	...
	<div class="alert alert-error" id="userNotExists" style="display: none;"> No user exists with the screen name you are provided.</div>
	...
	<aui:input id="userName" type="text" name="userName" label="Enter User Name (Network Id)" value="${userName}">
