...
pageContext.setAttribute("chainCdMap", chnCdMap);
if(preferences!=null)
{
...
<div>
	...
	<p class="accordion-expand-holder">
		...
		<c:forEach var="chainCode" items="${pageScope.chainCdMap}" varStatus="loop">
		
			<h3 tabindex="0" aria-expanded="false" aria-selected="false" aria-controls="ui-accordion-1-panel-${loop.index}" id="ui-accordion-1-header-${loop.index}" role="tab" class="ui-accordion-header ui-helper-reset ui-state-default ui-corner-all ui-accordion-icons">
			  <span class="ui-accordion-header-icon ui-icon ui-icon-triangle-1-e" id="${chainCode.key}Brand" ></span>${chainCode.value}</h3>
			  <div aria-hidden="true" role="tabpanel" aria-labelledby="ui-accordion-1-header-${loop.index}" id="ui-accordion-1-panel-${loop.index}" style="display: none;" class="ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom">
			  <textarea style="width:248px;" rows="4" class="popup_ajax_form edit" id="${chainCode.key}Desc"></textarea>
			</div>
