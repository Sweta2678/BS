...
/**
 * The persistence utility for the feedback detail service. This utility wraps {@link FeedbackDetailPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class FeedbackDetailUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(FeedbackDetail feedbackDetail) {
		getPersistence().clearCache(feedbackDetail);
	}
	 ...
	 */
	public static List<FeedbackDetail> findWithDynamicQuery(
	 ...
	 */
	public static FeedbackDetail update(FeedbackDetail feedbackDetail)
		throws SystemException {
		return getPersistence().update(feedbackDetail);
	}
	...
	public static FeedbackDetail update(FeedbackDetail feedbackDetail,
		...
		return getPersistence().update(feedbackDetail, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(feedbackDetail);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(feedbackDetails);
	}
	...
	*/
	public static com.ihg.grs.common.model.FeedbackDetail create(
		int PORTAL_FEEDBACK_DTL_ID) {
		return getPersistence().create(PORTAL_FEEDBACK_DTL_ID);
	}
	...
	*/
	public static com.ihg.grs.common.model.FeedbackDetail remove(
		int PORTAL_FEEDBACK_DTL_ID)
		throws com.ihg.grs.common.NoSuchFeedbackDetailException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(PORTAL_FEEDBACK_DTL_ID);
	}

	public static com.ihg.grs.common.model.FeedbackDetail updateImpl(
		com.ihg.grs.common.model.FeedbackDetail feedbackDetail)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(feedbackDetail);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.grs.common.model.FeedbackDetail findByPrimaryKey(
		int PORTAL_FEEDBACK_DTL_ID)
		throws com.ihg.grs.common.NoSuchFeedbackDetailException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().findByPrimaryKey(PORTAL_FEEDBACK_DTL_ID);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ihg.grs.common.model.FeedbackDetail fetchByPrimaryKey(
		int PORTAL_FEEDBACK_DTL_ID)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(PORTAL_FEEDBACK_DTL_ID);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.ihg.grs.common.model.FeedbackDetail> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static FeedbackDetailPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (FeedbackDetailPersistence)PortletBeanLocatorUtil.locate(com.ihg.grs.common.service.ClpSerializer.getServletContextName(),
					FeedbackDetailPersistence.class.getName());

			ReferenceRegistry.registerReference(FeedbackDetailUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(FeedbackDetailPersistence persistence) {
	}

	private static FeedbackDetailPersistence _persistence;
}