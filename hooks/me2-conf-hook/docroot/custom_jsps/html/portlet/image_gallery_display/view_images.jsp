...
<div class="custom_conf_common_wrapper">
	...
	%>
		...
		<c:choose>
			<c:when test="<%= fileEntry != null %>">
				<div class="custom_conf_file_wrapper">
				<%
			...
			<c:when test="<%= curFolder != null %>">
				<div class="custom_conf_folder_wrapper">
						...
						<div class="image-icon">
							<a class="image-link" href="<%= viewFolderURL.toString() %>" title="<%= HtmlUtil.escape(curFolder.getName()) + " - " + HtmlUtil.escape(curFolder.getDescription()) %>">
								...
								<%
									...
									String folderImageSrc = themeDisplay.getPathThemeImages() + "/custom_conf_photos.jpg";

									if ((curFoldersCount + curImagesCount) > 0) {
										folderImageSrc = themeDisplay.getPathThemeImages() + "/custom_conf_photos.jpg";
									}
								%>
