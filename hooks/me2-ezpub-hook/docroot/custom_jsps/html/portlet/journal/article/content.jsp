...
//All configurations fetch and apply
String noCustom = portletSetup.getValue("noCustom","true");
String hideLocalized = "false"; // default un-hide
String hideLanguage = "false";
String hideSearchable = "false";
String editorType = "liferay-article";
String hideStructure = "false";
String hideTemplate = "false";

if(!"true".equals(noCustom)) {
	hideLocalized = portletSetup.getValue("hideLocalized","false"); // default un-hide
	hideLanguage = portletSetup.getValue("hideLanguage","false");
	hideSearchable = portletSetup.getValue("hideSearchable","false");
	editorType = portletSetup.getValue("editorType","liferay-article");
	hideStructure = portletSetup.getValue("hideStructure","false");
	hideTemplate = portletSetup.getValue("hideTemplate","false");
}
...
<div class="journal-article-body" id="<portlet:namespace />journalArticleBody">
	<div class="journal-article-body-content">
		...
		<div class="journal-article-header-edit" id="<portlet:namespace />articleHeaderEdit">
			...
			<c:if test='<%= Validator.isNull(toLanguageId) && (!hideStructure.equals("true") || !hideTemplate.equals("true")) %>'>
				<div class="article-structure-template-toolbar journal-metadata">
					...
					<aui:row>
						<c:if test='<%= !hideStructure.equals("true") %>'>
						...
						<c:if test='<%= !hideTemplate.equals("true") %>'>
			...
			<div class="article-translation-toolbar journal-metadata <%= hideLanguage.equals("true")?"hide":"show" %>">
		...
		<div class="journal-article-container" id="<portlet:namespace />journalArticleContainer">
								...
								<span class="folder">
									<div class="field-container">
										...
										<div class="journal-article-component-container">
											<liferay-ui:input-editor contentsLanguageId="<%= Validator.isNotNull(toLanguageId) ? toLanguageId : defaultLanguageId %>" editorImpl="<%= EDITOR_WYSIWYG_IMPL_KEY %>" name="articleContent" toolbarSet="<%= editorType %>" width="100%" />
										</div>

										<c:if test='<%= !hideLocalized.equals("true") %>'>
			...
			<c:if test='<%= Validator.isNull(toLanguageId)  && !hideSearchable.equals("true") %>'>
