package com.ihg.me2.indexpostprocessor.util;
...
public class CustomIndexerUtil {
	...
	private static Log _log = LogFactoryUtil.getLog(CustomIndexerUtil.class);
		...
		{
			String orgCustomFieldVal= null;
			try 
			{
				 String[] valArray = getExpandoStringArray(org.getCompanyId(), org.getPrimaryKey(), Organization.class.getName(), "Type");
				 if(valArray!=null && valArray.length > 0)
				 {
					 orgCustomFieldVal = valArray[0];
				 }
			...
			if(Validator.isNotNull(orgCustomFieldVal) )
			{	
				 _log.info("orgCustomFieldVal from array::" + orgCustomFieldVal.toString());
				return orgCustomFieldVal.equals("Department");
			}
			return false;
		}
     ...
     */
    public static String getExpandoString(long companyId, long classPk, String className, String fieldName)
			throws PortalException, SystemException {

		Serializable expandoValue = ExpandoValueLocalServiceUtil.getData(
				companyId, className,
				ExpandoTableConstants.DEFAULT_TABLE_NAME, fieldName,
				classPk);

		return (expandoValue != null) ? expandoValue.toString()
				: StringPool.BLANK;
	}
     ...
     * @throws SystemException
     */
    public static String[] getExpandoStringArray(long companyId, long classPk, String className, String fieldName)
			throws PortalException, SystemException 
	{
    	String [] dafaultVal=null;
    	
		String [] expandoValue = ExpandoValueLocalServiceUtil.getData(companyId, className,	ExpandoTableConstants.DEFAULT_TABLE_NAME, fieldName,classPk,dafaultVal);
