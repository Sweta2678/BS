...
<%! public static String FNB_CONTENT_APPROVER = "Fnb Content Approver"; 
    public static String DOCUMENT_PUBLISHER_ROLE_NAME = "IHG Content Publisher";
	public static String FOOD_AND_BEVERAGES = "FOOD_AND_BEVERAGES";
			...
			<div class="journal-article-wrapper-content">
				...
				<liferay-util:buffer var="htmlBottom">
					...
					<aui:button-row cssClass="journal-article-button-row">
						...
						boolean fnbContentApproverRole = false;
						boolean ihgContentPublisherRole = false;
						fnbContentApproverRole = UserGroupRoleLocalServiceUtil.hasUserGroupRole(themeDisplay.getUserId(), themeDisplay.getScopeGroupId(), FNB_CONTENT_APPROVER);
						ihgContentPublisherRole = UserGroupRoleLocalServiceUtil.hasUserGroupRole(themeDisplay.getUserId(), themeDisplay.getScopeGroupId(), DOCUMENT_PUBLISHER_ROLE_NAME);
						%>
							...
							<c:when test="<%= Validator.isNull(toLanguageId) %>">
								<c:if test="<%= hasSavePermission %>">
									<c:if test="<%= classNameId == JournalArticleConstants.CLASSNAME_ID_DEFAULT %>">
										<c:choose>
											<c:when test="<%= ihgContentPublisherRole && structureId.equalsIgnoreCase(FOOD_AND_BEVERAGES) %>">
									...
									<c:choose>
										<c:when test="<%= permissionChecker.isOmniadmin() || permissionChecker.isCommunityAdmin(themeDisplay.getScopeGroupId()) || fnbContentApproverRole  && structureId.equalsIgnoreCase(FOOD_AND_BEVERAGES) %>">
