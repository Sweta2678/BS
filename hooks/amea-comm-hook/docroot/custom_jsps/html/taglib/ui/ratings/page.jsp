									...
									<div class="rating-label">
										<c:choose>
											...
											<c:otherwise>
												...
												<%= (int)(ratingsStats.getAverageScore() * ratingsStats.getTotalEntries()) %>
											</c:otherwise>
										</c:choose>
									...
									<c:choose>
										...
										<c:otherwise>
											...
											<div class="rating-input-container">
												...
												<label for="<%= ratingId %>">This post liked by <%= (int)(ratingsStats.getAverageScore() * ratingsStats.getTotalEntries()) %> people</label>
