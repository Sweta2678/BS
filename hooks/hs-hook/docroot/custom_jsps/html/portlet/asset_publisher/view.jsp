...
<div class="latestnews_container">
	...
	<div class="container_12">
		<div class="grid_12">
			<div class="round_cont_white_ds">

				<div class="top_left_white_ds"></div>
				<div class="top_right_white_ds"></div>

			<div class="right_side_ds">
				<div class="latestnews_content">

					<div class="latestnews_title_contain">
						<img src="/static/apps/hotelsolutions/assets/images/concierge_results_page.jpg" class="latestnews_lady" alt="Hotel concierge" title="Hotel concierge" />
						<h2 class="latestnews_htitle">Latest News</h2>
					</div>
...
%>
		...
		<div class="bottom_left_white_ds"></div>
		<div class="bottom_right_white_ds clearfix"></div>
