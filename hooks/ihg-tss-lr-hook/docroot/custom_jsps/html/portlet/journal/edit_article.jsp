...
//Add conditions here for only add tool portlt
String fromAddTool = ParamUtil.getString(request,"fromAddTool"); 

if(fromAddTool.equals("true")){
	structureId = ParamUtil.getString(request,"structureIdForSearch");
}
