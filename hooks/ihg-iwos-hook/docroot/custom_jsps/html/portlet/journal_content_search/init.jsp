...
boolean showListed = true;

if (portletName.equals(PortletKeys.JOURNAL_CONTENT_SEARCH)) {
	showListedDefault = PropsValues.JOURNAL_CONTENT_SEARCH_SHOW_LISTED;
}

if(com.liferay.portal.util.PortalUtil.getCurrentURL(renderRequest).indexOf("way-of-sales")!=-1){
	 showListed = false;
}
else{
   showListed = PrefsParamUtil.getBoolean(portletPreferences, request, "showListed", showListedDefault);
}
